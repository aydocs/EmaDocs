/**
 * Dropdown Component - premium Variant
...
(function() {
    ...
    function initDropdownPremium() {
        const components = document.querySelectorAll('.ema-dropdown--premium');
        ...
        console.log(`Dropdown premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dropdown premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Dropdown premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropdownPremium);
    } else {
        initDropdownPremium();
    }
