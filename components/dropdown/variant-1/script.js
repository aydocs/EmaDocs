/**
 * Dropdown Component - minimal Variant
...
(function() {
    ...
    function initDropdownMinimal() {
        const components = document.querySelectorAll('.ema-dropdown--minimal');
        ...
        console.log(`Dropdown minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Dropdown component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dropdown minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('dropdown:click', {
    ...
    window.handleClick = function() {
        console.log('Dropdown minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropdownMinimal);
    } else {
        initDropdownMinimal();
    }
