/**
 * Dropdown Component - soft Variant
...
(function() {
    ...
    function initDropdownSoft() {
        const components = document.querySelectorAll('.ema-dropdown--soft');
        ...
        console.log(`Dropdown soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dropdown soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Dropdown soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropdownSoft);
    } else {
        initDropdownSoft();
    }
