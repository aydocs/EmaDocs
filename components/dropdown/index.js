/**
 * Dropdown Component - Main Entry Point
...
// Export component
export { default as Dropdown } from './dropdown.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Dropdown', {
    name: 'Dropdown',
...
console.log('Dropdown component loaded with 5 variants');
