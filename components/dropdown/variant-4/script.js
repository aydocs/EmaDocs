/**
 * Dropdown Component - glass Variant
...
(function() {
    ...
    function initDropdownGlass() {
        const components = document.querySelectorAll('.ema-dropdown--glass');
        ...
        console.log(`Dropdown glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dropdown glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Dropdown glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropdownGlass);
    } else {
        initDropdownGlass();
    }
