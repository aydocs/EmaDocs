/**
 * Dropdown Component - neo Variant
...
(function() {
    ...
    function initDropdownNeo() {
        const components = document.querySelectorAll('.ema-dropdown--neo');
        ...
        console.log(`Dropdown neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dropdown neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Dropdown neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropdownNeo);
    } else {
        initDropdownNeo();
    }
