/**
 * NavbarForm Component - soft Variant
...
(function() {
    ...
    function initNavbarFormSoft() {
        const components = document.querySelectorAll('.ema-navbarform--soft');
        ...
        console.log(`NavbarForm soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarForm soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarForm soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarFormSoft);
    } else {
        initNavbarFormSoft();
    }
