/**
 * NavbarForm Component - neo Variant
...
(function() {
    ...
    function initNavbarFormNeo() {
        const components = document.querySelectorAll('.ema-navbarform--neo');
        ...
        console.log(`NavbarForm neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarForm neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarForm neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarFormNeo);
    } else {
        initNavbarFormNeo();
    }
