/**
 * NavbarForm Component - minimal Variant
...
(function() {
    ...
    function initNavbarFormMinimal() {
        const components = document.querySelectorAll('.ema-navbarform--minimal');
        ...
        console.log(`NavbarForm minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarForm minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarForm minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarFormMinimal);
    } else {
        initNavbarFormMinimal();
    }
