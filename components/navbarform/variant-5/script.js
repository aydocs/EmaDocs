/**
 * NavbarForm Component - premium Variant
...
(function() {
    ...
    function initNavbarFormPremium() {
        const components = document.querySelectorAll('.ema-navbarform--premium');
        ...
        console.log(`NavbarForm premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarForm component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarForm premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarform:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarForm premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarFormPremium);
    } else {
        initNavbarFormPremium();
    }
