/**
 * NavbarForm Component - glass Variant
...
(function() {
    ...
    function initNavbarFormGlass() {
        const components = document.querySelectorAll('.ema-navbarform--glass');
        ...
        console.log(`NavbarForm glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarForm glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarForm glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarFormGlass);
    } else {
        initNavbarFormGlass();
    }
