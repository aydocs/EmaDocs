/**
 * Dialog Component - minimal Variant
...
(function() {
    ...
    function initDialogMinimal() {
        const components = document.querySelectorAll('.ema-dialog--minimal');
        ...
        console.log(`Dialog minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Dialog component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dialog minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('dialog:click', {
    ...
    window.handleClick = function() {
        console.log('Dialog minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDialogMinimal);
    } else {
        initDialogMinimal();
    }
