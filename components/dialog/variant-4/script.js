/**
 * Dialog Component - glass Variant
...
(function() {
    ...
    function initDialogGlass() {
        const components = document.querySelectorAll('.ema-dialog--glass');
        ...
        console.log(`Dialog glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dialog glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Dialog glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDialogGlass);
    } else {
        initDialogGlass();
    }
