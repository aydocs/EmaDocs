...
A comprehensive Dialog component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Dialog variant="minimal">Minimal</Dialog>
<Dialog variant="neo">Neo</Dialog>
<Dialog variant="soft">Soft</Dialog>
<Dialog variant="glass">Glass</Dialog>
<Dialog variant="premium">Premium</Dialog>
```
...
- `dialog.ema` - Main component definition
