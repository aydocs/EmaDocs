...
(function() {
    ...
    function initDialogSoft() {
        const components = document.querySelectorAll('.ema-dialog--soft');
        ...
        console.log(`Dialog soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dialog soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Dialog soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDialogSoft);
    } else {
        initDialogSoft();
    }
