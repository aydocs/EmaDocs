/**
 * Dialog Component - premium Variant
...
(function() {
    ...
    function initDialogPremium() {
        const components = document.querySelectorAll('.ema-dialog--premium');
        ...
        console.log(`Dialog premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dialog premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Dialog premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDialogPremium);
    } else {
        initDialogPremium();
    }
