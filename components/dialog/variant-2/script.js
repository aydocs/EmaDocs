...
(function() {
    ...
    function initDialogNeo() {
        const components = document.querySelectorAll('.ema-dialog--neo');
        ...
        console.log(`Dialog neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dialog neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Dialog neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDialogNeo);
    } else {
        initDialogNeo();
    }
