...
(function() {
    ...
    function initComboboxPremium() {
        const components = document.querySelectorAll('.ema-combobox--premium');
        ...
        console.log(`Combobox premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Combobox component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Combobox premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('combobox:click', {
    ...
    window.handleClick = function() {
        console.log('Combobox premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initComboboxPremium);
    } else {
        initComboboxPremium();
    }
