/**
 * Combobox Component - soft Variant
...
(function() {
    ...
    function initComboboxSoft() {
        const components = document.querySelectorAll('.ema-combobox--soft');
        ...
        console.log(`Combobox soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Combobox soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Combobox soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initComboboxSoft);
    } else {
        initComboboxSoft();
    }
