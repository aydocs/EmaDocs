/**
 * Combobox Component - neo Variant
...
(function() {
    ...
    function initComboboxNeo() {
        const components = document.querySelectorAll('.ema-combobox--neo');
        ...
        console.log(`Combobox neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Combobox neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Combobox neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initComboboxNeo);
    } else {
        initComboboxNeo();
    }
