/**
 * Combobox Component - minimal Variant
...
(function() {
    ...
    function initComboboxMinimal() {
        const components = document.querySelectorAll('.ema-combobox--minimal');
        ...
        console.log(`Combobox minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Combobox minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Combobox minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initComboboxMinimal);
    } else {
        initComboboxMinimal();
    }
