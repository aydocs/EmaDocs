/**
 * Combobox Component - glass Variant
...
(function() {
    ...
    function initComboboxGlass() {
        const components = document.querySelectorAll('.ema-combobox--glass');
        ...
        console.log(`Combobox glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Combobox glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Combobox glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initComboboxGlass);
    } else {
        initComboboxGlass();
    }
