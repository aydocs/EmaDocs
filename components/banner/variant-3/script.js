...
(function() {
    ...
    function initBannerSoft() {
        const components = document.querySelectorAll('.ema-banner--soft');
        ...
        console.log(`Banner soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Banner soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Banner soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBannerSoft);
    } else {
        initBannerSoft();
    }
