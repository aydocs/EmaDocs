/**
 * Banner Component - glass Variant
...
(function() {
    ...
    function initBannerGlass() {
        const components = document.querySelectorAll('.ema-banner--glass');
        ...
        console.log(`Banner glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Banner glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Banner glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBannerGlass);
    } else {
        initBannerGlass();
    }
