/**
 * Banner Component - premium Variant
...
(function() {
    ...
    function initBannerPremium() {
        const components = document.querySelectorAll('.ema-banner--premium');
        ...
        console.log(`Banner premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Banner component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Banner premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('banner:click', {
    ...
    window.handleClick = function() {
        console.log('Banner premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBannerPremium);
    } else {
        initBannerPremium();
    }
