...
(function() {
    ...
    function initBannerNeo() {
        const components = document.querySelectorAll('.ema-banner--neo');
        ...
        console.log(`Banner neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Banner neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Banner neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBannerNeo);
    } else {
        initBannerNeo();
    }
