...
A comprehensive Banner component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Banner variant="minimal">Minimal</Banner>
<Banner variant="neo">Neo</Banner>
<Banner variant="soft">Soft</Banner>
<Banner variant="glass">Glass</Banner>
<Banner variant="premium">Premium</Banner>
```
...
- `banner.ema` - Main component definition
