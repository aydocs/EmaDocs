/**
 * Banner Component - minimal Variant
...
(function() {
    ...
    function initBannerMinimal() {
        const components = document.querySelectorAll('.ema-banner--minimal');
        ...
        console.log(`Banner minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Banner minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Banner minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBannerMinimal);
    } else {
        initBannerMinimal();
    }
