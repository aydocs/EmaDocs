/**
 * Search Component - minimal Variant
...
(function() {
    ...
    function initSearchMinimal() {
        const components = document.querySelectorAll('.ema-search--minimal');
        ...
        console.log(`Search minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Search component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Search minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('search:click', {
    ...
    window.handleClick = function() {
        console.log('Search minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSearchMinimal);
    } else {
        initSearchMinimal();
    }
