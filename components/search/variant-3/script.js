...
(function() {
    ...
    function initSearchSoft() {
        const components = document.querySelectorAll('.ema-search--soft');
        ...
        console.log(`Search soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Search soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Search soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSearchSoft);
    } else {
        initSearchSoft();
    }
