/**
 * Search Component - premium Variant
...
(function() {
    ...
    function initSearchPremium() {
        const components = document.querySelectorAll('.ema-search--premium');
        ...
        console.log(`Search premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Search premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Search premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSearchPremium);
    } else {
        initSearchPremium();
    }
