/**
 * Search Component - glass Variant
...
(function() {
    ...
    function initSearchGlass() {
        const components = document.querySelectorAll('.ema-search--glass');
        ...
        console.log(`Search glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Search glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSearchGlass);
    } else {
        initSearchGlass();
    }
