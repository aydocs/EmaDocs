...
(function() {
    ...
    function initSearchNeo() {
        const components = document.querySelectorAll('.ema-search--neo');
        ...
        console.log(`Search neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Search neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Search neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSearchNeo);
    } else {
        initSearchNeo();
    }
