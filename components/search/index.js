/**
 * Search Component - Main Entry Point
...
// Export component
export { default as Search } from './search.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Search', {
    name: 'Search',
...
console.log('Search component loaded with 5 variants');
