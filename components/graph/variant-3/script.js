...
(function() {
    ...
    function initGraphSoft() {
        const components = document.querySelectorAll('.ema-graph--soft');
        ...
        console.log(`Graph soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Graph soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Graph soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGraphSoft);
    } else {
        initGraphSoft();
    }
