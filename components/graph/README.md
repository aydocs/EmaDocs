...
A comprehensive Graph component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Graph variant="minimal">Minimal</Graph>
<Graph variant="neo">Neo</Graph>
<Graph variant="soft">Soft</Graph>
<Graph variant="glass">Glass</Graph>
<Graph variant="premium">Premium</Graph>
```
...
- `graph.ema` - Main component definition
