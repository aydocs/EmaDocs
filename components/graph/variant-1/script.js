/**
 * Graph Component - minimal Variant
...
(function() {
    ...
    function initGraphMinimal() {
        const components = document.querySelectorAll('.ema-graph--minimal');
        ...
        console.log(`Graph minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Graph minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Graph minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGraphMinimal);
    } else {
        initGraphMinimal();
    }
