/**
 * Graph Component - premium Variant
...
(function() {
    ...
    function initGraphPremium() {
        const components = document.querySelectorAll('.ema-graph--premium');
        ...
        console.log(`Graph premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Graph component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Graph premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('graph:click', {
    ...
    window.handleClick = function() {
        console.log('Graph premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGraphPremium);
    } else {
        initGraphPremium();
    }
