...
(function() {
    ...
    function initGraphGlass() {
        const components = document.querySelectorAll('.ema-graph--glass');
        ...
        console.log(`Graph glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Graph glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Graph glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGraphGlass);
    } else {
        initGraphGlass();
    }
