...
(function() {
    ...
    function initGraphNeo() {
        const components = document.querySelectorAll('.ema-graph--neo');
        ...
        console.log(`Graph neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Graph neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGraphNeo);
    } else {
        initGraphNeo();
    }
