/**
 * Preview Component - minimal Variant
...
(function() {
    ...
    function initPreviewMinimal() {
        const components = document.querySelectorAll('.ema-preview--minimal');
        ...
        console.log(`Preview minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Preview minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Preview minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreviewMinimal);
    } else {
        initPreviewMinimal();
    }
