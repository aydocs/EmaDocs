/**
 * Preview Component - soft Variant
...
(function() {
    ...
    function initPreviewSoft() {
        const components = document.querySelectorAll('.ema-preview--soft');
        ...
        console.log(`Preview soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Preview soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Preview soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreviewSoft);
    } else {
        initPreviewSoft();
    }
