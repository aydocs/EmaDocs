...
(function() {
    ...
    function initPreviewNeo() {
        const components = document.querySelectorAll('.ema-preview--neo');
        ...
        console.log(`Preview neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Preview neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Preview neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreviewNeo);
    } else {
        initPreviewNeo();
    }
