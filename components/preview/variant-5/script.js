/**
 * Preview Component - premium Variant
...
(function() {
    ...
    function initPreviewPremium() {
        const components = document.querySelectorAll('.ema-preview--premium');
        ...
        console.log(`Preview premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Preview component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Preview premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('preview:click', {
    ...
    window.handleClick = function() {
        console.log('Preview premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreviewPremium);
    } else {
        initPreviewPremium();
    }
