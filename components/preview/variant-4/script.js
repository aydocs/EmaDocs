/**
 * Preview Component - glass Variant
...
(function() {
    ...
    function initPreviewGlass() {
        const components = document.querySelectorAll('.ema-preview--glass');
        ...
        console.log(`Preview glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Preview glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Preview glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreviewGlass);
    } else {
        initPreviewGlass();
    }
