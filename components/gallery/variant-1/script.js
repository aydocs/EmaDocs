/**
 * Gallery Component - minimal Variant
...
(function() {
    ...
    function initGalleryMinimal() {
        const components = document.querySelectorAll('.ema-gallery--minimal');
        ...
        console.log(`Gallery minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Gallery minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Gallery minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGalleryMinimal);
    } else {
        initGalleryMinimal();
    }
