/**
 * Gallery Component - glass Variant
...
(function() {
    ...
    function initGalleryGlass() {
        const components = document.querySelectorAll('.ema-gallery--glass');
        ...
        console.log(`Gallery glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Gallery glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Gallery glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGalleryGlass);
    } else {
        initGalleryGlass();
    }
