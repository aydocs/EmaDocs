/**
 * Gallery Component - soft Variant
...
(function() {
    ...
    function initGallerySoft() {
        const components = document.querySelectorAll('.ema-gallery--soft');
        ...
        console.log(`Gallery soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Gallery soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Gallery soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGallerySoft);
    } else {
        initGallerySoft();
    }
