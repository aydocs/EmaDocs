/**
 * Gallery Component - premium Variant
...
(function() {
    ...
    function initGalleryPremium() {
        const components = document.querySelectorAll('.ema-gallery--premium');
        ...
        console.log(`Gallery premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Gallery component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Gallery premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('gallery:click', {
    ...
    window.handleClick = function() {
        console.log('Gallery premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGalleryPremium);
    } else {
        initGalleryPremium();
    }
