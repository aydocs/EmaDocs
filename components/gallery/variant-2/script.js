...
(function() {
    ...
    function initGalleryNeo() {
        const components = document.querySelectorAll('.ema-gallery--neo');
        ...
        console.log(`Gallery neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Gallery neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Gallery neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGalleryNeo);
    } else {
        initGalleryNeo();
    }
