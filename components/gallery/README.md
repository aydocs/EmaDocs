...
A comprehensive Gallery component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Gallery variant="minimal">Minimal</Gallery>
<Gallery variant="neo">Neo</Gallery>
<Gallery variant="soft">Soft</Gallery>
<Gallery variant="glass">Glass</Gallery>
<Gallery variant="premium">Premium</Gallery>
```
...
- `gallery.ema` - Main component definition
