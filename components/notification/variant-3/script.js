/**
 * Notification Component - soft Variant
...
(function() {
    ...
    function initNotificationSoft() {
        const components = document.querySelectorAll('.ema-notification--soft');
        ...
        console.log(`Notification soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Notification soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Notification soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNotificationSoft);
    } else {
        initNotificationSoft();
    }
