/**
 * Notification Component - glass Variant
...
(function() {
    ...
    function initNotificationGlass() {
        const components = document.querySelectorAll('.ema-notification--glass');
        ...
        console.log(`Notification glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Notification glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Notification glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNotificationGlass);
    } else {
        initNotificationGlass();
    }
