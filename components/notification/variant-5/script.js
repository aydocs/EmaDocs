/**
 * Notification Component - premium Variant
...
(function() {
    ...
    function initNotificationPremium() {
        const components = document.querySelectorAll('.ema-notification--premium');
        ...
        console.log(`Notification premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Notification component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Notification premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('notification:click', {
    ...
    window.handleClick = function() {
        console.log('Notification premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNotificationPremium);
    } else {
        initNotificationPremium();
    }
