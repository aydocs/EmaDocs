/**
 * Notification Component - minimal Variant
...
(function() {
    ...
    function initNotificationMinimal() {
        const components = document.querySelectorAll('.ema-notification--minimal');
        ...
        console.log(`Notification minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Notification minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Notification minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNotificationMinimal);
    } else {
        initNotificationMinimal();
    }
