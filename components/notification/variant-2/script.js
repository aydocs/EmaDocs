/**
 * Notification Component - neo Variant
...
(function() {
    ...
    function initNotificationNeo() {
        const components = document.querySelectorAll('.ema-notification--neo');
        ...
        console.log(`Notification neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Notification neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Notification neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNotificationNeo);
    } else {
        initNotificationNeo();
    }
