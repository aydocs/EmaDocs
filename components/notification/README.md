...
A comprehensive Notification component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Notification variant="minimal">Minimal</Notification>
<Notification variant="neo">Neo</Notification>
<Notification variant="soft">Soft</Notification>
<Notification variant="glass">Glass</Notification>
<Notification variant="premium">Premium</Notification>
```
...
- `notification.ema` - Main component definition
