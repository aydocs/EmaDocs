...
A comprehensive Diagram component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Diagram variant="minimal">Minimal</Diagram>
<Diagram variant="neo">Neo</Diagram>
<Diagram variant="soft">Soft</Diagram>
<Diagram variant="glass">Glass</Diagram>
<Diagram variant="premium">Premium</Diagram>
```
...
- `diagram.ema` - Main component definition
