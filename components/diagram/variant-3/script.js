/**
 * Diagram Component - soft Variant
...
(function() {
    ...
    function initDiagramSoft() {
        const components = document.querySelectorAll('.ema-diagram--soft');
        ...
        console.log(`Diagram soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Diagram soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Diagram soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDiagramSoft);
    } else {
        initDiagramSoft();
    }
