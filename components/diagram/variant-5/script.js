/**
 * Diagram Component - premium Variant
...
(function() {
    ...
    function initDiagramPremium() {
        const components = document.querySelectorAll('.ema-diagram--premium');
        ...
        console.log(`Diagram premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Diagram premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Diagram premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDiagramPremium);
    } else {
        initDiagramPremium();
    }
