/**
 * Diagram Component - glass Variant
...
(function() {
    ...
    function initDiagramGlass() {
        const components = document.querySelectorAll('.ema-diagram--glass');
        ...
        console.log(`Diagram glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Diagram glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Diagram glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDiagramGlass);
    } else {
        initDiagramGlass();
    }
