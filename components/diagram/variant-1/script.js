/**
 * Diagram Component - minimal Variant
...
(function() {
    ...
    function initDiagramMinimal() {
        const components = document.querySelectorAll('.ema-diagram--minimal');
        ...
        console.log(`Diagram minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Diagram component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Diagram minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('diagram:click', {
    ...
    window.handleClick = function() {
        console.log('Diagram minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDiagramMinimal);
    } else {
        initDiagramMinimal();
    }
