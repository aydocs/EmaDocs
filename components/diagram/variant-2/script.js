...
(function() {
    ...
    function initDiagramNeo() {
        const components = document.querySelectorAll('.ema-diagram--neo');
        ...
        console.log(`Diagram neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Diagram neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Diagram neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDiagramNeo);
    } else {
        initDiagramNeo();
    }
