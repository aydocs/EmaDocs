/**
 * Download Component - premium Variant
...
(function() {
    ...
    function initDownloadPremium() {
        const components = document.querySelectorAll('.ema-download--premium');
        ...
        console.log(`Download premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Download premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Download premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDownloadPremium);
    } else {
        initDownloadPremium();
    }
