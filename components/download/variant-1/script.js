/**
 * Download Component - minimal Variant
...
(function() {
    ...
    function initDownloadMinimal() {
        const components = document.querySelectorAll('.ema-download--minimal');
        ...
        console.log(`Download minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Download component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Download minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('download:click', {
    ...
    window.handleClick = function() {
        console.log('Download minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDownloadMinimal);
    } else {
        initDownloadMinimal();
    }
