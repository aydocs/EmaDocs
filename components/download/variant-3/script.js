/**
 * Download Component - soft Variant
...
(function() {
    ...
    function initDownloadSoft() {
        const components = document.querySelectorAll('.ema-download--soft');
        ...
        console.log(`Download soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Download soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Download soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDownloadSoft);
    } else {
        initDownloadSoft();
    }
