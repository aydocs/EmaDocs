...
(function() {
    ...
    function initDownloadGlass() {
        const components = document.querySelectorAll('.ema-download--glass');
        ...
        console.log(`Download glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Download glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Download glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDownloadGlass);
    } else {
        initDownloadGlass();
    }
