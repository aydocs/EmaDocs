/**
 * Download Component - neo Variant
...
(function() {
    ...
    function initDownloadNeo() {
        const components = document.querySelectorAll('.ema-download--neo');
        ...
        console.log(`Download neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Download neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Download neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDownloadNeo);
    } else {
        initDownloadNeo();
    }
