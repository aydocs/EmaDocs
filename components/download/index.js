/**
 * Download Component - Main Entry Point
...
// Export component
export { default as Download } from './download.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Download', {
    name: 'Download',
...
console.log('Download component loaded with 5 variants');
