...
(function() {
    ...
    function initZoomNeo() {
        const components = document.querySelectorAll('.ema-zoom--neo');
        ...
        console.log(`Zoom neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Zoom neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initZoomNeo);
    } else {
        initZoomNeo();
    }
