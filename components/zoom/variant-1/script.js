/**
 * Zoom Component - minimal Variant
...
(function() {
    ...
    function initZoomMinimal() {
        const components = document.querySelectorAll('.ema-zoom--minimal');
        ...
        console.log(`Zoom minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Zoom minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Zoom minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initZoomMinimal);
    } else {
        initZoomMinimal();
    }
