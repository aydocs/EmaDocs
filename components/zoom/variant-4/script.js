...
(function() {
    ...
    function initZoomGlass() {
        const components = document.querySelectorAll('.ema-zoom--glass');
        ...
        console.log(`Zoom glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Zoom glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Zoom glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initZoomGlass);
    } else {
        initZoomGlass();
    }
