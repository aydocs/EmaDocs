/**
 * Zoom Component - premium Variant
...
(function() {
    ...
    function initZoomPremium() {
        const components = document.querySelectorAll('.ema-zoom--premium');
        ...
        console.log(`Zoom premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Zoom component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Zoom premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('zoom:click', {
    ...
    window.handleClick = function() {
        console.log('Zoom premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initZoomPremium);
    } else {
        initZoomPremium();
    }
