...
A comprehensive Zoom component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Zoom variant="minimal">Minimal</Zoom>
<Zoom variant="neo">Neo</Zoom>
<Zoom variant="soft">Soft</Zoom>
<Zoom variant="glass">Glass</Zoom>
<Zoom variant="premium">Premium</Zoom>
```
...
- `zoom.ema` - Main component definition
