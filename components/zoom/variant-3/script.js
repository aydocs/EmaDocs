...
(function() {
    ...
    function initZoomSoft() {
        const components = document.querySelectorAll('.ema-zoom--soft');
        ...
        console.log(`Zoom soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Zoom soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initZoomSoft);
    } else {
        initZoomSoft();
    }
