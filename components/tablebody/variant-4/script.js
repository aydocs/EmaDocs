...
(function() {
    ...
    function initTableBodyGlass() {
        const components = document.querySelectorAll('.ema-tablebody--glass');
        ...
        console.log(`TableBody glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableBody glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TableBody glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableBodyGlass);
    } else {
        initTableBodyGlass();
    }
