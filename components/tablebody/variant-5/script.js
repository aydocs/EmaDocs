/**
 * TableBody Component - premium Variant
...
(function() {
    ...
    function initTableBodyPremium() {
        const components = document.querySelectorAll('.ema-tablebody--premium');
        ...
        console.log(`TableBody premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableBody premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TableBody premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableBodyPremium);
    } else {
        initTableBodyPremium();
    }
