/**
 * TableBody Component - soft Variant
...
(function() {
    ...
    function initTableBodySoft() {
        const components = document.querySelectorAll('.ema-tablebody--soft');
        ...
        console.log(`TableBody soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableBody soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TableBody soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableBodySoft);
    } else {
        initTableBodySoft();
    }
