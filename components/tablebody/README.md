...
A comprehensive TableBody component for Emadocs Framework with 5 beautiful variants.
...
```ema
<TableBody variant="minimal">Minimal</TableBody>
<TableBody variant="neo">Neo</TableBody>
<TableBody variant="soft">Soft</TableBody>
<TableBody variant="glass">Glass</TableBody>
<TableBody variant="premium">Premium</TableBody>
```
...
- `tablebody.ema` - Main component definition
