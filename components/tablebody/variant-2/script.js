/**
 * TableBody Component - neo Variant
...
(function() {
    ...
    function initTableBodyNeo() {
        const components = document.querySelectorAll('.ema-tablebody--neo');
        ...
        console.log(`TableBody neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableBody neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TableBody neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableBodyNeo);
    } else {
        initTableBodyNeo();
    }
