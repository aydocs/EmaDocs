/**
 * TableBody Component - minimal Variant
...
(function() {
    ...
    function initTableBodyMinimal() {
        const components = document.querySelectorAll('.ema-tablebody--minimal');
        ...
        console.log(`TableBody minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TableBody component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableBody minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tablebody:click', {
    ...
    window.handleClick = function() {
        console.log('TableBody minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableBodyMinimal);
    } else {
        initTableBodyMinimal();
    }
