/**
 * TreeNode Component - glass Variant
...
(function() {
    ...
    function initTreeNodeGlass() {
        const components = document.querySelectorAll('.ema-treenode--glass');
        ...
        console.log(`TreeNode glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeNode glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeNode glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNodeGlass);
    } else {
        initTreeNodeGlass();
    }
