/**
 * TreeNode Component - neo Variant
...
(function() {
    ...
    function initTreeNodeNeo() {
        const components = document.querySelectorAll('.ema-treenode--neo');
        ...
        console.log(`TreeNode neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeNode neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeNode neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNodeNeo);
    } else {
        initTreeNodeNeo();
    }
