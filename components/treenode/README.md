...
A comprehensive TreeNode component for Emadocs Framework with 5 beautiful variants.
...
```ema
<TreeNode variant="minimal">Minimal</TreeNode>
<TreeNode variant="neo">Neo</TreeNode>
<TreeNode variant="soft">Soft</TreeNode>
<TreeNode variant="glass">Glass</TreeNode>
<TreeNode variant="premium">Premium</TreeNode>
```
...
- `treenode.ema` - Main component definition
