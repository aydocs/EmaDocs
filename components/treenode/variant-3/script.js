/**
 * TreeNode Component - soft Variant
...
(function() {
    ...
    function initTreeNodeSoft() {
        const components = document.querySelectorAll('.ema-treenode--soft');
        ...
        console.log(`TreeNode soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeNode soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeNode soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNodeSoft);
    } else {
        initTreeNodeSoft();
    }
