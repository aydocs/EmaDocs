/**
 * TreeNode Component - premium Variant
...
(function() {
    ...
    function initTreeNodePremium() {
        const components = document.querySelectorAll('.ema-treenode--premium');
        ...
        console.log(`TreeNode premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeNode premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeNode premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNodePremium);
    } else {
        initTreeNodePremium();
    }
