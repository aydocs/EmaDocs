/**
 * TreeNode Component - minimal Variant
...
(function() {
    ...
    function initTreeNodeMinimal() {
        const components = document.querySelectorAll('.ema-treenode--minimal');
        ...
        console.log(`TreeNode minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TreeNode component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeNode minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('treenode:click', {
    ...
    window.handleClick = function() {
        console.log('TreeNode minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNodeMinimal);
    } else {
        initTreeNodeMinimal();
    }
