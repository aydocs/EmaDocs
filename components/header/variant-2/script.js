...
(function() {
    ...
    function initHeaderNeo() {
        const components = document.querySelectorAll('.ema-header--neo');
        ...
        console.log(`Header neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Header neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Header neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeaderNeo);
    } else {
        initHeaderNeo();
    }
