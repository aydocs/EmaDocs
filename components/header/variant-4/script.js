/**
 * Header Component - glass Variant
...
(function() {
    ...
    function initHeaderGlass() {
        const components = document.querySelectorAll('.ema-header--glass');
        ...
        console.log(`Header glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Header glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Header glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeaderGlass);
    } else {
        initHeaderGlass();
    }
