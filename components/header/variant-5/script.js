/**
 * Header Component - premium Variant
...
(function() {
    ...
    function initHeaderPremium() {
        const components = document.querySelectorAll('.ema-header--premium');
        ...
        console.log(`Header premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Header premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Header premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeaderPremium);
    } else {
        initHeaderPremium();
    }
