/**
 * Header Component - minimal Variant
...
(function() {
    ...
    function initHeaderMinimal() {
        const components = document.querySelectorAll('.ema-header--minimal');
        ...
        console.log(`Header minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Header minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Header minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeaderMinimal);
    } else {
        initHeaderMinimal();
    }
