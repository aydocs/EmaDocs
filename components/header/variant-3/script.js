...
(function() {
    ...
    function initHeaderSoft() {
        const components = document.querySelectorAll('.ema-header--soft');
        ...
        console.log(`Header soft variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Header component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Header soft clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('header:click', {
    ...
    window.handleClick = function() {
        console.log('Header soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeaderSoft);
    } else {
        initHeaderSoft();
    }
