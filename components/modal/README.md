...
A comprehensive Modal component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Modal variant="minimal">Minimal</Modal>
<Modal variant="neo">Neo</Modal>
<Modal variant="soft">Soft</Modal>
<Modal variant="glass">Glass</Modal>
<Modal variant="premium">Premium</Modal>
```
...
- `modal.ema` - Main component definition
