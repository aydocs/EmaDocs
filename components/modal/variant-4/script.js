...
(function() {
    ...
    function initModalGlass() {
        const components = document.querySelectorAll('.ema-modal--glass');
        ...
        console.log(`Modal glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Modal glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Modal glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initModalGlass);
    } else {
        initModalGlass();
    }
