...
(function() {
    ...
    function initModalNeo() {
        const components = document.querySelectorAll('.ema-modal--neo');
        ...
        console.log(`Modal neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Modal neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initModalNeo);
    } else {
        initModalNeo();
    }
