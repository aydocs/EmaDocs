/**
 * Modal Component - premium Variant
...
(function() {
    ...
    function initModalPremium() {
        const components = document.querySelectorAll('.ema-modal--premium');
        ...
        console.log(`Modal premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Modal premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Modal premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initModalPremium);
    } else {
        initModalPremium();
    }
