...
(function() {
    ...
    function initModalSoft() {
        const components = document.querySelectorAll('.ema-modal--soft');
        ...
        console.log(`Modal soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Modal soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Modal soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initModalSoft);
    } else {
        initModalSoft();
    }
