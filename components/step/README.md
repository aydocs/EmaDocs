...
A comprehensive Step component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Step variant="minimal">Minimal</Step>
<Step variant="neo">Neo</Step>
<Step variant="soft">Soft</Step>
<Step variant="glass">Glass</Step>
<Step variant="premium">Premium</Step>
```
...
- `step.ema` - Main component definition
