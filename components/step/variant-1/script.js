/**
 * Step Component - minimal Variant
...
(function() {
    ...
    function initStepMinimal() {
        const components = document.querySelectorAll('.ema-step--minimal');
        ...
        console.log(`Step minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Step component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Step minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('step:click', {
    ...
    window.handleClick = function() {
        console.log('Step minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepMinimal);
    } else {
        initStepMinimal();
    }
