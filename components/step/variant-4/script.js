...
(function() {
    ...
    function initStepGlass() {
        const components = document.querySelectorAll('.ema-step--glass');
        ...
        console.log(`Step glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Step glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Step glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepGlass);
    } else {
        initStepGlass();
    }
