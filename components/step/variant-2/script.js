...
(function() {
    ...
    function initStepNeo() {
        const components = document.querySelectorAll('.ema-step--neo');
        ...
        console.log(`Step neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Step neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepNeo);
    } else {
        initStepNeo();
    }
