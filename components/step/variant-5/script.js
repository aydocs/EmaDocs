/**
 * Step Component - premium Variant
...
(function() {
    ...
    function initStepPremium() {
        const components = document.querySelectorAll('.ema-step--premium');
        ...
        console.log(`Step premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Step premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Step premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepPremium);
    } else {
        initStepPremium();
    }
