...
(function() {
    ...
    function initStepSoft() {
        const components = document.querySelectorAll('.ema-step--soft');
        ...
        console.log(`Step soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Step soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepSoft);
    } else {
        initStepSoft();
    }
