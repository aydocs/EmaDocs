/**
 * Spinner Component - premium Variant
...
(function() {
    ...
    function initSpinnerPremium() {
        const components = document.querySelectorAll('.ema-spinner--premium');
        ...
        console.log(`Spinner premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spinner premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Spinner premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpinnerPremium);
    } else {
        initSpinnerPremium();
    }
