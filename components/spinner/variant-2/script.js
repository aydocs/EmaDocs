...
(function() {
    ...
    function initSpinnerNeo() {
        const components = document.querySelectorAll('.ema-spinner--neo');
        ...
        console.log(`Spinner neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spinner neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Spinner neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpinnerNeo);
    } else {
        initSpinnerNeo();
    }
