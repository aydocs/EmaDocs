/**
 * Spinner Component - minimal Variant
...
(function() {
    ...
    function initSpinnerMinimal() {
        const components = document.querySelectorAll('.ema-spinner--minimal');
        ...
        console.log(`Spinner minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Spinner component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spinner minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('spinner:click', {
    ...
    window.handleClick = function() {
        console.log('Spinner minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpinnerMinimal);
    } else {
        initSpinnerMinimal();
    }
