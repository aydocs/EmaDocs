/**
 * Spinner Component - soft Variant
...
(function() {
    ...
    function initSpinnerSoft() {
        const components = document.querySelectorAll('.ema-spinner--soft');
        ...
        console.log(`Spinner soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spinner soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Spinner soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpinnerSoft);
    } else {
        initSpinnerSoft();
    }
