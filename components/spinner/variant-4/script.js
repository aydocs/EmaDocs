/**
 * Spinner Component - glass Variant
...
(function() {
    ...
    function initSpinnerGlass() {
        const components = document.querySelectorAll('.ema-spinner--glass');
        ...
        console.log(`Spinner glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spinner glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Spinner glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpinnerGlass);
    } else {
        initSpinnerGlass();
    }
