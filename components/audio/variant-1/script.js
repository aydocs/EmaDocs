/**
 * Audio Component - minimal Variant
...
(function() {
    ...
    function initAudioMinimal() {
        const components = document.querySelectorAll('.ema-audio--minimal');
        ...
        console.log(`Audio minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Audio component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Audio minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('audio:click', {
    ...
    window.handleClick = function() {
        console.log('Audio minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAudioMinimal);
    } else {
        initAudioMinimal();
    }
