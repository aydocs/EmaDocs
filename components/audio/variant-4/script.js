...
(function() {
    ...
    function initAudioGlass() {
        const components = document.querySelectorAll('.ema-audio--glass');
        ...
        console.log(`Audio glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Audio glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Audio glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAudioGlass);
    } else {
        initAudioGlass();
    }
