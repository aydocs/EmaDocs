...
(function() {
    ...
    function initAudioSoft() {
        const components = document.querySelectorAll('.ema-audio--soft');
        ...
        console.log(`Audio soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Audio soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Audio soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAudioSoft);
    } else {
        initAudioSoft();
    }
