/**
 * Audio Component - premium Variant
...
(function() {
    ...
    function initAudioPremium() {
        const components = document.querySelectorAll('.ema-audio--premium');
        ...
        console.log(`Audio premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Audio premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Audio premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAudioPremium);
    } else {
        initAudioPremium();
    }
