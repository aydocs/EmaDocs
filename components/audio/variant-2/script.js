...
(function() {
    ...
    function initAudioNeo() {
        const components = document.querySelectorAll('.ema-audio--neo');
        ...
        console.log(`Audio neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Audio neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAudioNeo);
    } else {
        initAudioNeo();
    }
