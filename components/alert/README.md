...
A comprehensive Alert component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Alert variant="minimal">Minimal</Alert>
<Alert variant="neo">Neo</Alert>
<Alert variant="soft">Soft</Alert>
<Alert variant="glass">Glass</Alert>
<Alert variant="premium">Premium</Alert>
```
...
- `alert.ema` - Main component definition
