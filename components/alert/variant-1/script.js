/**
 * Alert Component - minimal Variant
...
(function() {
    ...
    function initAlertMinimal() {
        const components = document.querySelectorAll('.ema-alert--minimal');
        ...
        console.log(`Alert minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Alert minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Alert minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAlertMinimal);
    } else {
        initAlertMinimal();
    }
