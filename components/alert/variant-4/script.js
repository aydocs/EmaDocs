...
(function() {
    ...
    function initAlertGlass() {
        const components = document.querySelectorAll('.ema-alert--glass');
        ...
        console.log(`Alert glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Alert glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Alert glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAlertGlass);
    } else {
        initAlertGlass();
    }
