...
(function() {
    ...
    function initAlertNeo() {
        const components = document.querySelectorAll('.ema-alert--neo');
        ...
        console.log(`Alert neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Alert neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAlertNeo);
    } else {
        initAlertNeo();
    }
