...
(function() {
    ...
    function initAlertSoft() {
        const components = document.querySelectorAll('.ema-alert--soft');
        ...
        console.log(`Alert soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Alert soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Alert soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAlertSoft);
    } else {
        initAlertSoft();
    }
