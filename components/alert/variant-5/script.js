/**
 * Alert Component - premium Variant
...
(function() {
    ...
    function initAlertPremium() {
        const components = document.querySelectorAll('.ema-alert--premium');
        ...
        console.log(`Alert premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Alert component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Alert premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('alert:click', {
    ...
    window.handleClick = function() {
        console.log('Alert premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAlertPremium);
    } else {
        initAlertPremium();
    }
