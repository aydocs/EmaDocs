/**
 * Alert Component - Main Entry Point
...
// Export component
export { default as Alert } from './alert.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Alert', {
    name: 'Alert',
...
console.log('Alert component loaded with 5 variants');
