...
A comprehensive Calendar component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Calendar variant="minimal">Minimal</Calendar>
<Calendar variant="neo">Neo</Calendar>
<Calendar variant="soft">Soft</Calendar>
<Calendar variant="glass">Glass</Calendar>
<Calendar variant="premium">Premium</Calendar>
```
...
- `calendar.ema` - Main component definition
