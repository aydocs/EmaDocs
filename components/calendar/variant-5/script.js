/**
 * Calendar Component - premium Variant
...
(function() {
    ...
    function initCalendarPremium() {
        const components = document.querySelectorAll('.ema-calendar--premium');
        ...
        console.log(`Calendar premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Calendar premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Calendar premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCalendarPremium);
    } else {
        initCalendarPremium();
    }
