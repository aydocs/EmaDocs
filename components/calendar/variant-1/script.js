/**
 * Calendar Component - minimal Variant
...
(function() {
    ...
    function initCalendarMinimal() {
        const components = document.querySelectorAll('.ema-calendar--minimal');
        ...
        console.log(`Calendar minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Calendar component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Calendar minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('calendar:click', {
    ...
    window.handleClick = function() {
        console.log('Calendar minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCalendarMinimal);
    } else {
        initCalendarMinimal();
    }
