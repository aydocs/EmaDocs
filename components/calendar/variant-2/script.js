/**
 * Calendar Component - neo Variant
...
(function() {
    ...
    function initCalendarNeo() {
        const components = document.querySelectorAll('.ema-calendar--neo');
        ...
        console.log(`Calendar neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Calendar neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Calendar neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCalendarNeo);
    } else {
        initCalendarNeo();
    }
