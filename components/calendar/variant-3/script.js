/**
 * Calendar Component - soft Variant
...
(function() {
    ...
    function initCalendarSoft() {
        const components = document.querySelectorAll('.ema-calendar--soft');
        ...
        console.log(`Calendar soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Calendar soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Calendar soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCalendarSoft);
    } else {
        initCalendarSoft();
    }
