/**
 * Calendar Component - glass Variant
...
(function() {
    ...
    function initCalendarGlass() {
        const components = document.querySelectorAll('.ema-calendar--glass');
        ...
        console.log(`Calendar glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Calendar glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Calendar glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCalendarGlass);
    } else {
        initCalendarGlass();
    }
