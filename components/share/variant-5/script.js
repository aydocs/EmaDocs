/**
 * Share Component - premium Variant
...
(function() {
    ...
    function initSharePremium() {
        const components = document.querySelectorAll('.ema-share--premium');
        ...
        console.log(`Share premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Share premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Share premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSharePremium);
    } else {
        initSharePremium();
    }
