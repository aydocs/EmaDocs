...
(function() {
    ...
    function initShareGlass() {
        const components = document.querySelectorAll('.ema-share--glass');
        ...
        console.log(`Share glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Share glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Share glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShareGlass);
    } else {
        initShareGlass();
    }
