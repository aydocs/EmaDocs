...
A comprehensive Share component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Share variant="minimal">Minimal</Share>
<Share variant="neo">Neo</Share>
<Share variant="soft">Soft</Share>
<Share variant="glass">Glass</Share>
<Share variant="premium">Premium</Share>
```
...
- `share.ema` - Main component definition
