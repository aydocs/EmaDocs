...
(function() {
    ...
    function initShareNeo() {
        const components = document.querySelectorAll('.ema-share--neo');
        ...
        console.log(`Share neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Share neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShareNeo);
    } else {
        initShareNeo();
    }
