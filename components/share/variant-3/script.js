...
(function() {
    ...
    function initShareSoft() {
        const components = document.querySelectorAll('.ema-share--soft');
        ...
        console.log(`Share soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Share soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Share soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShareSoft);
    } else {
        initShareSoft();
    }
