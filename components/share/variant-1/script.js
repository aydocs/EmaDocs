/**
 * Share Component - minimal Variant
...
(function() {
    ...
    function initShareMinimal() {
        const components = document.querySelectorAll('.ema-share--minimal');
        ...
        console.log(`Share minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Share component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Share minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('share:click', {
    ...
    window.handleClick = function() {
        console.log('Share minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShareMinimal);
    } else {
        initShareMinimal();
    }
