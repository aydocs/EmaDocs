/**
 * DragDrop Component - glass Variant
...
(function() {
    ...
    function initDragDropGlass() {
        const components = document.querySelectorAll('.ema-dragdrop--glass');
        ...
        console.log(`DragDrop glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DragDrop glass clicked`);
    ...
    window.handleClick = function() {
        console.log('DragDrop glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragDropGlass);
    } else {
        initDragDropGlass();
    }
