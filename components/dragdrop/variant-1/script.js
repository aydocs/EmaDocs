/**
 * DragDrop Component - minimal Variant
...
(function() {
    ...
    function initDragDropMinimal() {
        const components = document.querySelectorAll('.ema-dragdrop--minimal');
        ...
        console.log(`DragDrop minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DragDrop minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('DragDrop minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragDropMinimal);
    } else {
        initDragDropMinimal();
    }
