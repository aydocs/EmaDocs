/**
 * DragDrop Component - Main Entry Point
...
// Export component
export { default as DragDrop } from './dragdrop.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('DragDrop', {
    name: 'DragDrop',
...
console.log('DragDrop component loaded with 5 variants');
