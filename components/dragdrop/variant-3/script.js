/**
 * DragDrop Component - soft Variant
...
(function() {
    ...
    function initDragDropSoft() {
        const components = document.querySelectorAll('.ema-dragdrop--soft');
        ...
        console.log(`DragDrop soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DragDrop soft clicked`);
    ...
    window.handleClick = function() {
        console.log('DragDrop soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragDropSoft);
    } else {
        initDragDropSoft();
    }
