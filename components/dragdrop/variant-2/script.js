/**
 * DragDrop Component - neo Variant
...
(function() {
    ...
    function initDragDropNeo() {
        const components = document.querySelectorAll('.ema-dragdrop--neo');
        ...
        console.log(`DragDrop neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DragDrop neo clicked`);
    ...
    window.handleClick = function() {
        console.log('DragDrop neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragDropNeo);
    } else {
        initDragDropNeo();
    }
