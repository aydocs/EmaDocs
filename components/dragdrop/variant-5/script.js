/**
 * DragDrop Component - premium Variant
...
(function() {
    ...
    function initDragDropPremium() {
        const components = document.querySelectorAll('.ema-dragdrop--premium');
        ...
        console.log(`DragDrop premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `DragDrop component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DragDrop premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('dragdrop:click', {
    ...
    window.handleClick = function() {
        console.log('DragDrop premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragDropPremium);
    } else {
        initDragDropPremium();
    }
