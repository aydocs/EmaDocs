/**
 * Group Component - Main Entry Point
...
// Export component
export { default as Group } from './group.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Group', {
    name: 'Group',
...
console.log('Group component loaded with 5 variants');
