...
(function() {
    ...
    function initGroupNeo() {
        const components = document.querySelectorAll('.ema-group--neo');
        ...
        console.log(`Group neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Group neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGroupNeo);
    } else {
        initGroupNeo();
    }
