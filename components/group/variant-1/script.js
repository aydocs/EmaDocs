/**
 * Group Component - minimal Variant
...
(function() {
    ...
    function initGroupMinimal() {
        const components = document.querySelectorAll('.ema-group--minimal');
        ...
        console.log(`Group minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Group minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Group minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGroupMinimal);
    } else {
        initGroupMinimal();
    }
