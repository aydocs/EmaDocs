...
(function() {
    ...
    function initGroupSoft() {
        const components = document.querySelectorAll('.ema-group--soft');
        ...
        console.log(`Group soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Group soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Group soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGroupSoft);
    } else {
        initGroupSoft();
    }
