...
A comprehensive Group component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Group variant="minimal">Minimal</Group>
<Group variant="neo">Neo</Group>
<Group variant="soft">Soft</Group>
<Group variant="glass">Glass</Group>
<Group variant="premium">Premium</Group>
```
...
- `group.ema` - Main component definition
