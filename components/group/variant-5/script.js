/**
 * Group Component - premium Variant
...
(function() {
    ...
    function initGroupPremium() {
        const components = document.querySelectorAll('.ema-group--premium');
        ...
        console.log(`Group premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Group component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Group premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('group:click', {
    ...
    window.handleClick = function() {
        console.log('Group premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGroupPremium);
    } else {
        initGroupPremium();
    }
