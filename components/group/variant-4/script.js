...
(function() {
    ...
    function initGroupGlass() {
        const components = document.querySelectorAll('.ema-group--glass');
        ...
        console.log(`Group glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Group glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Group glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGroupGlass);
    } else {
        initGroupGlass();
    }
