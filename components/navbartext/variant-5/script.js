/**
 * NavbarText Component - premium Variant
...
(function() {
    ...
    function initNavbarTextPremium() {
        const components = document.querySelectorAll('.ema-navbartext--premium');
        ...
        console.log(`NavbarText premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarText component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarText premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbartext:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarText premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTextPremium);
    } else {
        initNavbarTextPremium();
    }
