/**
 * NavbarText Component - Main Entry Point
...
// Export component
export { default as NavbarText } from './navbartext.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarText', {
    name: 'NavbarText',
...
console.log('NavbarText component loaded with 5 variants');
