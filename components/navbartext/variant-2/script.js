/**
 * NavbarText Component - neo Variant
...
(function() {
    ...
    function initNavbarTextNeo() {
        const components = document.querySelectorAll('.ema-navbartext--neo');
        ...
        console.log(`NavbarText neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarText neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarText neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTextNeo);
    } else {
        initNavbarTextNeo();
    }
