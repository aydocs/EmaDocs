/**
 * NavbarText Component - soft Variant
...
(function() {
    ...
    function initNavbarTextSoft() {
        const components = document.querySelectorAll('.ema-navbartext--soft');
        ...
        console.log(`NavbarText soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarText soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarText soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTextSoft);
    } else {
        initNavbarTextSoft();
    }
