/**
 * NavbarText Component - minimal Variant
...
(function() {
    ...
    function initNavbarTextMinimal() {
        const components = document.querySelectorAll('.ema-navbartext--minimal');
        ...
        console.log(`NavbarText minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarText minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarText minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTextMinimal);
    } else {
        initNavbarTextMinimal();
    }
