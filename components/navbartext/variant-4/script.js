/**
 * NavbarText Component - glass Variant
...
(function() {
    ...
    function initNavbarTextGlass() {
        const components = document.querySelectorAll('.ema-navbartext--glass');
        ...
        console.log(`NavbarText glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarText glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarText glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTextGlass);
    } else {
        initNavbarTextGlass();
    }
