/**
 * Card Component - premium Variant
...
(function() {
    ...
    function initCardPremium() {
        const components = document.querySelectorAll('.ema-card--premium');
        ...
        console.log(`Card premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Card premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Card premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCardPremium);
    } else {
        initCardPremium();
    }
