/**
 * Card Component - minimal Variant
...
(function() {
    ...
    function initCardMinimal() {
        const components = document.querySelectorAll('.ema-card--minimal');
        ...
        console.log(`Card minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Card component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Card minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('card:click', {
    ...
    window.handleClick = function() {
        console.log('Card minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCardMinimal);
    } else {
        initCardMinimal();
    }
