/**
 * Card Component - Main Entry Point
...
// Export component
export { default as Card } from './card.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Card', {
    name: 'Card',
...
console.log('Card component loaded with 5 variants');
