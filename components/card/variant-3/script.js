...
(function() {
    ...
    function initCardSoft() {
        const components = document.querySelectorAll('.ema-card--soft');
        ...
        console.log(`Card soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Card soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCardSoft);
    } else {
        initCardSoft();
    }
