...
(function() {
    ...
    function initCardNeo() {
        const components = document.querySelectorAll('.ema-card--neo');
        ...
        console.log(`Card neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Card neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCardNeo);
    } else {
        initCardNeo();
    }
