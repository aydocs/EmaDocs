...
(function() {
    ...
    function initCardGlass() {
        const components = document.querySelectorAll('.ema-card--glass');
        ...
        console.log(`Card glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Card glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Card glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCardGlass);
    } else {
        initCardGlass();
    }
