...
(function() {
    ...
    function initInputSoft() {
        const components = document.querySelectorAll('.ema-input--soft');
        ...
        console.log(`Input soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Input soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Input soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInputSoft);
    } else {
        initInputSoft();
    }
