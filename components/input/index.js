/**
 * Input Component - Main Entry Point
...
// Export component
export { default as Input } from './input.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Input', {
    name: 'Input',
...
console.log('Input component loaded with 5 variants');
