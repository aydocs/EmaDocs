...
(function() {
    ...
    function initInputGlass() {
        const components = document.querySelectorAll('.ema-input--glass');
        ...
        console.log(`Input glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Input glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Input glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInputGlass);
    } else {
        initInputGlass();
    }
