...
(function() {
    ...
    function initInputNeo() {
        const components = document.querySelectorAll('.ema-input--neo');
        ...
        console.log(`Input neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Input neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInputNeo);
    } else {
        initInputNeo();
    }
