/**
 * Input Component - premium Variant
...
(function() {
    ...
    function initInputPremium() {
        const components = document.querySelectorAll('.ema-input--premium');
        ...
        console.log(`Input premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Input component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Input premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('input:click', {
    ...
    window.handleClick = function() {
        console.log('Input premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInputPremium);
    } else {
        initInputPremium();
    }
