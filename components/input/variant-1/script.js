/**
 * Input Component - minimal Variant
...
(function() {
    ...
    function initInputMinimal() {
        const components = document.querySelectorAll('.ema-input--minimal');
        ...
        console.log(`Input minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Input minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Input minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInputMinimal);
    } else {
        initInputMinimal();
    }
