...
A comprehensive Input component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Input variant="minimal">Minimal</Input>
<Input variant="neo">Neo</Input>
<Input variant="soft">Soft</Input>
<Input variant="glass">Glass</Input>
<Input variant="premium">Premium</Input>
```
...
- `input.ema` - Main component definition
