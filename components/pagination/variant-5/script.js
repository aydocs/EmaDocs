/**
 * Pagination Component - premium Variant
...
(function() {
    ...
    function initPaginationPremium() {
        const components = document.querySelectorAll('.ema-pagination--premium');
        ...
        console.log(`Pagination premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Pagination component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pagination premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('pagination:click', {
    ...
    window.handleClick = function() {
        console.log('Pagination premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationPremium);
    } else {
        initPaginationPremium();
    }
