/**
 * Pagination Component - minimal Variant
...
(function() {
    ...
    function initPaginationMinimal() {
        const components = document.querySelectorAll('.ema-pagination--minimal');
        ...
        console.log(`Pagination minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pagination minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Pagination minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationMinimal);
    } else {
        initPaginationMinimal();
    }
