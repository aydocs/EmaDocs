/**
 * Pagination Component - glass Variant
...
(function() {
    ...
    function initPaginationGlass() {
        const components = document.querySelectorAll('.ema-pagination--glass');
        ...
        console.log(`Pagination glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pagination glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Pagination glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationGlass);
    } else {
        initPaginationGlass();
    }
