/**
 * Pagination Component - neo Variant
...
(function() {
    ...
    function initPaginationNeo() {
        const components = document.querySelectorAll('.ema-pagination--neo');
        ...
        console.log(`Pagination neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pagination neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Pagination neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationNeo);
    } else {
        initPaginationNeo();
    }
