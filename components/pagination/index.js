/**
 * Pagination Component - Main Entry Point
...
// Export component
export { default as Pagination } from './pagination.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Pagination', {
    name: 'Pagination',
...
console.log('Pagination component loaded with 5 variants');
