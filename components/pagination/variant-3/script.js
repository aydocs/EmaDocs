/**
 * Pagination Component - soft Variant
...
(function() {
    ...
    function initPaginationSoft() {
        const components = document.querySelectorAll('.ema-pagination--soft');
        ...
        console.log(`Pagination soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pagination soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Pagination soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationSoft);
    } else {
        initPaginationSoft();
    }
