/**
 * Thumbnail Component - premium Variant
...
(function() {
    ...
    function initThumbnailPremium() {
        const components = document.querySelectorAll('.ema-thumbnail--premium');
        ...
        console.log(`Thumbnail premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Thumbnail premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Thumbnail premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initThumbnailPremium);
    } else {
        initThumbnailPremium();
    }
