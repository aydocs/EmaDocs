/**
 * Thumbnail Component - minimal Variant
...
(function() {
    ...
    function initThumbnailMinimal() {
        const components = document.querySelectorAll('.ema-thumbnail--minimal');
        ...
        console.log(`Thumbnail minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Thumbnail component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Thumbnail minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('thumbnail:click', {
    ...
    window.handleClick = function() {
        console.log('Thumbnail minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initThumbnailMinimal);
    } else {
        initThumbnailMinimal();
    }
