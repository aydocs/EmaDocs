/**
 * Thumbnail Component - neo Variant
...
(function() {
    ...
    function initThumbnailNeo() {
        const components = document.querySelectorAll('.ema-thumbnail--neo');
        ...
        console.log(`Thumbnail neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Thumbnail neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Thumbnail neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initThumbnailNeo);
    } else {
        initThumbnailNeo();
    }
