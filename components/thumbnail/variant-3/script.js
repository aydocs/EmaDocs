/**
 * Thumbnail Component - soft Variant
...
(function() {
    ...
    function initThumbnailSoft() {
        const components = document.querySelectorAll('.ema-thumbnail--soft');
        ...
        console.log(`Thumbnail soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Thumbnail soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Thumbnail soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initThumbnailSoft);
    } else {
        initThumbnailSoft();
    }
