/**
 * Thumbnail Component - glass Variant
...
(function() {
    ...
    function initThumbnailGlass() {
        const components = document.querySelectorAll('.ema-thumbnail--glass');
        ...
        console.log(`Thumbnail glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Thumbnail glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Thumbnail glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initThumbnailGlass);
    } else {
        initThumbnailGlass();
    }
