/**
 * SortableTable Component - glass Variant
...
(function() {
    ...
    function initSortableTableGlass() {
        const components = document.querySelectorAll('.ema-sortabletable--glass');
        ...
        console.log(`SortableTable glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SortableTable glass clicked`);
    ...
    window.handleClick = function() {
        console.log('SortableTable glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableTableGlass);
    } else {
        initSortableTableGlass();
    }
