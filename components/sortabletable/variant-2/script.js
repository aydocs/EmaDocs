/**
 * SortableTable Component - neo Variant
...
(function() {
    ...
    function initSortableTableNeo() {
        const components = document.querySelectorAll('.ema-sortabletable--neo');
        ...
        console.log(`SortableTable neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SortableTable neo clicked`);
    ...
    window.handleClick = function() {
        console.log('SortableTable neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableTableNeo);
    } else {
        initSortableTableNeo();
    }
