/**
 * SortableTable Component - soft Variant
...
(function() {
    ...
    function initSortableTableSoft() {
        const components = document.querySelectorAll('.ema-sortabletable--soft');
        ...
        console.log(`SortableTable soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SortableTable soft clicked`);
    ...
    window.handleClick = function() {
        console.log('SortableTable soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableTableSoft);
    } else {
        initSortableTableSoft();
    }
