/**
 * SortableTable Component - minimal Variant
...
(function() {
    ...
    function initSortableTableMinimal() {
        const components = document.querySelectorAll('.ema-sortabletable--minimal');
        ...
        console.log(`SortableTable minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SortableTable minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('SortableTable minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableTableMinimal);
    } else {
        initSortableTableMinimal();
    }
