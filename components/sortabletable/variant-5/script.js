/**
 * SortableTable Component - premium Variant
...
(function() {
    ...
    function initSortableTablePremium() {
        const components = document.querySelectorAll('.ema-sortabletable--premium');
        ...
        console.log(`SortableTable premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `SortableTable component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SortableTable premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('sortabletable:click', {
    ...
    window.handleClick = function() {
        console.log('SortableTable premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableTablePremium);
    } else {
        initSortableTablePremium();
    }
