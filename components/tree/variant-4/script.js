...
(function() {
    ...
    function initTreeGlass() {
        const components = document.querySelectorAll('.ema-tree--glass');
        ...
        console.log(`Tree glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tree glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Tree glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeGlass);
    } else {
        initTreeGlass();
    }
