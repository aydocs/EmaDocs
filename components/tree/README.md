...
A comprehensive Tree component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Tree variant="minimal">Minimal</Tree>
<Tree variant="neo">Neo</Tree>
<Tree variant="soft">Soft</Tree>
<Tree variant="glass">Glass</Tree>
<Tree variant="premium">Premium</Tree>
```
...
- `tree.ema` - Main component definition
