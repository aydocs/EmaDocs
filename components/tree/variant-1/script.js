/**
 * Tree Component - minimal Variant
...
(function() {
    ...
    function initTreeMinimal() {
        const components = document.querySelectorAll('.ema-tree--minimal');
        ...
        console.log(`Tree minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tree minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Tree minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeMinimal);
    } else {
        initTreeMinimal();
    }
