/**
 * Tree Component - premium Variant
...
(function() {
    ...
    function initTreePremium() {
        const components = document.querySelectorAll('.ema-tree--premium');
        ...
        console.log(`Tree premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Tree component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tree premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tree:click', {
    ...
    window.handleClick = function() {
        console.log('Tree premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreePremium);
    } else {
        initTreePremium();
    }
