...
(function() {
    ...
    function initTreeSoft() {
        const components = document.querySelectorAll('.ema-tree--soft');
        ...
        console.log(`Tree soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tree soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSoft);
    } else {
        initTreeSoft();
    }
