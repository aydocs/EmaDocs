...
(function() {
    ...
    function initTreeNeo() {
        const components = document.querySelectorAll('.ema-tree--neo');
        ...
        console.log(`Tree neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tree neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeNeo);
    } else {
        initTreeNeo();
    }
