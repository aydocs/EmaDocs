...
(function() {
    ...
    function initDeviceSoft() {
        const components = document.querySelectorAll('.ema-device--soft');
        ...
        console.log(`Device soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Device soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Device soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDeviceSoft);
    } else {
        initDeviceSoft();
    }
