/**
 * Device Component - glass Variant
...
(function() {
    ...
    function initDeviceGlass() {
        const components = document.querySelectorAll('.ema-device--glass');
        ...
        console.log(`Device glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Device glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Device glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDeviceGlass);
    } else {
        initDeviceGlass();
    }
