/**
 * Device Component - premium Variant
...
(function() {
    ...
    function initDevicePremium() {
        const components = document.querySelectorAll('.ema-device--premium');
        ...
        console.log(`Device premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Device component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Device premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('device:click', {
    ...
    window.handleClick = function() {
        console.log('Device premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDevicePremium);
    } else {
        initDevicePremium();
    }
