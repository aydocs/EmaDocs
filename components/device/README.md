...
A comprehensive Device component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Device variant="minimal">Minimal</Device>
<Device variant="neo">Neo</Device>
<Device variant="soft">Soft</Device>
<Device variant="glass">Glass</Device>
<Device variant="premium">Premium</Device>
```
...
- `device.ema` - Main component definition
