...
(function() {
    ...
    function initDeviceNeo() {
        const components = document.querySelectorAll('.ema-device--neo');
        ...
        console.log(`Device neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Device neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Device neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDeviceNeo);
    } else {
        initDeviceNeo();
    }
