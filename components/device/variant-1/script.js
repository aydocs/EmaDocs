/**
 * Device Component - minimal Variant
...
(function() {
    ...
    function initDeviceMinimal() {
        const components = document.querySelectorAll('.ema-device--minimal');
        ...
        console.log(`Device minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Device minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Device minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDeviceMinimal);
    } else {
        initDeviceMinimal();
    }
