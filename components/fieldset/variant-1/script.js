/**
 * Fieldset Component - minimal Variant
...
(function() {
    ...
    function initFieldsetMinimal() {
        const components = document.querySelectorAll('.ema-fieldset--minimal');
        ...
        console.log(`Fieldset minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Fieldset component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Fieldset minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('fieldset:click', {
    ...
    window.handleClick = function() {
        console.log('Fieldset minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldsetMinimal);
    } else {
        initFieldsetMinimal();
    }
