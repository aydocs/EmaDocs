/**
 * Fieldset Component - Main Entry Point
...
// Export component
export { default as Fieldset } from './fieldset.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Fieldset', {
    name: 'Fieldset',
...
console.log('Fieldset component loaded with 5 variants');
