/**
 * Fieldset Component - soft Variant
...
(function() {
    ...
    function initFieldsetSoft() {
        const components = document.querySelectorAll('.ema-fieldset--soft');
        ...
        console.log(`Fieldset soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Fieldset soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Fieldset soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldsetSoft);
    } else {
        initFieldsetSoft();
    }
