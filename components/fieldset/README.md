...
A comprehensive Fieldset component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Fieldset variant="minimal">Minimal</Fieldset>
<Fieldset variant="neo">Neo</Fieldset>
<Fieldset variant="soft">Soft</Fieldset>
<Fieldset variant="glass">Glass</Fieldset>
<Fieldset variant="premium">Premium</Fieldset>
```
...
- `fieldset.ema` - Main component definition
