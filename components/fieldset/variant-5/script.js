/**
 * Fieldset Component - premium Variant
...
(function() {
    ...
    function initFieldsetPremium() {
        const components = document.querySelectorAll('.ema-fieldset--premium');
        ...
        console.log(`Fieldset premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Fieldset premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Fieldset premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldsetPremium);
    } else {
        initFieldsetPremium();
    }
