/**
 * Fieldset Component - glass Variant
...
(function() {
    ...
    function initFieldsetGlass() {
        const components = document.querySelectorAll('.ema-fieldset--glass');
        ...
        console.log(`Fieldset glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Fieldset glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Fieldset glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldsetGlass);
    } else {
        initFieldsetGlass();
    }
