/**
 * Fieldset Component - neo Variant
...
(function() {
    ...
    function initFieldsetNeo() {
        const components = document.querySelectorAll('.ema-fieldset--neo');
        ...
        console.log(`Fieldset neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Fieldset neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Fieldset neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldsetNeo);
    } else {
        initFieldsetNeo();
    }
