/**
 * Import Component - premium Variant
...
(function() {
    ...
    function initImportPremium() {
        const components = document.querySelectorAll('.ema-import--premium');
        ...
        console.log(`Import premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Import premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Import premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImportPremium);
    } else {
        initImportPremium();
    }
