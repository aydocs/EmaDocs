/**
 * Import Component - Main Entry Point
...
// Export component
export { default as Import } from './import.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Import', {
    name: 'Import',
...
console.log('Import component loaded with 5 variants');
