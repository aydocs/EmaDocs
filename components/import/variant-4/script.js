/**
 * Import Component - glass Variant
...
(function() {
    ...
    function initImportGlass() {
        const components = document.querySelectorAll('.ema-import--glass');
        ...
        console.log(`Import glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Import glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Import glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImportGlass);
    } else {
        initImportGlass();
    }
