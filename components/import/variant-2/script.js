...
(function() {
    ...
    function initImportNeo() {
        const components = document.querySelectorAll('.ema-import--neo');
        ...
        console.log(`Import neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Import neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Import neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImportNeo);
    } else {
        initImportNeo();
    }
