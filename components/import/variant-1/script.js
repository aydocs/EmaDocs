/**
 * Import Component - minimal Variant
...
(function() {
    ...
    function initImportMinimal() {
        const components = document.querySelectorAll('.ema-import--minimal');
        ...
        console.log(`Import minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Import component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Import minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('import:click', {
    ...
    window.handleClick = function() {
        console.log('Import minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImportMinimal);
    } else {
        initImportMinimal();
    }
