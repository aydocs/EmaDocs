...
(function() {
    ...
    function initImportSoft() {
        const components = document.querySelectorAll('.ema-import--soft');
        ...
        console.log(`Import soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Import soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Import soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImportSoft);
    } else {
        initImportSoft();
    }
