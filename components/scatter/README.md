...
A comprehensive Scatter component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Scatter variant="minimal">Minimal</Scatter>
<Scatter variant="neo">Neo</Scatter>
<Scatter variant="soft">Soft</Scatter>
<Scatter variant="glass">Glass</Scatter>
<Scatter variant="premium">Premium</Scatter>
```
...
- `scatter.ema` - Main component definition
