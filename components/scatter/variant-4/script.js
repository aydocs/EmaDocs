/**
 * Scatter Component - glass Variant
...
(function() {
    ...
    function initScatterGlass() {
        const components = document.querySelectorAll('.ema-scatter--glass');
        ...
        console.log(`Scatter glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Scatter glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Scatter glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScatterGlass);
    } else {
        initScatterGlass();
    }
