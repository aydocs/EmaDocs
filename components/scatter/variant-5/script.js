/**
 * Scatter Component - premium Variant
...
(function() {
    ...
    function initScatterPremium() {
        const components = document.querySelectorAll('.ema-scatter--premium');
        ...
        console.log(`Scatter premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Scatter premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Scatter premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScatterPremium);
    } else {
        initScatterPremium();
    }
