/**
 * Scatter Component - minimal Variant
...
(function() {
    ...
    function initScatterMinimal() {
        const components = document.querySelectorAll('.ema-scatter--minimal');
        ...
        console.log(`Scatter minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Scatter component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Scatter minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('scatter:click', {
    ...
    window.handleClick = function() {
        console.log('Scatter minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScatterMinimal);
    } else {
        initScatterMinimal();
    }
