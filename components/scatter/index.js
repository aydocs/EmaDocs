/**
 * Scatter Component - Main Entry Point
...
// Export component
export { default as Scatter } from './scatter.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Scatter', {
    name: 'Scatter',
...
console.log('Scatter component loaded with 5 variants');
