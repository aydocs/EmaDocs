/**
 * Scatter Component - soft Variant
...
(function() {
    ...
    function initScatterSoft() {
        const components = document.querySelectorAll('.ema-scatter--soft');
        ...
        console.log(`Scatter soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Scatter soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Scatter soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScatterSoft);
    } else {
        initScatterSoft();
    }
