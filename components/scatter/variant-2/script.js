...
(function() {
    ...
    function initScatterNeo() {
        const components = document.querySelectorAll('.ema-scatter--neo');
        ...
        console.log(`Scatter neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Scatter neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Scatter neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScatterNeo);
    } else {
        initScatterNeo();
    }
