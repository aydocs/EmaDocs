/**
 * Divider Component - soft Variant
...
(function() {
    ...
    function initDividerSoft() {
        const components = document.querySelectorAll('.ema-divider--soft');
        ...
        console.log(`Divider soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Divider soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Divider soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDividerSoft);
    } else {
        initDividerSoft();
    }
