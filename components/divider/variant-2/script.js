...
(function() {
    ...
    function initDividerNeo() {
        const components = document.querySelectorAll('.ema-divider--neo');
        ...
        console.log(`Divider neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Divider neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Divider neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDividerNeo);
    } else {
        initDividerNeo();
    }
