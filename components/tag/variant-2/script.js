...
(function() {
    ...
    function initTagNeo() {
        const components = document.querySelectorAll('.ema-tag--neo');
        ...
        console.log(`Tag neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tag neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTagNeo);
    } else {
        initTagNeo();
    }
