...
(function() {
    ...
    function initTagGlass() {
        const components = document.querySelectorAll('.ema-tag--glass');
        ...
        console.log(`Tag glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tag glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTagGlass);
    } else {
        initTagGlass();
    }
