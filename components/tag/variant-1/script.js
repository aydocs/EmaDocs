...
(function() {
    ...
    function initTagMinimal() {
        const components = document.querySelectorAll('.ema-tag--minimal');
        ...
        console.log(`Tag minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Tag component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tag minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tag:click', {
    ...
    window.handleClick = function() {
        console.log('Tag minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTagMinimal);
    } else {
        initTagMinimal();
    }
