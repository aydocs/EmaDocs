...
(function() {
    ...
    function initTagPremium() {
        const components = document.querySelectorAll('.ema-tag--premium');
        ...
        console.log(`Tag premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tag premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Tag premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTagPremium);
    } else {
        initTagPremium();
    }
