...
(function() {
    ...
    function initTagSoft() {
        const components = document.querySelectorAll('.ema-tag--soft');
        ...
        console.log(`Tag soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tag soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTagSoft);
    } else {
        initTagSoft();
    }
