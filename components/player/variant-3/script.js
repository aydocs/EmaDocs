...
(function() {
    ...
    function initPlayerSoft() {
        const components = document.querySelectorAll('.ema-player--soft');
        ...
        console.log(`Player soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Player soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Player soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPlayerSoft);
    } else {
        initPlayerSoft();
    }
