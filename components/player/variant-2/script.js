...
(function() {
    ...
    function initPlayerNeo() {
        const components = document.querySelectorAll('.ema-player--neo');
        ...
        console.log(`Player neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Player neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Player neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPlayerNeo);
    } else {
        initPlayerNeo();
    }
