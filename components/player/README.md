...
A comprehensive Player component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Player variant="minimal">Minimal</Player>
<Player variant="neo">Neo</Player>
<Player variant="soft">Soft</Player>
<Player variant="glass">Glass</Player>
<Player variant="premium">Premium</Player>
```
...
- `player.ema` - Main component definition
