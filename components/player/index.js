/**
 * Player Component - Main Entry Point
...
// Export component
export { default as Player } from './player.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Player', {
    name: 'Player',
...
console.log('Player component loaded with 5 variants');
