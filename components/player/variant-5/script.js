/**
 * Player Component - premium Variant
...
(function() {
    ...
    function initPlayerPremium() {
        const components = document.querySelectorAll('.ema-player--premium');
        ...
        console.log(`Player premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Player component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Player premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('player:click', {
    ...
    window.handleClick = function() {
        console.log('Player premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPlayerPremium);
    } else {
        initPlayerPremium();
    }
