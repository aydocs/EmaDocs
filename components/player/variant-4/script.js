/**
 * Player Component - glass Variant
...
(function() {
    ...
    function initPlayerGlass() {
        const components = document.querySelectorAll('.ema-player--glass');
        ...
        console.log(`Player glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Player glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Player glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPlayerGlass);
    } else {
        initPlayerGlass();
    }
