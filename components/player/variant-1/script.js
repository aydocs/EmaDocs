...
(function() {
    ...
    function initPlayerMinimal() {
        const components = document.querySelectorAll('.ema-player--minimal');
        ...
        console.log(`Player minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Player minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Player minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPlayerMinimal);
    } else {
        initPlayerMinimal();
    }
