/**
 * TableFooter Component - premium Variant
...
(function() {
    ...
    function initTableFooterPremium() {
        const components = document.querySelectorAll('.ema-tablefooter--premium');
        ...
        console.log(`TableFooter premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableFooter premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TableFooter premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableFooterPremium);
    } else {
        initTableFooterPremium();
    }
