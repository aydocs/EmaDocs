/**
 * TableFooter Component - neo Variant
...
(function() {
    ...
    function initTableFooterNeo() {
        const components = document.querySelectorAll('.ema-tablefooter--neo');
        ...
        console.log(`TableFooter neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableFooter neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TableFooter neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableFooterNeo);
    } else {
        initTableFooterNeo();
    }
