...
A comprehensive TableFooter component for Emadocs Framework with 5 beautiful variants.
...
```ema
<TableFooter variant="minimal">Minimal</TableFooter>
<TableFooter variant="neo">Neo</TableFooter>
<TableFooter variant="soft">Soft</TableFooter>
<TableFooter variant="glass">Glass</TableFooter>
<TableFooter variant="premium">Premium</TableFooter>
```
...
- `tablefooter.ema` - Main component definition
