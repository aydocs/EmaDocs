/**
 * TableFooter Component - soft Variant
...
(function() {
    ...
    function initTableFooterSoft() {
        const components = document.querySelectorAll('.ema-tablefooter--soft');
        ...
        console.log(`TableFooter soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableFooter soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TableFooter soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableFooterSoft);
    } else {
        initTableFooterSoft();
    }
