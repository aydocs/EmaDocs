...
(function() {
    ...
    function initTableFooterGlass() {
        const components = document.querySelectorAll('.ema-tablefooter--glass');
        ...
        console.log(`TableFooter glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableFooter glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TableFooter glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableFooterGlass);
    } else {
        initTableFooterGlass();
    }
