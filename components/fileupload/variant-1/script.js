/**
 * FileUpload Component - minimal Variant
...
(function() {
    ...
    function initFileUploadMinimal() {
        const components = document.querySelectorAll('.ema-fileupload--minimal');
        ...
        console.log(`FileUpload minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `FileUpload component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`FileUpload minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('fileupload:click', {
    ...
    window.handleClick = function() {
        console.log('FileUpload minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFileUploadMinimal);
    } else {
        initFileUploadMinimal();
    }
