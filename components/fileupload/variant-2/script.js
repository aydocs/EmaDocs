/**
 * FileUpload Component - neo Variant
...
(function() {
    ...
    function initFileUploadNeo() {
        const components = document.querySelectorAll('.ema-fileupload--neo');
        ...
        console.log(`FileUpload neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`FileUpload neo clicked`);
    ...
    window.handleClick = function() {
        console.log('FileUpload neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFileUploadNeo);
    } else {
        initFileUploadNeo();
    }
