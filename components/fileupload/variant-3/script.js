/**
 * FileUpload Component - soft Variant
...
(function() {
    ...
    function initFileUploadSoft() {
        const components = document.querySelectorAll('.ema-fileupload--soft');
        ...
        console.log(`FileUpload soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`FileUpload soft clicked`);
    ...
    window.handleClick = function() {
        console.log('FileUpload soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFileUploadSoft);
    } else {
        initFileUploadSoft();
    }
