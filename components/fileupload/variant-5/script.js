/**
 * FileUpload Component - premium Variant
...
(function() {
    ...
    function initFileUploadPremium() {
        const components = document.querySelectorAll('.ema-fileupload--premium');
        ...
        console.log(`FileUpload premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`FileUpload premium clicked`);
    ...
    window.handleClick = function() {
        console.log('FileUpload premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFileUploadPremium);
    } else {
        initFileUploadPremium();
    }
