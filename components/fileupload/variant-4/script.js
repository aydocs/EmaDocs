/**
 * FileUpload Component - glass Variant
...
(function() {
    ...
    function initFileUploadGlass() {
        const components = document.querySelectorAll('.ema-fileupload--glass');
        ...
        console.log(`FileUpload glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`FileUpload glass clicked`);
    ...
    window.handleClick = function() {
        console.log('FileUpload glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFileUploadGlass);
    } else {
        initFileUploadGlass();
    }
