...
A comprehensive Separator component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Separator variant="minimal">Minimal</Separator>
<Separator variant="neo">Neo</Separator>
<Separator variant="soft">Soft</Separator>
<Separator variant="glass">Glass</Separator>
<Separator variant="premium">Premium</Separator>
```
...
- `separator.ema` - Main component definition
