/**
 * Separator Component - soft Variant
...
(function() {
    ...
    function initSeparatorSoft() {
        const components = document.querySelectorAll('.ema-separator--soft');
        ...
        console.log(`Separator soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Separator soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Separator soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSeparatorSoft);
    } else {
        initSeparatorSoft();
    }
