/**
 * Separator Component - neo Variant
...
(function() {
    ...
    function initSeparatorNeo() {
        const components = document.querySelectorAll('.ema-separator--neo');
        ...
        console.log(`Separator neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Separator neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Separator neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSeparatorNeo);
    } else {
        initSeparatorNeo();
    }
