/**
 * Separator Component - glass Variant
...
(function() {
    ...
    function initSeparatorGlass() {
        const components = document.querySelectorAll('.ema-separator--glass');
        ...
        console.log(`Separator glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Separator glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Separator glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSeparatorGlass);
    } else {
        initSeparatorGlass();
    }
