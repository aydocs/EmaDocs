/**
 * Separator Component - minimal Variant
...
(function() {
    ...
    function initSeparatorMinimal() {
        const components = document.querySelectorAll('.ema-separator--minimal');
        ...
        console.log(`Separator minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Separator component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Separator minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('separator:click', {
    ...
    window.handleClick = function() {
        console.log('Separator minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSeparatorMinimal);
    } else {
        initSeparatorMinimal();
    }
