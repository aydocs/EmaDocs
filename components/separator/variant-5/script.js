/**
 * Separator Component - premium Variant
...
(function() {
    ...
    function initSeparatorPremium() {
        const components = document.querySelectorAll('.ema-separator--premium');
        ...
        console.log(`Separator premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Separator premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Separator premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSeparatorPremium);
    } else {
        initSeparatorPremium();
    }
