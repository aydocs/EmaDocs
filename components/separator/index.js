/**
 * Separator Component - Main Entry Point
...
// Export component
export { default as Separator } from './separator.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Separator', {
    name: 'Separator',
...
console.log('Separator component loaded with 5 variants');
