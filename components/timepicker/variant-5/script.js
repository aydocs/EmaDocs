/**
 * TimePicker Component - premium Variant
...
(function() {
    ...
    function initTimePickerPremium() {
        const components = document.querySelectorAll('.ema-timepicker--premium');
        ...
        console.log(`TimePicker premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TimePicker component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimePicker premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('timepicker:click', {
    ...
    window.handleClick = function() {
        console.log('TimePicker premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimePickerPremium);
    } else {
        initTimePickerPremium();
    }
