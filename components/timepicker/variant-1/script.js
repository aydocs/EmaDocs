/**
 * TimePicker Component - minimal Variant
...
(function() {
    ...
    function initTimePickerMinimal() {
        const components = document.querySelectorAll('.ema-timepicker--minimal');
        ...
        console.log(`TimePicker minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimePicker minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('TimePicker minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimePickerMinimal);
    } else {
        initTimePickerMinimal();
    }
