...
(function() {
    ...
    function initTimePickerGlass() {
        const components = document.querySelectorAll('.ema-timepicker--glass');
        ...
        console.log(`TimePicker glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimePicker glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TimePicker glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimePickerGlass);
    } else {
        initTimePickerGlass();
    }
