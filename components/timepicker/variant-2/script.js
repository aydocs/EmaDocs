/**
 * TimePicker Component - neo Variant
...
(function() {
    ...
    function initTimePickerNeo() {
        const components = document.querySelectorAll('.ema-timepicker--neo');
        ...
        console.log(`TimePicker neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimePicker neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TimePicker neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimePickerNeo);
    } else {
        initTimePickerNeo();
    }
