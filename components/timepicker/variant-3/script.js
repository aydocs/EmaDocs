/**
 * TimePicker Component - soft Variant
...
(function() {
    ...
    function initTimePickerSoft() {
        const components = document.querySelectorAll('.ema-timepicker--soft');
        ...
        console.log(`TimePicker soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimePicker soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TimePicker soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimePickerSoft);
    } else {
        initTimePickerSoft();
    }
