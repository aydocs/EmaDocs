/**
 * Rating Component - premium Variant
...
(function() {
    ...
    function initRatingPremium() {
        const components = document.querySelectorAll('.ema-rating--premium');
        ...
        console.log(`Rating premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Rating component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Rating premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('rating:click', {
    ...
    window.handleClick = function() {
        console.log('Rating premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRatingPremium);
    } else {
        initRatingPremium();
    }
