/**
 * Rating Component - minimal Variant
...
(function() {
    ...
    function initRatingMinimal() {
        const components = document.querySelectorAll('.ema-rating--minimal');
        ...
        console.log(`Rating minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Rating minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Rating minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRatingMinimal);
    } else {
        initRatingMinimal();
    }
