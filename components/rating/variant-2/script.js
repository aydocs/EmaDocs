...
(function() {
    ...
    function initRatingNeo() {
        const components = document.querySelectorAll('.ema-rating--neo');
        ...
        console.log(`Rating neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Rating neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Rating neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRatingNeo);
    } else {
        initRatingNeo();
    }
