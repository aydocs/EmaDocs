/**
 * Rating Component - Main Entry Point
...
// Export component
export { default as Rating } from './rating.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Rating', {
    name: 'Rating',
...
console.log('Rating component loaded with 5 variants');
