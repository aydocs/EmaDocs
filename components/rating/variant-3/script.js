...
(function() {
    ...
    function initRatingSoft() {
        const components = document.querySelectorAll('.ema-rating--soft');
        ...
        console.log(`Rating soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Rating soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Rating soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRatingSoft);
    } else {
        initRatingSoft();
    }
