/**
 * Rating Component - glass Variant
...
(function() {
    ...
    function initRatingGlass() {
        const components = document.querySelectorAll('.ema-rating--glass');
        ...
        console.log(`Rating glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Rating glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Rating glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRatingGlass);
    } else {
        initRatingGlass();
    }
