...
(function() {
    ...
    function initFlexSoft() {
        const components = document.querySelectorAll('.ema-flex--soft');
        ...
        console.log(`Flex soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Flex soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFlexSoft);
    } else {
        initFlexSoft();
    }
