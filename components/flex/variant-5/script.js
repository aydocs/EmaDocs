/**
 * Flex Component - premium Variant
...
(function() {
    ...
    function initFlexPremium() {
        const components = document.querySelectorAll('.ema-flex--premium');
        ...
        console.log(`Flex premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Flex component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Flex premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('flex:click', {
    ...
    window.handleClick = function() {
        console.log('Flex premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFlexPremium);
    } else {
        initFlexPremium();
    }
