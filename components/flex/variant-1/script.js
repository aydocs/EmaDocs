/**
 * Flex Component - minimal Variant
...
(function() {
    ...
    function initFlexMinimal() {
        const components = document.querySelectorAll('.ema-flex--minimal');
        ...
        console.log(`Flex minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Flex minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Flex minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFlexMinimal);
    } else {
        initFlexMinimal();
    }
