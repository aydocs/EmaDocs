...
(function() {
    ...
    function initFlexGlass() {
        const components = document.querySelectorAll('.ema-flex--glass');
        ...
        console.log(`Flex glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Flex glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Flex glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFlexGlass);
    } else {
        initFlexGlass();
    }
