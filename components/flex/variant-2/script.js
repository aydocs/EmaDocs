...
(function() {
    ...
    function initFlexNeo() {
        const components = document.querySelectorAll('.ema-flex--neo');
        ...
        console.log(`Flex neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Flex neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFlexNeo);
    } else {
        initFlexNeo();
    }
