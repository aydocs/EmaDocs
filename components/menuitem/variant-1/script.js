/**
 * MenuItem Component - minimal Variant
...
(function() {
    ...
    function initMenuItemMinimal() {
        const components = document.querySelectorAll('.ema-menuitem--minimal');
        ...
        console.log(`MenuItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MenuItem minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('MenuItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuItemMinimal);
    } else {
        initMenuItemMinimal();
    }
