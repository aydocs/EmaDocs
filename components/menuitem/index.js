/**
 * MenuItem Component - Main Entry Point
...
// Export component
export { default as MenuItem } from './menuitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('MenuItem', {
    name: 'MenuItem',
...
console.log('MenuItem component loaded with 5 variants');
