...
A comprehensive MenuItem component for Emadocs Framework with 5 beautiful variants.
...
```ema
<MenuItem variant="minimal">Minimal</MenuItem>
<MenuItem variant="neo">Neo</MenuItem>
<MenuItem variant="soft">Soft</MenuItem>
<MenuItem variant="glass">Glass</MenuItem>
<MenuItem variant="premium">Premium</MenuItem>
```
...
- `menuitem.ema` - Main component definition
