/**
 * MenuItem Component - soft Variant
...
(function() {
    ...
    function initMenuItemSoft() {
        const components = document.querySelectorAll('.ema-menuitem--soft');
        ...
        console.log(`MenuItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MenuItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('MenuItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuItemSoft);
    } else {
        initMenuItemSoft();
    }
