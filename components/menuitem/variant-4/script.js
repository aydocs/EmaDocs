/**
 * MenuItem Component - glass Variant
...
(function() {
    ...
    function initMenuItemGlass() {
        const components = document.querySelectorAll('.ema-menuitem--glass');
        ...
        console.log(`MenuItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MenuItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('MenuItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuItemGlass);
    } else {
        initMenuItemGlass();
    }
