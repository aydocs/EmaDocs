/**
 * MenuItem Component - neo Variant
...
(function() {
    ...
    function initMenuItemNeo() {
        const components = document.querySelectorAll('.ema-menuitem--neo');
        ...
        console.log(`MenuItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MenuItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('MenuItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuItemNeo);
    } else {
        initMenuItemNeo();
    }
