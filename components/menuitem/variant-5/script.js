/**
 * MenuItem Component - premium Variant
...
(function() {
    ...
    function initMenuItemPremium() {
        const components = document.querySelectorAll('.ema-menuitem--premium');
        ...
        console.log(`MenuItem premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `MenuItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MenuItem premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('menuitem:click', {
    ...
    window.handleClick = function() {
        console.log('MenuItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuItemPremium);
    } else {
        initMenuItemPremium();
    }
