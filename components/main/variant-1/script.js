/**
 * Main Component - minimal Variant
...
(function() {
    ...
    function initMainMinimal() {
        const components = document.querySelectorAll('.ema-main--minimal');
        ...
        console.log(`Main minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Main minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Main minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMainMinimal);
    } else {
        initMainMinimal();
    }
