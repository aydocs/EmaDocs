...
(function() {
    ...
    function initMainSoft() {
        const components = document.querySelectorAll('.ema-main--soft');
        ...
        console.log(`Main soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Main soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMainSoft);
    } else {
        initMainSoft();
    }
