/**
 * Main Component - premium Variant
...
(function() {
    ...
    function initMainPremium() {
        const components = document.querySelectorAll('.ema-main--premium');
        ...
        console.log(`Main premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Main component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Main premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('main:click', {
    ...
    window.handleClick = function() {
        console.log('Main premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMainPremium);
    } else {
        initMainPremium();
    }
