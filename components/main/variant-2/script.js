...
(function() {
    ...
    function initMainNeo() {
        const components = document.querySelectorAll('.ema-main--neo');
        ...
        console.log(`Main neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Main neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMainNeo);
    } else {
        initMainNeo();
    }
