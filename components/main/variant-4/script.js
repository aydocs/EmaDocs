...
(function() {
    ...
    function initMainGlass() {
        const components = document.querySelectorAll('.ema-main--glass');
        ...
        console.log(`Main glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Main glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Main glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMainGlass);
    } else {
        initMainGlass();
    }
