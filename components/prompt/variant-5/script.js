/**
 * Prompt Component - premium Variant
...
(function() {
    ...
    function initPromptPremium() {
        const components = document.querySelectorAll('.ema-prompt--premium');
        ...
        console.log(`Prompt premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Prompt premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Prompt premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPromptPremium);
    } else {
        initPromptPremium();
    }
