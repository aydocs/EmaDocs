/**
 * Prompt Component - glass Variant
...
(function() {
    ...
    function initPromptGlass() {
        const components = document.querySelectorAll('.ema-prompt--glass');
        ...
        console.log(`Prompt glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Prompt glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Prompt glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPromptGlass);
    } else {
        initPromptGlass();
    }
