...
A comprehensive Prompt component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Prompt variant="minimal">Minimal</Prompt>
<Prompt variant="neo">Neo</Prompt>
<Prompt variant="soft">Soft</Prompt>
<Prompt variant="glass">Glass</Prompt>
<Prompt variant="premium">Premium</Prompt>
```
...
- `prompt.ema` - Main component definition
