/**
 * Prompt Component - minimal Variant
...
(function() {
    ...
    function initPromptMinimal() {
        const components = document.querySelectorAll('.ema-prompt--minimal');
        ...
        console.log(`Prompt minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Prompt component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Prompt minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('prompt:click', {
    ...
    window.handleClick = function() {
        console.log('Prompt minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPromptMinimal);
    } else {
        initPromptMinimal();
    }
