...
(function() {
    ...
    function initPromptNeo() {
        const components = document.querySelectorAll('.ema-prompt--neo');
        ...
        console.log(`Prompt neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Prompt neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Prompt neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPromptNeo);
    } else {
        initPromptNeo();
    }
