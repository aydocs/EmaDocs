...
(function() {
    ...
    function initPromptSoft() {
        const components = document.querySelectorAll('.ema-prompt--soft');
        ...
        console.log(`Prompt soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Prompt soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Prompt soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPromptSoft);
    } else {
        initPromptSoft();
    }
