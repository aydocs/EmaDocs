/**
 * LazyLoad Component - soft Variant
...
(function() {
    ...
    function initLazyLoadSoft() {
        const components = document.querySelectorAll('.ema-lazyload--soft');
        ...
        console.log(`LazyLoad soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`LazyLoad soft clicked`);
    ...
    window.handleClick = function() {
        console.log('LazyLoad soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLazyLoadSoft);
    } else {
        initLazyLoadSoft();
    }
