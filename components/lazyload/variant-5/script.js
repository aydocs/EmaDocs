/**
 * LazyLoad Component - premium Variant
...
(function() {
    ...
    function initLazyLoadPremium() {
        const components = document.querySelectorAll('.ema-lazyload--premium');
        ...
        console.log(`LazyLoad premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `LazyLoad component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`LazyLoad premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('lazyload:click', {
    ...
    window.handleClick = function() {
        console.log('LazyLoad premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLazyLoadPremium);
    } else {
        initLazyLoadPremium();
    }
