...
A comprehensive LazyLoad component for Emadocs Framework with 5 beautiful variants.
...
```ema
<LazyLoad variant="minimal">Minimal</LazyLoad>
<LazyLoad variant="neo">Neo</LazyLoad>
<LazyLoad variant="soft">Soft</LazyLoad>
<LazyLoad variant="glass">Glass</LazyLoad>
<LazyLoad variant="premium">Premium</LazyLoad>
```
...
- `lazyload.ema` - Main component definition
