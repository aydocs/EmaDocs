/**
 * LazyLoad Component - neo Variant
...
(function() {
    ...
    function initLazyLoadNeo() {
        const components = document.querySelectorAll('.ema-lazyload--neo');
        ...
        console.log(`LazyLoad neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`LazyLoad neo clicked`);
    ...
    window.handleClick = function() {
        console.log('LazyLoad neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLazyLoadNeo);
    } else {
        initLazyLoadNeo();
    }
