/**
 * LazyLoad Component - Main Entry Point
...
// Export component
export { default as LazyLoad } from './lazyload.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('LazyLoad', {
    name: 'LazyLoad',
...
console.log('LazyLoad component loaded with 5 variants');
