/**
 * LazyLoad Component - glass Variant
...
(function() {
    ...
    function initLazyLoadGlass() {
        const components = document.querySelectorAll('.ema-lazyload--glass');
        ...
        console.log(`LazyLoad glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`LazyLoad glass clicked`);
    ...
    window.handleClick = function() {
        console.log('LazyLoad glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLazyLoadGlass);
    } else {
        initLazyLoadGlass();
    }
