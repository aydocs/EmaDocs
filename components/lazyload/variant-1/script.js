/**
 * LazyLoad Component - minimal Variant
...
(function() {
    ...
    function initLazyLoadMinimal() {
        const components = document.querySelectorAll('.ema-lazyload--minimal');
        ...
        console.log(`LazyLoad minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`LazyLoad minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('LazyLoad minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLazyLoadMinimal);
    } else {
        initLazyLoadMinimal();
    }
