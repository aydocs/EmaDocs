...
(function() {
    ...
    function initGridSoft() {
        const components = document.querySelectorAll('.ema-grid--soft');
        ...
        console.log(`Grid soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Grid soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGridSoft);
    } else {
        initGridSoft();
    }
