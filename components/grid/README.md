...
A comprehensive Grid component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Grid variant="minimal">Minimal</Grid>
<Grid variant="neo">Neo</Grid>
<Grid variant="soft">Soft</Grid>
<Grid variant="glass">Glass</Grid>
<Grid variant="premium">Premium</Grid>
```
...
- `grid.ema` - Main component definition
