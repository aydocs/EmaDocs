...
(function() {
    ...
    function initGridGlass() {
        const components = document.querySelectorAll('.ema-grid--glass');
        ...
        console.log(`Grid glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Grid glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Grid glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGridGlass);
    } else {
        initGridGlass();
    }
