/**
 * Grid Component - minimal Variant
...
(function() {
    ...
    function initGridMinimal() {
        const components = document.querySelectorAll('.ema-grid--minimal');
        ...
        console.log(`Grid minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Grid minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Grid minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGridMinimal);
    } else {
        initGridMinimal();
    }
