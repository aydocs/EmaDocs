/**
 * Grid Component - premium Variant
...
(function() {
    ...
    function initGridPremium() {
        const components = document.querySelectorAll('.ema-grid--premium');
        ...
        console.log(`Grid premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Grid component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Grid premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('grid:click', {
    ...
    window.handleClick = function() {
        console.log('Grid premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGridPremium);
    } else {
        initGridPremium();
    }
