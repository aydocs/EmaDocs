...
(function() {
    ...
    function initGridNeo() {
        const components = document.querySelectorAll('.ema-grid--neo');
        ...
        console.log(`Grid neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Grid neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initGridNeo);
    } else {
        initGridNeo();
    }
