/**
 * Message Component - minimal Variant
...
(function() {
    ...
    function initMessageMinimal() {
        const components = document.querySelectorAll('.ema-message--minimal');
        ...
        console.log(`Message minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Message minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Message minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMessageMinimal);
    } else {
        initMessageMinimal();
    }
