/**
 * Message Component - glass Variant
...
(function() {
    ...
    function initMessageGlass() {
        const components = document.querySelectorAll('.ema-message--glass');
        ...
        console.log(`Message glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Message glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Message glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMessageGlass);
    } else {
        initMessageGlass();
    }
