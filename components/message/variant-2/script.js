...
(function() {
    ...
    function initMessageNeo() {
        const components = document.querySelectorAll('.ema-message--neo');
        ...
        console.log(`Message neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Message neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Message neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMessageNeo);
    } else {
        initMessageNeo();
    }
