/**
 * Message Component - premium Variant
...
(function() {
    ...
    function initMessagePremium() {
        const components = document.querySelectorAll('.ema-message--premium');
        ...
        console.log(`Message premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Message component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Message premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('message:click', {
    ...
    window.handleClick = function() {
        console.log('Message premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMessagePremium);
    } else {
        initMessagePremium();
    }
