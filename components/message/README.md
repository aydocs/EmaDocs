...
A comprehensive Message component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Message variant="minimal">Minimal</Message>
<Message variant="neo">Neo</Message>
<Message variant="soft">Soft</Message>
<Message variant="glass">Glass</Message>
<Message variant="premium">Premium</Message>
```
...
- `message.ema` - Main component definition
