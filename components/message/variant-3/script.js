/**
 * Message Component - soft Variant
...
(function() {
    ...
    function initMessageSoft() {
        const components = document.querySelectorAll('.ema-message--soft');
        ...
        console.log(`Message soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Message soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Message soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMessageSoft);
    } else {
        initMessageSoft();
    }
