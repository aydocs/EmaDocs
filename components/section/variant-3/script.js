/**
 * Section Component - soft Variant
...
(function() {
    ...
    function initSectionSoft() {
        const components = document.querySelectorAll('.ema-section--soft');
        ...
        console.log(`Section soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Section soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Section soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSectionSoft);
    } else {
        initSectionSoft();
    }
