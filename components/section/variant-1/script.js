/**
 * Section Component - minimal Variant
...
(function() {
    ...
    function initSectionMinimal() {
        const components = document.querySelectorAll('.ema-section--minimal');
        ...
        console.log(`Section minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Section minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Section minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSectionMinimal);
    } else {
        initSectionMinimal();
    }
