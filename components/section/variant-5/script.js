/**
 * Section Component - premium Variant
...
(function() {
    ...
    function initSectionPremium() {
        const components = document.querySelectorAll('.ema-section--premium');
        ...
        console.log(`Section premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Section component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Section premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('section:click', {
    ...
    window.handleClick = function() {
        console.log('Section premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSectionPremium);
    } else {
        initSectionPremium();
    }
