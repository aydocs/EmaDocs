...
(function() {
    ...
    function initSectionNeo() {
        const components = document.querySelectorAll('.ema-section--neo');
        ...
        console.log(`Section neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Section neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Section neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSectionNeo);
    } else {
        initSectionNeo();
    }
