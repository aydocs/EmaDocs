/**
 * Section Component - glass Variant
...
(function() {
    ...
    function initSectionGlass() {
        const components = document.querySelectorAll('.ema-section--glass');
        ...
        console.log(`Section glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Section glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Section glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSectionGlass);
    } else {
        initSectionGlass();
    }
