/**
 * Section Component - Main Entry Point
...
// Export component
export { default as Section } from './section.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Section', {
    name: 'Section',
...
console.log('Section component loaded with 5 variants');
