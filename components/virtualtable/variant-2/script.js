/**
 * VirtualTable Component - neo Variant
...
(function() {
    ...
    function initVirtualTableNeo() {
        const components = document.querySelectorAll('.ema-virtualtable--neo');
        ...
        console.log(`VirtualTable neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualTable neo clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualTable neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualTableNeo);
    } else {
        initVirtualTableNeo();
    }
