/**
 * VirtualTable Component - premium Variant
...
(function() {
    ...
    function initVirtualTablePremium() {
        const components = document.querySelectorAll('.ema-virtualtable--premium');
        ...
        console.log(`VirtualTable premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualTable premium clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualTable premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualTablePremium);
    } else {
        initVirtualTablePremium();
    }
