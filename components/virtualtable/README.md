...
A comprehensive VirtualTable component for Emadocs Framework with 5 beautiful variants.
...
```ema
<VirtualTable variant="minimal">Minimal</VirtualTable>
<VirtualTable variant="neo">Neo</VirtualTable>
<VirtualTable variant="soft">Soft</VirtualTable>
<VirtualTable variant="glass">Glass</VirtualTable>
<VirtualTable variant="premium">Premium</VirtualTable>
```
...
- `virtualtable.ema` - Main component definition
