/**
 * VirtualTable Component - glass Variant
...
(function() {
    ...
    function initVirtualTableGlass() {
        const components = document.querySelectorAll('.ema-virtualtable--glass');
        ...
        console.log(`VirtualTable glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualTable glass clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualTable glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualTableGlass);
    } else {
        initVirtualTableGlass();
    }
