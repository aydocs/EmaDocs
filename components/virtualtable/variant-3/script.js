...
(function() {
    ...
    function initVirtualTableSoft() {
        const components = document.querySelectorAll('.ema-virtualtable--soft');
        ...
        console.log(`VirtualTable soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualTable soft clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualTable soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualTableSoft);
    } else {
        initVirtualTableSoft();
    }
