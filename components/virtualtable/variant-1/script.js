/**
 * VirtualTable Component - minimal Variant
...
(function() {
    ...
    function initVirtualTableMinimal() {
        const components = document.querySelectorAll('.ema-virtualtable--minimal');
        ...
        console.log(`VirtualTable minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `VirtualTable component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualTable minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('virtualtable:click', {
    ...
    window.handleClick = function() {
        console.log('VirtualTable minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualTableMinimal);
    } else {
        initVirtualTableMinimal();
    }
