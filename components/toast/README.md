...
A comprehensive Toast component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Toast variant="minimal">Minimal</Toast>
<Toast variant="neo">Neo</Toast>
<Toast variant="soft">Soft</Toast>
<Toast variant="glass">Glass</Toast>
<Toast variant="premium">Premium</Toast>
```
...
- `toast.ema` - Main component definition
