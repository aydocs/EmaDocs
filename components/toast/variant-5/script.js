/**
 * Toast Component - premium Variant
...
(function() {
    ...
    function initToastPremium() {
        const components = document.querySelectorAll('.ema-toast--premium');
        ...
        console.log(`Toast premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toast premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Toast premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToastPremium);
    } else {
        initToastPremium();
    }
