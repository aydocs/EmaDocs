...
(function() {
    ...
    function initToastNeo() {
        const components = document.querySelectorAll('.ema-toast--neo');
        ...
        console.log(`Toast neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Toast neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToastNeo);
    } else {
        initToastNeo();
    }
