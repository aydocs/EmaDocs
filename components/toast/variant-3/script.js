...
(function() {
    ...
    function initToastSoft() {
        const components = document.querySelectorAll('.ema-toast--soft');
        ...
        console.log(`Toast soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toast soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Toast soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToastSoft);
    } else {
        initToastSoft();
    }
