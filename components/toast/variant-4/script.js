...
(function() {
    ...
    function initToastGlass() {
        const components = document.querySelectorAll('.ema-toast--glass');
        ...
        console.log(`Toast glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toast glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Toast glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToastGlass);
    } else {
        initToastGlass();
    }
