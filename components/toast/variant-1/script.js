/**
 * Toast Component - minimal Variant
...
(function() {
    ...
    function initToastMinimal() {
        const components = document.querySelectorAll('.ema-toast--minimal');
        ...
        console.log(`Toast minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Toast component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toast minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('toast:click', {
    ...
    window.handleClick = function() {
        console.log('Toast minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToastMinimal);
    } else {
        initToastMinimal();
    }
