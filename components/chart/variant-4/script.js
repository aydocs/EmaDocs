...
(function() {
    ...
    function initChartGlass() {
        const components = document.querySelectorAll('.ema-chart--glass');
        ...
        console.log(`Chart glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chart glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Chart glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChartGlass);
    } else {
        initChartGlass();
    }
