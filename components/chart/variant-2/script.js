...
(function() {
    ...
    function initChartNeo() {
        const components = document.querySelectorAll('.ema-chart--neo');
        ...
        console.log(`Chart neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Chart neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChartNeo);
    } else {
        initChartNeo();
    }
