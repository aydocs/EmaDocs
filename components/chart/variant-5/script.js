/**
 * Chart Component - premium Variant
...
(function() {
    ...
    function initChartPremium() {
        const components = document.querySelectorAll('.ema-chart--premium');
        ...
        console.log(`Chart premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Chart component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chart premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('chart:click', {
    ...
    window.handleClick = function() {
        console.log('Chart premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChartPremium);
    } else {
        initChartPremium();
    }
