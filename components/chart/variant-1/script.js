/**
 * Chart Component - minimal Variant
...
(function() {
    ...
    function initChartMinimal() {
        const components = document.querySelectorAll('.ema-chart--minimal');
        ...
        console.log(`Chart minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chart minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Chart minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChartMinimal);
    } else {
        initChartMinimal();
    }
