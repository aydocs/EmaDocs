...
(function() {
    ...
    function initChartSoft() {
        const components = document.querySelectorAll('.ema-chart--soft');
        ...
        console.log(`Chart soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chart soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Chart soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChartSoft);
    } else {
        initChartSoft();
    }
