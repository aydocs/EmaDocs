/**
 * Chip Component - premium Variant
...
(function() {
    ...
    function initChipPremium() {
        const components = document.querySelectorAll('.ema-chip--premium');
        ...
        console.log(`Chip premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Chip component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chip premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('chip:click', {
    ...
    window.handleClick = function() {
        console.log('Chip premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChipPremium);
    } else {
        initChipPremium();
    }
