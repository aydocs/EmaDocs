...
(function() {
    ...
    function initChipGlass() {
        const components = document.querySelectorAll('.ema-chip--glass');
        ...
        console.log(`Chip glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chip glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Chip glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChipGlass);
    } else {
        initChipGlass();
    }
