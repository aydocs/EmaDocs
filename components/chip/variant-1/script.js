...
(function() {
    ...
    function initChipMinimal() {
        const components = document.querySelectorAll('.ema-chip--minimal');
        ...
        console.log(`Chip minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Chip minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Chip minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChipMinimal);
    } else {
        initChipMinimal();
    }
