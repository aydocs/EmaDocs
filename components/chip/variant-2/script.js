...
(function() {
    ...
    function initChipNeo() {
        const components = document.querySelectorAll('.ema-chip--neo');
        ...
        console.log(`Chip neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Chip neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChipNeo);
    } else {
        initChipNeo();
    }
