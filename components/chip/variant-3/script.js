...
(function() {
    ...
    function initChipSoft() {
        const components = document.querySelectorAll('.ema-chip--soft');
        ...
        console.log(`Chip soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Chip soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initChipSoft);
    } else {
        initChipSoft();
    }
