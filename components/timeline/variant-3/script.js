/**
 * Timeline Component - soft Variant
...
(function() {
    ...
    function initTimelineSoft() {
        const components = document.querySelectorAll('.ema-timeline--soft');
        ...
        console.log(`Timeline soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Timeline soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Timeline soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimelineSoft);
    } else {
        initTimelineSoft();
    }
