/**
 * Video Component - minimal Variant
...
(function() {
    ...
    function initVideoMinimal() {
        const components = document.querySelectorAll('.ema-video--minimal');
        ...
        console.log(`Video minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Video minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Video minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVideoMinimal);
    } else {
        initVideoMinimal();
    }
