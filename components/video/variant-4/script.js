...
(function() {
    ...
    function initVideoGlass() {
        const components = document.querySelectorAll('.ema-video--glass');
        ...
        console.log(`Video glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Video glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Video glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVideoGlass);
    } else {
        initVideoGlass();
    }
