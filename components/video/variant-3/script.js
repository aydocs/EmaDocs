...
(function() {
    ...
    function initVideoSoft() {
        const components = document.querySelectorAll('.ema-video--soft');
        ...
        console.log(`Video soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Video soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Video soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVideoSoft);
    } else {
        initVideoSoft();
    }
