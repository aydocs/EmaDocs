/**
 * Video Component - premium Variant
...
(function() {
    ...
    function initVideoPremium() {
        const components = document.querySelectorAll('.ema-video--premium');
        ...
        console.log(`Video premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Video component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Video premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('video:click', {
    ...
    window.handleClick = function() {
        console.log('Video premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVideoPremium);
    } else {
        initVideoPremium();
    }
