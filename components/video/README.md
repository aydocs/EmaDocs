...
A comprehensive Video component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Video variant="minimal">Minimal</Video>
<Video variant="neo">Neo</Video>
<Video variant="soft">Soft</Video>
<Video variant="glass">Glass</Video>
<Video variant="premium">Premium</Video>
```
...
- `video.ema` - Main component definition
