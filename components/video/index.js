/**
 * Video Component - Main Entry Point
...
// Export component
export { default as Video } from './video.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Video', {
    name: 'Video',
...
console.log('Video component loaded with 5 variants');
