...
(function() {
    ...
    function initVideoNeo() {
        const components = document.querySelectorAll('.ema-video--neo');
        ...
        console.log(`Video neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Video neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVideoNeo);
    } else {
        initVideoNeo();
    }
