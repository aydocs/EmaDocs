/**
 * VirtualScroll Component - minimal Variant
...
(function() {
    ...
    function initVirtualScrollMinimal() {
        const components = document.querySelectorAll('.ema-virtualscroll--minimal');
        ...
        console.log(`VirtualScroll minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `VirtualScroll component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualScroll minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('virtualscroll:click', {
    ...
    window.handleClick = function() {
        console.log('VirtualScroll minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualScrollMinimal);
    } else {
        initVirtualScrollMinimal();
    }
