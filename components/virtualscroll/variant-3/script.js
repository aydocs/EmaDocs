/**
 * VirtualScroll Component - soft Variant
...
(function() {
    ...
    function initVirtualScrollSoft() {
        const components = document.querySelectorAll('.ema-virtualscroll--soft');
        ...
        console.log(`VirtualScroll soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualScroll soft clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualScroll soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualScrollSoft);
    } else {
        initVirtualScrollSoft();
    }
