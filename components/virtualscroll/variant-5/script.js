/**
 * VirtualScroll Component - premium Variant
...
(function() {
    ...
    function initVirtualScrollPremium() {
        const components = document.querySelectorAll('.ema-virtualscroll--premium');
        ...
        console.log(`VirtualScroll premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualScroll premium clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualScroll premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualScrollPremium);
    } else {
        initVirtualScrollPremium();
    }
