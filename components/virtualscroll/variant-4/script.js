/**
 * VirtualScroll Component - glass Variant
...
(function() {
    ...
    function initVirtualScrollGlass() {
        const components = document.querySelectorAll('.ema-virtualscroll--glass');
        ...
        console.log(`VirtualScroll glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualScroll glass clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualScroll glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualScrollGlass);
    } else {
        initVirtualScrollGlass();
    }
