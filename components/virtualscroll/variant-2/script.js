/**
 * VirtualScroll Component - neo Variant
...
(function() {
    ...
    function initVirtualScrollNeo() {
        const components = document.querySelectorAll('.ema-virtualscroll--neo');
        ...
        console.log(`VirtualScroll neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualScroll neo clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualScroll neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualScrollNeo);
    } else {
        initVirtualScrollNeo();
    }
