/**
 * TableCell Component - Main Entry Point
...
// Export component
export { default as TableCell } from './tablecell.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('TableCell', {
    name: 'TableCell',
...
console.log('TableCell component loaded with 5 variants');
