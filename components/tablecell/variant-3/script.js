/**
 * TableCell Component - soft Variant
...
(function() {
    ...
    function initTableCellSoft() {
        const components = document.querySelectorAll('.ema-tablecell--soft');
        ...
        console.log(`TableCell soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableCell soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TableCell soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableCellSoft);
    } else {
        initTableCellSoft();
    }
