/**
 * TableCell Component - neo Variant
...
(function() {
    ...
    function initTableCellNeo() {
        const components = document.querySelectorAll('.ema-tablecell--neo');
        ...
        console.log(`TableCell neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableCell neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TableCell neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableCellNeo);
    } else {
        initTableCellNeo();
    }
