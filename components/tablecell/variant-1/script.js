/**
 * TableCell Component - minimal Variant
...
(function() {
    ...
    function initTableCellMinimal() {
        const components = document.querySelectorAll('.ema-tablecell--minimal');
        ...
        console.log(`TableCell minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableCell minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('TableCell minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableCellMinimal);
    } else {
        initTableCellMinimal();
    }
