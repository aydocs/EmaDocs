/**
 * TableCell Component - glass Variant
...
(function() {
    ...
    function initTableCellGlass() {
        const components = document.querySelectorAll('.ema-tablecell--glass');
        ...
        console.log(`TableCell glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableCell glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TableCell glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableCellGlass);
    } else {
        initTableCellGlass();
    }
