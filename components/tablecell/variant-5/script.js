/**
 * TableCell Component - premium Variant
...
(function() {
    ...
    function initTableCellPremium() {
        const components = document.querySelectorAll('.ema-tablecell--premium');
        ...
        console.log(`TableCell premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TableCell component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableCell premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tablecell:click', {
    ...
    window.handleClick = function() {
        console.log('TableCell premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableCellPremium);
    } else {
        initTableCellPremium();
    }
