...
A comprehensive Tooltip component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Tooltip variant="minimal">Minimal</Tooltip>
<Tooltip variant="neo">Neo</Tooltip>
<Tooltip variant="soft">Soft</Tooltip>
<Tooltip variant="glass">Glass</Tooltip>
<Tooltip variant="premium">Premium</Tooltip>
```
...
- `tooltip.ema` - Main component definition
