/**
 * Tooltip Component - premium Variant
...
(function() {
    ...
    function initTooltipPremium() {
        const components = document.querySelectorAll('.ema-tooltip--premium');
        ...
        console.log(`Tooltip premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tooltip premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Tooltip premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTooltipPremium);
    } else {
        initTooltipPremium();
    }
