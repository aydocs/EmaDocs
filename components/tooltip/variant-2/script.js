...
(function() {
    ...
    function initTooltipNeo() {
        const components = document.querySelectorAll('.ema-tooltip--neo');
        ...
        console.log(`Tooltip neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tooltip neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Tooltip neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTooltipNeo);
    } else {
        initTooltipNeo();
    }
