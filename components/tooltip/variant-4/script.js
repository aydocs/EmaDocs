...
(function() {
    ...
    function initTooltipGlass() {
        const components = document.querySelectorAll('.ema-tooltip--glass');
        ...
        console.log(`Tooltip glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tooltip glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Tooltip glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTooltipGlass);
    } else {
        initTooltipGlass();
    }
