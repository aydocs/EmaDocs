/**
 * Tooltip Component - Main Entry Point
...
// Export component
export { default as Tooltip } from './tooltip.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Tooltip', {
    name: 'Tooltip',
...
console.log('Tooltip component loaded with 5 variants');
