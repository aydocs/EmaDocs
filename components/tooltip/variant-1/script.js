/**
 * Tooltip Component - minimal Variant
...
(function() {
    ...
    function initTooltipMinimal() {
        const components = document.querySelectorAll('.ema-tooltip--minimal');
        ...
        console.log(`Tooltip minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Tooltip component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tooltip minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tooltip:click', {
    ...
    window.handleClick = function() {
        console.log('Tooltip minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTooltipMinimal);
    } else {
        initTooltipMinimal();
    }
