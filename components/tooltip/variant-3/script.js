/**
 * Tooltip Component - soft Variant
...
(function() {
    ...
    function initTooltipSoft() {
        const components = document.querySelectorAll('.ema-tooltip--soft');
        ...
        console.log(`Tooltip soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tooltip soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Tooltip soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTooltipSoft);
    } else {
        initTooltipSoft();
    }
