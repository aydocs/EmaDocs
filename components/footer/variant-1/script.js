/**
 * Footer Component - minimal Variant
...
(function() {
    ...
    function initFooterMinimal() {
        const components = document.querySelectorAll('.ema-footer--minimal');
        ...
        console.log(`Footer minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Footer minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Footer minimal clicked via global handler');
    };
