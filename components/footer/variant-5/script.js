/**
 * Footer Component - premium Variant
...
(function() {
    ...
    function initFooterPremium() {
        const components = document.querySelectorAll('.ema-footer--premium');
        ...
        console.log(`Footer premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Footer component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Footer premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('footer:click', {
    ...
    window.handleClick = function() {
        console.log('Footer premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFooterPremium);
    } else {
        initFooterPremium();
    }
