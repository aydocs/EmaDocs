...
(function() {
    ...
    function initFooterNeo() {
        const components = document.querySelectorAll('.ema-footer--neo');
        ...
        console.log(`Footer neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Footer neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Footer neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFooterNeo);
    } else {
        initFooterNeo();
    }
