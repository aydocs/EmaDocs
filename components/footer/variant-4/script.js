/**
 * Footer Component - glass Variant
...
(function() {
    ...
    function initFooterGlass() {
        const components = document.querySelectorAll('.ema-footer--glass');
        ...
        console.log(`Footer glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Footer glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Footer glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFooterGlass);
    } else {
        initFooterGlass();
    }
