...
(function() {
    ...
    function initFooterSoft() {
        const components = document.querySelectorAll('.ema-footer--soft');
        ...
        console.log(`Footer soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Footer soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Footer soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFooterSoft);
    } else {
        initFooterSoft();
    }
