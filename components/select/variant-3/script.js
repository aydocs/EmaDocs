...
(function() {
    ...
    function initSelectSoft() {
        const components = document.querySelectorAll('.ema-select--soft');
        ...
        console.log(`Select soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Select soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Select soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSelectSoft);
    } else {
        initSelectSoft();
    }
