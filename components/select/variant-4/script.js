/**
 * Select Component - glass Variant
...
(function() {
    ...
    function initSelectGlass() {
        const components = document.querySelectorAll('.ema-select--glass');
        ...
        console.log(`Select glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Select glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Select glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSelectGlass);
    } else {
        initSelectGlass();
    }
