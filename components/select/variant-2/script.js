...
(function() {
    ...
    function initSelectNeo() {
        const components = document.querySelectorAll('.ema-select--neo');
        ...
        console.log(`Select neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Select neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Select neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSelectNeo);
    } else {
        initSelectNeo();
    }
