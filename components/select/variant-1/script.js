/**
 * Select Component - minimal Variant
...
(function() {
    ...
    function initSelectMinimal() {
        const components = document.querySelectorAll('.ema-select--minimal');
        ...
        console.log(`Select minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Select minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Select minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSelectMinimal);
    } else {
        initSelectMinimal();
    }
