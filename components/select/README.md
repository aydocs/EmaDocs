...
A comprehensive Select component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Select variant="minimal">Minimal</Select>
<Select variant="neo">Neo</Select>
<Select variant="soft">Soft</Select>
<Select variant="glass">Glass</Select>
<Select variant="premium">Premium</Select>
```
...
- `select.ema` - Main component definition
