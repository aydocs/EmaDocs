/**
 * Select Component - premium Variant
...
(function() {
    ...
    function initSelectPremium() {
        const components = document.querySelectorAll('.ema-select--premium');
        ...
        console.log(`Select premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Select component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Select premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('select:click', {
    ...
    window.handleClick = function() {
        console.log('Select premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSelectPremium);
    } else {
        initSelectPremium();
    }
