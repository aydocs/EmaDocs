...
A comprehensive SidebarItem component for Emadocs Framework with 5 beautiful variants.
...
```ema
<SidebarItem variant="minimal">Minimal</SidebarItem>
<SidebarItem variant="neo">Neo</SidebarItem>
<SidebarItem variant="soft">Soft</SidebarItem>
<SidebarItem variant="glass">Glass</SidebarItem>
<SidebarItem variant="premium">Premium</SidebarItem>
```
...
- `sidebaritem.ema` - Main component definition
