/**
 * SidebarItem Component - minimal Variant
...
(function() {
    ...
    function initSidebarItemMinimal() {
        const components = document.querySelectorAll('.ema-sidebaritem--minimal');
        ...
        console.log(`SidebarItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `SidebarItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SidebarItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('sidebaritem:click', {
    ...
    window.handleClick = function() {
        console.log('SidebarItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarItemMinimal);
    } else {
        initSidebarItemMinimal();
    }
