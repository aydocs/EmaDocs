/**
 * SidebarItem Component - soft Variant
...
(function() {
    ...
    function initSidebarItemSoft() {
        const components = document.querySelectorAll('.ema-sidebaritem--soft');
        ...
        console.log(`SidebarItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SidebarItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('SidebarItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarItemSoft);
    } else {
        initSidebarItemSoft();
    }
