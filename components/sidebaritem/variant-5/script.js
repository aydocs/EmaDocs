/**
 * SidebarItem Component - premium Variant
...
(function() {
    ...
    function initSidebarItemPremium() {
        const components = document.querySelectorAll('.ema-sidebaritem--premium');
        ...
        console.log(`SidebarItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SidebarItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('SidebarItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarItemPremium);
    } else {
        initSidebarItemPremium();
    }
