/**
 * SidebarItem Component - neo Variant
...
(function() {
    ...
    function initSidebarItemNeo() {
        const components = document.querySelectorAll('.ema-sidebaritem--neo');
        ...
        console.log(`SidebarItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SidebarItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('SidebarItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarItemNeo);
    } else {
        initSidebarItemNeo();
    }
