/**
 * SidebarItem Component - glass Variant
...
(function() {
    ...
    function initSidebarItemGlass() {
        const components = document.querySelectorAll('.ema-sidebaritem--glass');
        ...
        console.log(`SidebarItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`SidebarItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('SidebarItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarItemGlass);
    } else {
        initSidebarItemGlass();
    }
