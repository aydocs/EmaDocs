/**
 * TableHeader Component - minimal Variant
...
(function() {
    ...
    function initTableHeaderMinimal() {
        const components = document.querySelectorAll('.ema-tableheader--minimal');
        ...
        console.log(`TableHeader minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TableHeader component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableHeader minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tableheader:click', {
    ...
    window.handleClick = function() {
        console.log('TableHeader minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableHeaderMinimal);
    } else {
        initTableHeaderMinimal();
    }
