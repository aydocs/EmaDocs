/**
 * TableHeader Component - glass Variant
...
(function() {
    ...
    function initTableHeaderGlass() {
        const components = document.querySelectorAll('.ema-tableheader--glass');
        ...
        console.log(`TableHeader glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableHeader glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TableHeader glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableHeaderGlass);
    } else {
        initTableHeaderGlass();
    }
