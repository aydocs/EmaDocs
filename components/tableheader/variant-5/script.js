/**
 * TableHeader Component - premium Variant
...
(function() {
    ...
    function initTableHeaderPremium() {
        const components = document.querySelectorAll('.ema-tableheader--premium');
        ...
        console.log(`TableHeader premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableHeader premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TableHeader premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableHeaderPremium);
    } else {
        initTableHeaderPremium();
    }
