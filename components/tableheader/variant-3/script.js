/**
 * TableHeader Component - soft Variant
...
(function() {
    ...
    function initTableHeaderSoft() {
        const components = document.querySelectorAll('.ema-tableheader--soft');
        ...
        console.log(`TableHeader soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableHeader soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TableHeader soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableHeaderSoft);
    } else {
        initTableHeaderSoft();
    }
