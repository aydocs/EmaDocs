/**
 * TableHeader Component - neo Variant
...
(function() {
    ...
    function initTableHeaderNeo() {
        const components = document.querySelectorAll('.ema-tableheader--neo');
        ...
        console.log(`TableHeader neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableHeader neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TableHeader neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableHeaderNeo);
    } else {
        initTableHeaderNeo();
    }
