/**
 * Wizard Component - glass Variant
...
(function() {
    ...
    function initWizardGlass() {
        const components = document.querySelectorAll('.ema-wizard--glass');
        ...
        console.log(`Wizard glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Wizard glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Wizard glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWizardGlass);
    } else {
        initWizardGlass();
    }
