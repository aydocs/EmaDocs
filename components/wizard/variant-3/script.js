...
(function() {
    ...
    function initWizardSoft() {
        const components = document.querySelectorAll('.ema-wizard--soft');
        ...
        console.log(`Wizard soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Wizard soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Wizard soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWizardSoft);
    } else {
        initWizardSoft();
    }
