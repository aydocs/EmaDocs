/**
 * Wizard Component - premium Variant
...
(function() {
    ...
    function initWizardPremium() {
        const components = document.querySelectorAll('.ema-wizard--premium');
        ...
        console.log(`Wizard premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Wizard premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Wizard premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWizardPremium);
    } else {
        initWizardPremium();
    }
