...
(function() {
    ...
    function initWizardNeo() {
        const components = document.querySelectorAll('.ema-wizard--neo');
        ...
        console.log(`Wizard neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Wizard neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Wizard neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWizardNeo);
    } else {
        initWizardNeo();
    }
