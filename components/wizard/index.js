/**
 * Wizard Component - Main Entry Point
...
// Export component
export { default as Wizard } from './wizard.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Wizard', {
    name: 'Wizard',
...
console.log('Wizard component loaded with 5 variants');
