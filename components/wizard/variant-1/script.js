/**
 * Wizard Component - minimal Variant
...
(function() {
    ...
    function initWizardMinimal() {
        const components = document.querySelectorAll('.ema-wizard--minimal');
        ...
        console.log(`Wizard minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Wizard component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Wizard minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('wizard:click', {
    ...
    window.handleClick = function() {
        console.log('Wizard minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWizardMinimal);
    } else {
        initWizardMinimal();
    }
