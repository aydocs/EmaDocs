/**
 * Breadcrumb Component - Main Entry Point
...
// Export component
export { default as Breadcrumb } from './breadcrumb.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Breadcrumb', {
    name: 'Breadcrumb',
...
console.log('Breadcrumb component loaded with 5 variants');
