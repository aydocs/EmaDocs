/**
 * Breadcrumb Component - soft Variant
...
(function() {
    ...
    function initBreadcrumbSoft() {
        const components = document.querySelectorAll('.ema-breadcrumb--soft');
        ...
        console.log(`Breadcrumb soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breadcrumb soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Breadcrumb soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbSoft);
    } else {
        initBreadcrumbSoft();
    }
