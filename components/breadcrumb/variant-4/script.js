...
(function() {
    ...
    function initBreadcrumbGlass() {
        const components = document.querySelectorAll('.ema-breadcrumb--glass');
        ...
        console.log(`Breadcrumb glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breadcrumb glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Breadcrumb glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbGlass);
    } else {
        initBreadcrumbGlass();
    }
