/**
 * Breadcrumb Component - minimal Variant
...
(function() {
    ...
    function initBreadcrumbMinimal() {
        const components = document.querySelectorAll('.ema-breadcrumb--minimal');
        ...
        console.log(`Breadcrumb minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Breadcrumb component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breadcrumb minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('breadcrumb:click', {
    ...
    window.handleClick = function() {
        console.log('Breadcrumb minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbMinimal);
    } else {
        initBreadcrumbMinimal();
    }
