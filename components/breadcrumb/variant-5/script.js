/**
 * Breadcrumb Component - premium Variant
...
(function() {
    ...
    function initBreadcrumbPremium() {
        const components = document.querySelectorAll('.ema-breadcrumb--premium');
        ...
        console.log(`Breadcrumb premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breadcrumb premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Breadcrumb premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbPremium);
    } else {
        initBreadcrumbPremium();
    }
