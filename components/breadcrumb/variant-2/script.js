/**
 * Breadcrumb Component - neo Variant
...
(function() {
    ...
    function initBreadcrumbNeo() {
        const components = document.querySelectorAll('.ema-breadcrumb--neo');
        ...
        console.log(`Breadcrumb neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breadcrumb neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Breadcrumb neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbNeo);
    } else {
        initBreadcrumbNeo();
    }
