...
A comprehensive Carousel component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Carousel variant="minimal">Minimal</Carousel>
<Carousel variant="neo">Neo</Carousel>
<Carousel variant="soft">Soft</Carousel>
<Carousel variant="glass">Glass</Carousel>
<Carousel variant="premium">Premium</Carousel>
```
...
- `carousel.ema` - Main component definition
