/**
 * Carousel Component - minimal Variant
...
(function() {
    ...
    function initCarouselMinimal() {
        const components = document.querySelectorAll('.ema-carousel--minimal');
        ...
        console.log(`Carousel minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Carousel component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Carousel minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('carousel:click', {
    ...
    window.handleClick = function() {
        console.log('Carousel minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCarouselMinimal);
    } else {
        initCarouselMinimal();
    }
