/**
 * Carousel Component - premium Variant
...
(function() {
    ...
    function initCarouselPremium() {
        const components = document.querySelectorAll('.ema-carousel--premium');
        ...
        console.log(`Carousel premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Carousel premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Carousel premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCarouselPremium);
    } else {
        initCarouselPremium();
    }
