/**
 * Carousel Component - neo Variant
...
(function() {
    ...
    function initCarouselNeo() {
        const components = document.querySelectorAll('.ema-carousel--neo');
        ...
        console.log(`Carousel neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Carousel neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Carousel neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCarouselNeo);
    } else {
        initCarouselNeo();
    }
