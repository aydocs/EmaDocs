/**
 * Carousel Component - soft Variant
...
(function() {
    ...
    function initCarouselSoft() {
        const components = document.querySelectorAll('.ema-carousel--soft');
        ...
        console.log(`Carousel soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Carousel soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Carousel soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCarouselSoft);
    } else {
        initCarouselSoft();
    }
