...
(function() {
    ...
    function initAsideSoft() {
        const components = document.querySelectorAll('.ema-aside--soft');
        ...
        console.log(`Aside soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Aside soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Aside soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAsideSoft);
    } else {
        initAsideSoft();
    }
