...
(function() {
    ...
    function initAsideGlass() {
        const components = document.querySelectorAll('.ema-aside--glass');
        ...
        console.log(`Aside glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Aside glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Aside glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAsideGlass);
    } else {
        initAsideGlass();
    }
