/**
 * Aside Component - premium Variant
...
(function() {
    ...
    function initAsidePremium() {
        const components = document.querySelectorAll('.ema-aside--premium');
        ...
        console.log(`Aside premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Aside component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Aside premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('aside:click', {
    ...
    window.handleClick = function() {
        console.log('Aside premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAsidePremium);
    } else {
        initAsidePremium();
    }
