/**
 * Aside Component - Main Entry Point
...
// Export component
export { default as Aside } from './aside.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Aside', {
    name: 'Aside',
...
console.log('Aside component loaded with 5 variants');
