/**
 * Aside Component - minimal Variant
...
(function() {
    ...
    function initAsideMinimal() {
        const components = document.querySelectorAll('.ema-aside--minimal');
        ...
        console.log(`Aside minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Aside minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Aside minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAsideMinimal);
    } else {
        initAsideMinimal();
    }
