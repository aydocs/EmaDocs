...
(function() {
    ...
    function initAsideNeo() {
        const components = document.querySelectorAll('.ema-aside--neo');
        ...
        console.log(`Aside neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Aside neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAsideNeo);
    } else {
        initAsideNeo();
    }
