/**
 * Intersection Component - minimal Variant
...
(function() {
    ...
    function initIntersectionMinimal() {
        const components = document.querySelectorAll('.ema-intersection--minimal');
        ...
        console.log(`Intersection minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Intersection component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Intersection minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('intersection:click', {
    ...
    window.handleClick = function() {
        console.log('Intersection minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIntersectionMinimal);
    } else {
        initIntersectionMinimal();
    }
