/**
 * Intersection Component - neo Variant
...
(function() {
    ...
    function initIntersectionNeo() {
        const components = document.querySelectorAll('.ema-intersection--neo');
        ...
        console.log(`Intersection neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Intersection neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Intersection neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIntersectionNeo);
    } else {
        initIntersectionNeo();
    }
