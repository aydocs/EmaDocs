/**
 * Intersection Component - Main Entry Point
...
// Export component
export { default as Intersection } from './intersection.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Intersection', {
    name: 'Intersection',
...
console.log('Intersection component loaded with 5 variants');
