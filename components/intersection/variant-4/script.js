/**
 * Intersection Component - glass Variant
...
(function() {
    ...
    function initIntersectionGlass() {
        const components = document.querySelectorAll('.ema-intersection--glass');
        ...
        console.log(`Intersection glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Intersection glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Intersection glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIntersectionGlass);
    } else {
        initIntersectionGlass();
    }
