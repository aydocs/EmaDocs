/**
 * Intersection Component - premium Variant
...
(function() {
    ...
    function initIntersectionPremium() {
        const components = document.querySelectorAll('.ema-intersection--premium');
        ...
        console.log(`Intersection premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Intersection premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Intersection premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIntersectionPremium);
    } else {
        initIntersectionPremium();
    }
