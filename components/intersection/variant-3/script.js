/**
 * Intersection Component - soft Variant
...
(function() {
    ...
    function initIntersectionSoft() {
        const components = document.querySelectorAll('.ema-intersection--soft');
        ...
        console.log(`Intersection soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Intersection soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Intersection soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIntersectionSoft);
    } else {
        initIntersectionSoft();
    }
