/**
 * Empty Component - premium Variant
...
(function() {
    ...
    function initEmptyPremium() {
        const components = document.querySelectorAll('.ema-empty--premium');
        ...
        console.log(`Empty premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Empty premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Empty premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initEmptyPremium);
    } else {
        initEmptyPremium();
    }
