...
(function() {
    ...
    function initEmptySoft() {
        const components = document.querySelectorAll('.ema-empty--soft');
        ...
        console.log(`Empty soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Empty soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Empty soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initEmptySoft);
    } else {
        initEmptySoft();
    }
