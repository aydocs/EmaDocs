/**
 * Empty Component - Main Entry Point
...
// Export component
export { default as Empty } from './empty.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Empty', {
    name: 'Empty',
...
console.log('Empty component loaded with 5 variants');
