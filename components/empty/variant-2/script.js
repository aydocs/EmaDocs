...
(function() {
    ...
    function initEmptyNeo() {
        const components = document.querySelectorAll('.ema-empty--neo');
        ...
        console.log(`Empty neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Empty neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initEmptyNeo);
    } else {
        initEmptyNeo();
    }
