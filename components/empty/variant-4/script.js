...
(function() {
    ...
    function initEmptyGlass() {
        const components = document.querySelectorAll('.ema-empty--glass');
        ...
        console.log(`Empty glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Empty glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Empty glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initEmptyGlass);
    } else {
        initEmptyGlass();
    }
