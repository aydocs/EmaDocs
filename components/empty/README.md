...
A comprehensive Empty component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Empty variant="minimal">Minimal</Empty>
<Empty variant="neo">Neo</Empty>
<Empty variant="soft">Soft</Empty>
<Empty variant="glass">Glass</Empty>
<Empty variant="premium">Premium</Empty>
```
...
- `empty.ema` - Main component definition
