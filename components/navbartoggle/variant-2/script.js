/**
 * NavbarToggle Component - neo Variant
...
(function() {
    ...
    function initNavbarToggleNeo() {
        const components = document.querySelectorAll('.ema-navbartoggle--neo');
        ...
        console.log(`NavbarToggle neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarToggle neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarToggle neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarToggleNeo);
    } else {
        initNavbarToggleNeo();
    }
