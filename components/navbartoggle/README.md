...
A comprehensive NavbarToggle component for Emadocs Framework with 5 beautiful variants.
...
```ema
<NavbarToggle variant="minimal">Minimal</NavbarToggle>
<NavbarToggle variant="neo">Neo</NavbarToggle>
<NavbarToggle variant="soft">Soft</NavbarToggle>
<NavbarToggle variant="glass">Glass</NavbarToggle>
<NavbarToggle variant="premium">Premium</NavbarToggle>
```
...
- `navbartoggle.ema` - Main component definition
