/**
 * NavbarToggle Component - minimal Variant
...
(function() {
    ...
    function initNavbarToggleMinimal() {
        const components = document.querySelectorAll('.ema-navbartoggle--minimal');
        ...
        console.log(`NavbarToggle minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarToggle minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarToggle minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarToggleMinimal);
    } else {
        initNavbarToggleMinimal();
    }
