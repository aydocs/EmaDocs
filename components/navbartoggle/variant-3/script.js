/**
 * NavbarToggle Component - soft Variant
...
(function() {
    ...
    function initNavbarToggleSoft() {
        const components = document.querySelectorAll('.ema-navbartoggle--soft');
        ...
        console.log(`NavbarToggle soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarToggle soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarToggle soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarToggleSoft);
    } else {
        initNavbarToggleSoft();
    }
