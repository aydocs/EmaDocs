/**
 * NavbarToggle Component - premium Variant
...
(function() {
    ...
    function initNavbarTogglePremium() {
        const components = document.querySelectorAll('.ema-navbartoggle--premium');
        ...
        console.log(`NavbarToggle premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarToggle component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarToggle premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbartoggle:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarToggle premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarTogglePremium);
    } else {
        initNavbarTogglePremium();
    }
