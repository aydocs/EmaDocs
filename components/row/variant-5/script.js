...
(function() {
    ...
    function initRowPremium() {
        const components = document.querySelectorAll('.ema-row--premium');
        ...
        console.log(`Row premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Row component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Row premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('row:click', {
    ...
    window.handleClick = function() {
        console.log('Row premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRowPremium);
    } else {
        initRowPremium();
    }
