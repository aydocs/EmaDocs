...
(function() {
    ...
    function initRowSoft() {
        const components = document.querySelectorAll('.ema-row--soft');
        ...
        console.log(`Row soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Row soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRowSoft);
    } else {
        initRowSoft();
    }
