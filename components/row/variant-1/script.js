...
(function() {
    ...
    function initRowMinimal() {
        const components = document.querySelectorAll('.ema-row--minimal');
        ...
        console.log(`Row minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Row minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Row minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRowMinimal);
    } else {
        initRowMinimal();
    }
