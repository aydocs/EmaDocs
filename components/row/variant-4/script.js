...
(function() {
    ...
    function initRowGlass() {
        const components = document.querySelectorAll('.ema-row--glass');
        ...
        console.log(`Row glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Row glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRowGlass);
    } else {
        initRowGlass();
    }
