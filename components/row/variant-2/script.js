...
(function() {
    ...
    function initRowNeo() {
        const components = document.querySelectorAll('.ema-row--neo');
        ...
        console.log(`Row neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Row neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRowNeo);
    } else {
        initRowNeo();
    }
