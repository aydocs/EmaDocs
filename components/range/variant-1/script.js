/**
 * Range Component - minimal Variant
...
(function() {
    ...
    function initRangeMinimal() {
        const components = document.querySelectorAll('.ema-range--minimal');
        ...
        console.log(`Range minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Range component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Range minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('range:click', {
    ...
    window.handleClick = function() {
        console.log('Range minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRangeMinimal);
    } else {
        initRangeMinimal();
    }
