...
(function() {
    ...
    function initRangeGlass() {
        const components = document.querySelectorAll('.ema-range--glass');
        ...
        console.log(`Range glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Range glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Range glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRangeGlass);
    } else {
        initRangeGlass();
    }
