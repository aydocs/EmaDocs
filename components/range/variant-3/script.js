...
(function() {
    ...
    function initRangeSoft() {
        const components = document.querySelectorAll('.ema-range--soft');
        ...
        console.log(`Range soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Range soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Range soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRangeSoft);
    } else {
        initRangeSoft();
    }
