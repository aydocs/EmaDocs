/**
 * Range Component - premium Variant
...
(function() {
    ...
    function initRangePremium() {
        const components = document.querySelectorAll('.ema-range--premium');
        ...
        console.log(`Range premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Range premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Range premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRangePremium);
    } else {
        initRangePremium();
    }
