...
(function() {
    ...
    function initRangeNeo() {
        const components = document.querySelectorAll('.ema-range--neo');
        ...
        console.log(`Range neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Range neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRangeNeo);
    } else {
        initRangeNeo();
    }
