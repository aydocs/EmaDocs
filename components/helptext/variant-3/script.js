/**
 * HelpText Component - soft Variant
...
(function() {
    ...
    function initHelpTextSoft() {
        const components = document.querySelectorAll('.ema-helptext--soft');
        ...
        console.log(`HelpText soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`HelpText soft clicked`);
    ...
    window.handleClick = function() {
        console.log('HelpText soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHelpTextSoft);
    } else {
        initHelpTextSoft();
    }
