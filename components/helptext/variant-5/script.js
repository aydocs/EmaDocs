/**
 * HelpText Component - premium Variant
...
(function() {
    ...
    function initHelpTextPremium() {
        const components = document.querySelectorAll('.ema-helptext--premium');
        ...
        console.log(`HelpText premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`HelpText premium clicked`);
    ...
    window.handleClick = function() {
        console.log('HelpText premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHelpTextPremium);
    } else {
        initHelpTextPremium();
    }
