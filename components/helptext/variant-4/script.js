/**
 * HelpText Component - glass Variant
...
(function() {
    ...
    function initHelpTextGlass() {
        const components = document.querySelectorAll('.ema-helptext--glass');
        ...
        console.log(`HelpText glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`HelpText glass clicked`);
    ...
    window.handleClick = function() {
        console.log('HelpText glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHelpTextGlass);
    } else {
        initHelpTextGlass();
    }
