/**
 * HelpText Component - minimal Variant
...
(function() {
    ...
    function initHelpTextMinimal() {
        const components = document.querySelectorAll('.ema-helptext--minimal');
        ...
        console.log(`HelpText minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `HelpText component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`HelpText minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('helptext:click', {
    ...
    window.handleClick = function() {
        console.log('HelpText minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHelpTextMinimal);
    } else {
        initHelpTextMinimal();
    }
