/**
 * HelpText Component - Main Entry Point
...
// Export component
export { default as HelpText } from './helptext.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('HelpText', {
    name: 'HelpText',
...
console.log('HelpText component loaded with 5 variants');
