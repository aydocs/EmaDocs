/**
 * HelpText Component - neo Variant
...
(function() {
    ...
    function initHelpTextNeo() {
        const components = document.querySelectorAll('.ema-helptext--neo');
        ...
        console.log(`HelpText neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`HelpText neo clicked`);
    ...
    window.handleClick = function() {
        console.log('HelpText neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHelpTextNeo);
    } else {
        initHelpTextNeo();
    }
