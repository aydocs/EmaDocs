/**
 * Viewport Component - neo Variant
...
(function() {
    ...
    function initViewportNeo() {
        const components = document.querySelectorAll('.ema-viewport--neo');
        ...
        console.log(`Viewport neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Viewport neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Viewport neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initViewportNeo);
    } else {
        initViewportNeo();
    }
