/**
 * Viewport Component - soft Variant
...
(function() {
    ...
    function initViewportSoft() {
        const components = document.querySelectorAll('.ema-viewport--soft');
        ...
        console.log(`Viewport soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Viewport soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Viewport soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initViewportSoft);
    } else {
        initViewportSoft();
    }
