/**
 * Viewport Component - minimal Variant
...
(function() {
    ...
    function initViewportMinimal() {
        const components = document.querySelectorAll('.ema-viewport--minimal');
        ...
        console.log(`Viewport minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Viewport minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Viewport minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initViewportMinimal);
    } else {
        initViewportMinimal();
    }
