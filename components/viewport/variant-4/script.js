/**
 * Viewport Component - glass Variant
...
(function() {
    ...
    function initViewportGlass() {
        const components = document.querySelectorAll('.ema-viewport--glass');
        ...
        console.log(`Viewport glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Viewport glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Viewport glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initViewportGlass);
    } else {
        initViewportGlass();
    }
