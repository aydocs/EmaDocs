/**
 * Viewport Component - premium Variant
...
(function() {
    ...
    function initViewportPremium() {
        const components = document.querySelectorAll('.ema-viewport--premium');
        ...
        console.log(`Viewport premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Viewport component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Viewport premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('viewport:click', {
    ...
    window.handleClick = function() {
        console.log('Viewport premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initViewportPremium);
    } else {
        initViewportPremium();
    }
