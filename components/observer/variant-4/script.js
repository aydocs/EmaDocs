/**
 * Observer Component - glass Variant
...
(function() {
    ...
    function initObserverGlass() {
        const components = document.querySelectorAll('.ema-observer--glass');
        ...
        console.log(`Observer glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Observer glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Observer glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initObserverGlass);
    } else {
        initObserverGlass();
    }
