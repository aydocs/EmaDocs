/**
 * Observer Component - premium Variant
...
(function() {
    ...
    function initObserverPremium() {
        const components = document.querySelectorAll('.ema-observer--premium');
        ...
        console.log(`Observer premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Observer premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Observer premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initObserverPremium);
    } else {
        initObserverPremium();
    }
