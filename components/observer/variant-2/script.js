/**
 * Observer Component - neo Variant
...
(function() {
    ...
    function initObserverNeo() {
        const components = document.querySelectorAll('.ema-observer--neo');
        ...
        console.log(`Observer neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Observer neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Observer neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initObserverNeo);
    } else {
        initObserverNeo();
    }
