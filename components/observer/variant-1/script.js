/**
 * Observer Component - minimal Variant
...
(function() {
    ...
    function initObserverMinimal() {
        const components = document.querySelectorAll('.ema-observer--minimal');
        ...
        console.log(`Observer minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Observer component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Observer minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('observer:click', {
    ...
    window.handleClick = function() {
        console.log('Observer minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initObserverMinimal);
    } else {
        initObserverMinimal();
    }
