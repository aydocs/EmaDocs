/**
 * Observer Component - soft Variant
...
(function() {
    ...
    function initObserverSoft() {
        const components = document.querySelectorAll('.ema-observer--soft');
        ...
        console.log(`Observer soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Observer soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Observer soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initObserverSoft);
    } else {
        initObserverSoft();
    }
