/**
 * Print Component - premium Variant
...
(function() {
    ...
    function initPrintPremium() {
        const components = document.querySelectorAll('.ema-print--premium');
        ...
        console.log(`Print premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Print component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Print premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('print:click', {
    ...
    window.handleClick = function() {
        console.log('Print premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPrintPremium);
    } else {
        initPrintPremium();
    }
