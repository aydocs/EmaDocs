...
(function() {
    ...
    function initPrintSoft() {
        const components = document.querySelectorAll('.ema-print--soft');
        ...
        console.log(`Print soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Print soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Print soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPrintSoft);
    } else {
        initPrintSoft();
    }
