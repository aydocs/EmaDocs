...
(function() {
    ...
    function initPrintGlass() {
        const components = document.querySelectorAll('.ema-print--glass');
        ...
        console.log(`Print glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Print glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Print glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPrintGlass);
    } else {
        initPrintGlass();
    }
