...
A comprehensive Print component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Print variant="minimal">Minimal</Print>
<Print variant="neo">Neo</Print>
<Print variant="soft">Soft</Print>
<Print variant="glass">Glass</Print>
<Print variant="premium">Premium</Print>
```
...
- `print.ema` - Main component definition
