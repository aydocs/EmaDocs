...
(function() {
    ...
    function initPrintNeo() {
        const components = document.querySelectorAll('.ema-print--neo');
        ...
        console.log(`Print neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Print neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPrintNeo);
    } else {
        initPrintNeo();
    }
