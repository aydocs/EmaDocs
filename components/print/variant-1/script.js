/**
 * Print Component - minimal Variant
...
(function() {
    ...
    function initPrintMinimal() {
        const components = document.querySelectorAll('.ema-print--minimal');
        ...
        console.log(`Print minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Print minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Print minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPrintMinimal);
    } else {
        initPrintMinimal();
    }
