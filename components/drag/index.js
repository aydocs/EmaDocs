/**
 * Drag Component - Main Entry Point
...
// Export component
export { default as Drag } from './drag.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Drag', {
    name: 'Drag',
...
console.log('Drag component loaded with 5 variants');
