...
(function() {
    ...
    function initDragNeo() {
        const components = document.querySelectorAll('.ema-drag--neo');
        ...
        console.log(`Drag neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Drag neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragNeo);
    } else {
        initDragNeo();
    }
