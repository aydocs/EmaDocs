/**
 * Drag Component - premium Variant
...
(function() {
    ...
    function initDragPremium() {
        const components = document.querySelectorAll('.ema-drag--premium');
        ...
        console.log(`Drag premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Drag component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drag premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('drag:click', {
    ...
    window.handleClick = function() {
        console.log('Drag premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragPremium);
    } else {
        initDragPremium();
    }
