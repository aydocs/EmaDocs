/**
 * Drag Component - minimal Variant
...
(function() {
    ...
    function initDragMinimal() {
        const components = document.querySelectorAll('.ema-drag--minimal');
        ...
        console.log(`Drag minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drag minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Drag minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragMinimal);
    } else {
        initDragMinimal();
    }
