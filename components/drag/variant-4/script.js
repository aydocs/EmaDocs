...
(function() {
    ...
    function initDragGlass() {
        const components = document.querySelectorAll('.ema-drag--glass');
        ...
        console.log(`Drag glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drag glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Drag glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragGlass);
    } else {
        initDragGlass();
    }
