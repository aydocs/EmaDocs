...
(function() {
    ...
    function initDragSoft() {
        const components = document.querySelectorAll('.ema-drag--soft');
        ...
        console.log(`Drag soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Drag soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDragSoft);
    } else {
        initDragSoft();
    }
