/**
 * NavbarCollapse Component - neo Variant
...
(function() {
    ...
    function initNavbarCollapseNeo() {
        const components = document.querySelectorAll('.ema-navbarcollapse--neo');
        ...
        console.log(`NavbarCollapse neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarCollapse neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarCollapse neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarCollapseNeo);
    } else {
        initNavbarCollapseNeo();
    }
