/**
 * NavbarCollapse Component - premium Variant
...
(function() {
    ...
    function initNavbarCollapsePremium() {
        const components = document.querySelectorAll('.ema-navbarcollapse--premium');
        ...
        console.log(`NavbarCollapse premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarCollapse premium clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarCollapse premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarCollapsePremium);
    } else {
        initNavbarCollapsePremium();
    }
