...
(function() {
    ...
    function initNavbarCollapseGlass() {
        const components = document.querySelectorAll('.ema-navbarcollapse--glass');
        ...
        console.log(`NavbarCollapse glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarCollapse glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarCollapse glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarCollapseGlass);
    } else {
        initNavbarCollapseGlass();
    }
