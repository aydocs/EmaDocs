/**
 * NavbarCollapse Component - minimal Variant
...
(function() {
    ...
    function initNavbarCollapseMinimal() {
        const components = document.querySelectorAll('.ema-navbarcollapse--minimal');
        ...
        console.log(`NavbarCollapse minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarCollapse component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarCollapse minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarcollapse:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarCollapse minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarCollapseMinimal);
    } else {
        initNavbarCollapseMinimal();
    }
