/**
 * NavbarCollapse Component - soft Variant
...
(function() {
    ...
    function initNavbarCollapseSoft() {
        const components = document.querySelectorAll('.ema-navbarcollapse--soft');
        ...
        console.log(`NavbarCollapse soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarCollapse soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarCollapse soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarCollapseSoft);
    } else {
        initNavbarCollapseSoft();
    }
