/**
 * NavbarCollapse Component - Main Entry Point
...
// Export component
export { default as NavbarCollapse } from './navbarcollapse.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarCollapse', {
    name: 'NavbarCollapse',
...
console.log('NavbarCollapse component loaded with 5 variants');
