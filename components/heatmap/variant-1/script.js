/**
 * Heatmap Component - minimal Variant
...
(function() {
    ...
    function initHeatmapMinimal() {
        const components = document.querySelectorAll('.ema-heatmap--minimal');
        ...
        console.log(`Heatmap minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Heatmap component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Heatmap minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('heatmap:click', {
    ...
    window.handleClick = function() {
        console.log('Heatmap minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeatmapMinimal);
    } else {
        initHeatmapMinimal();
    }
