/**
 * Heatmap Component - glass Variant
...
(function() {
    ...
    function initHeatmapGlass() {
        const components = document.querySelectorAll('.ema-heatmap--glass');
        ...
        console.log(`Heatmap glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Heatmap glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Heatmap glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeatmapGlass);
    } else {
        initHeatmapGlass();
    }
