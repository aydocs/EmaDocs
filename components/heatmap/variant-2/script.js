...
(function() {
    ...
    function initHeatmapNeo() {
        const components = document.querySelectorAll('.ema-heatmap--neo');
        ...
        console.log(`Heatmap neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Heatmap neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Heatmap neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeatmapNeo);
    } else {
        initHeatmapNeo();
    }
