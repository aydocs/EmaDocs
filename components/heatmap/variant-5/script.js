/**
 * Heatmap Component - premium Variant
...
(function() {
    ...
    function initHeatmapPremium() {
        const components = document.querySelectorAll('.ema-heatmap--premium');
        ...
        console.log(`Heatmap premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Heatmap premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Heatmap premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeatmapPremium);
    } else {
        initHeatmapPremium();
    }
