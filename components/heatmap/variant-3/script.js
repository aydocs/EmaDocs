/**
 * Heatmap Component - soft Variant
...
(function() {
    ...
    function initHeatmapSoft() {
        const components = document.querySelectorAll('.ema-heatmap--soft');
        ...
        console.log(`Heatmap soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Heatmap soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Heatmap soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHeatmapSoft);
    } else {
        initHeatmapSoft();
    }
