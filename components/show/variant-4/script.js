...
(function() {
    ...
    function initShowGlass() {
        const components = document.querySelectorAll('.ema-show--glass');
        ...
        console.log(`Show glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Show glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Show glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShowGlass);
    } else {
        initShowGlass();
    }
