/**
 * Show Component - minimal Variant
...
(function() {
    ...
    function initShowMinimal() {
        const components = document.querySelectorAll('.ema-show--minimal');
        ...
        console.log(`Show minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Show component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Show minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('show:click', {
    ...
    window.handleClick = function() {
        console.log('Show minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShowMinimal);
    } else {
        initShowMinimal();
    }
