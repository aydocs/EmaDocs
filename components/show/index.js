/**
 * Show Component - Main Entry Point
...
// Export component
export { default as Show } from './show.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Show', {
    name: 'Show',
...
console.log('Show component loaded with 5 variants');
