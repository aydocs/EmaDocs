...
(function() {
    ...
    function initShowNeo() {
        const components = document.querySelectorAll('.ema-show--neo');
        ...
        console.log(`Show neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Show neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShowNeo);
    } else {
        initShowNeo();
    }
