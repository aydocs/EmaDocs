/**
 * Show Component - premium Variant
...
(function() {
    ...
    function initShowPremium() {
        const components = document.querySelectorAll('.ema-show--premium');
        ...
        console.log(`Show premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Show premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Show premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShowPremium);
    } else {
        initShowPremium();
    }
