...
(function() {
    ...
    function initShowSoft() {
        const components = document.querySelectorAll('.ema-show--soft');
        ...
        console.log(`Show soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Show soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initShowSoft);
    } else {
        initShowSoft();
    }
