/**
 * Navigate Component - neo Variant
...
(function() {
    ...
    function initNavigateNeo() {
        const components = document.querySelectorAll('.ema-navigate--neo');
        ...
        console.log(`Navigate neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navigate neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Navigate neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavigateNeo);
    } else {
        initNavigateNeo();
    }
