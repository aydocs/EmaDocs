/**
 * Navigate Component - premium Variant
...
(function() {
    ...
    function initNavigatePremium() {
        const components = document.querySelectorAll('.ema-navigate--premium');
        ...
        console.log(`Navigate premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Navigate component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navigate premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navigate:click', {
    ...
    window.handleClick = function() {
        console.log('Navigate premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavigatePremium);
    } else {
        initNavigatePremium();
    }
