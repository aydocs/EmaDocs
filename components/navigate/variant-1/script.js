/**
 * Navigate Component - minimal Variant
...
(function() {
    ...
    function initNavigateMinimal() {
        const components = document.querySelectorAll('.ema-navigate--minimal');
        ...
        console.log(`Navigate minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navigate minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Navigate minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavigateMinimal);
    } else {
        initNavigateMinimal();
    }
