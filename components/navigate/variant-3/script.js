/**
 * Navigate Component - soft Variant
...
(function() {
    ...
    function initNavigateSoft() {
        const components = document.querySelectorAll('.ema-navigate--soft');
        ...
        console.log(`Navigate soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navigate soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Navigate soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavigateSoft);
    } else {
        initNavigateSoft();
    }
