/**
 * Navigate Component - glass Variant
...
(function() {
    ...
    function initNavigateGlass() {
        const components = document.querySelectorAll('.ema-navigate--glass');
        ...
        console.log(`Navigate glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navigate glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Navigate glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavigateGlass);
    } else {
        initNavigateGlass();
    }
