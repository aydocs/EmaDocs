/**
 * Visible Component - minimal Variant
...
(function() {
    ...
    function initVisibleMinimal() {
        const components = document.querySelectorAll('.ema-visible--minimal');
        ...
        console.log(`Visible minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Visible minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Visible minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVisibleMinimal);
    } else {
        initVisibleMinimal();
    }
