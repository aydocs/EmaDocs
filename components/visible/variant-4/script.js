/**
 * Visible Component - glass Variant
...
(function() {
    ...
    function initVisibleGlass() {
        const components = document.querySelectorAll('.ema-visible--glass');
        ...
        console.log(`Visible glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Visible glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Visible glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVisibleGlass);
    } else {
        initVisibleGlass();
    }
