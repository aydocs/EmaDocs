/**
 * Visible Component - premium Variant
...
(function() {
    ...
    function initVisiblePremium() {
        const components = document.querySelectorAll('.ema-visible--premium');
        ...
        console.log(`Visible premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Visible component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Visible premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('visible:click', {
    ...
    window.handleClick = function() {
        console.log('Visible premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVisiblePremium);
    } else {
        initVisiblePremium();
    }
