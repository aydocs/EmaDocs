/**
 * Visible Component - Main Entry Point
...
// Export component
export { default as Visible } from './visible.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Visible', {
    name: 'Visible',
...
console.log('Visible component loaded with 5 variants');
