...
(function() {
    ...
    function initVisibleNeo() {
        const components = document.querySelectorAll('.ema-visible--neo');
        ...
        console.log(`Visible neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Visible neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Visible neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVisibleNeo);
    } else {
        initVisibleNeo();
    }
