/**
 * Visible Component - soft Variant
...
(function() {
    ...
    function initVisibleSoft() {
        const components = document.querySelectorAll('.ema-visible--soft');
        ...
        console.log(`Visible soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Visible soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Visible soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVisibleSoft);
    } else {
        initVisibleSoft();
    }
