/**
 * Accordion Component - minimal Variant
...
(function() {
    ...
    function initAccordionMinimal() {
        const components = document.querySelectorAll('.ema-accordion--minimal');
        ...
        console.log(`Accordion minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Accordion component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Accordion minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('accordion:click', {
    ...
    window.handleClick = function() {
        console.log('Accordion minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAccordionMinimal);
    } else {
        initAccordionMinimal();
    }
