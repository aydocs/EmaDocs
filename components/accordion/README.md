...
A comprehensive Accordion component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Accordion variant="minimal">Minimal</Accordion>
<Accordion variant="neo">Neo</Accordion>
<Accordion variant="soft">Soft</Accordion>
<Accordion variant="glass">Glass</Accordion>
<Accordion variant="premium">Premium</Accordion>
```
...
- `accordion.ema` - Main component definition
