/**
 * Accordion Component - neo Variant
...
(function() {
    ...
    function initAccordionNeo() {
        const components = document.querySelectorAll('.ema-accordion--neo');
        ...
        console.log(`Accordion neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Accordion neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Accordion neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAccordionNeo);
    } else {
        initAccordionNeo();
    }
