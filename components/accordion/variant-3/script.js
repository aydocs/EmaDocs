/**
 * Accordion Component - soft Variant
...
(function() {
    ...
    function initAccordionSoft() {
        const components = document.querySelectorAll('.ema-accordion--soft');
        ...
        console.log(`Accordion soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Accordion soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Accordion soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAccordionSoft);
    } else {
        initAccordionSoft();
    }
