/**
 * Accordion Component - premium Variant
...
(function() {
    ...
    function initAccordionPremium() {
        const components = document.querySelectorAll('.ema-accordion--premium');
        ...
        console.log(`Accordion premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Accordion premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Accordion premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAccordionPremium);
    } else {
        initAccordionPremium();
    }
