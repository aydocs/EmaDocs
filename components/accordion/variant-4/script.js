/**
 * Accordion Component - glass Variant
...
(function() {
    ...
    function initAccordionGlass() {
        const components = document.querySelectorAll('.ema-accordion--glass');
        ...
        console.log(`Accordion glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Accordion glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Accordion glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAccordionGlass);
    } else {
        initAccordionGlass();
    }
