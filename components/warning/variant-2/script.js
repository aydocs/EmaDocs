...
(function() {
    ...
    function initWarningNeo() {
        const components = document.querySelectorAll('.ema-warning--neo');
        ...
        console.log(`Warning neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Warning neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Warning neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWarningNeo);
    } else {
        initWarningNeo();
    }
