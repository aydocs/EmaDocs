/**
 * Warning Component - soft Variant
...
(function() {
    ...
    function initWarningSoft() {
        const components = document.querySelectorAll('.ema-warning--soft');
        ...
        console.log(`Warning soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Warning soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Warning soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWarningSoft);
    } else {
        initWarningSoft();
    }
