/**
 * Warning Component - premium Variant
...
(function() {
    ...
    function initWarningPremium() {
        const components = document.querySelectorAll('.ema-warning--premium');
        ...
        console.log(`Warning premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Warning premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Warning premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWarningPremium);
    } else {
        initWarningPremium();
    }
