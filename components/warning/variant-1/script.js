/**
 * Warning Component - minimal Variant
...
(function() {
    ...
    function initWarningMinimal() {
        const components = document.querySelectorAll('.ema-warning--minimal');
        ...
        console.log(`Warning minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Warning component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Warning minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('warning:click', {
    ...
    window.handleClick = function() {
        console.log('Warning minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWarningMinimal);
    } else {
        initWarningMinimal();
    }
