/**
 * Warning Component - glass Variant
...
(function() {
    ...
    function initWarningGlass() {
        const components = document.querySelectorAll('.ema-warning--glass');
        ...
        console.log(`Warning glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Warning glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Warning glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initWarningGlass);
    } else {
        initWarningGlass();
    }
