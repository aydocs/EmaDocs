/**
 * Resize Component - glass Variant
...
(function() {
    ...
    function initResizeGlass() {
        const components = document.querySelectorAll('.ema-resize--glass');
        ...
        console.log(`Resize glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Resize glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Resize glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResizeGlass);
    } else {
        initResizeGlass();
    }
