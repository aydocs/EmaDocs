/**
 * Resize Component - premium Variant
...
(function() {
    ...
    function initResizePremium() {
        const components = document.querySelectorAll('.ema-resize--premium');
        ...
        console.log(`Resize premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Resize component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Resize premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('resize:click', {
    ...
    window.handleClick = function() {
        console.log('Resize premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResizePremium);
    } else {
        initResizePremium();
    }
