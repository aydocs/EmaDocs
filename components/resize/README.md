...
A comprehensive Resize component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Resize variant="minimal">Minimal</Resize>
<Resize variant="neo">Neo</Resize>
<Resize variant="soft">Soft</Resize>
<Resize variant="glass">Glass</Resize>
<Resize variant="premium">Premium</Resize>
```
...
- `resize.ema` - Main component definition
