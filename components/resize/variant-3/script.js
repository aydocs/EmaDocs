...
(function() {
    ...
    function initResizeSoft() {
        const components = document.querySelectorAll('.ema-resize--soft');
        ...
        console.log(`Resize soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Resize soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Resize soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResizeSoft);
    } else {
        initResizeSoft();
    }
