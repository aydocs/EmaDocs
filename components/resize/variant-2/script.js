...
(function() {
    ...
    function initResizeNeo() {
        const components = document.querySelectorAll('.ema-resize--neo');
        ...
        console.log(`Resize neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Resize neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Resize neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResizeNeo);
    } else {
        initResizeNeo();
    }
