/**
 * Resize Component - minimal Variant
...
(function() {
    ...
    function initResizeMinimal() {
        const components = document.querySelectorAll('.ema-resize--minimal');
        ...
        console.log(`Resize minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Resize minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Resize minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResizeMinimal);
    } else {
        initResizeMinimal();
    }
