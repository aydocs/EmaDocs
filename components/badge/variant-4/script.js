...
(function() {
    ...
    function initBadgeGlass() {
        const components = document.querySelectorAll('.ema-badge--glass');
        ...
        console.log(`Badge glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Badge glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Badge glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBadgeGlass);
    } else {
        initBadgeGlass();
    }
