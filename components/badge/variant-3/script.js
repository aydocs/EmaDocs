...
(function() {
    ...
    function initBadgeSoft() {
        const components = document.querySelectorAll('.ema-badge--soft');
        ...
        console.log(`Badge soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Badge soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Badge soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBadgeSoft);
    } else {
        initBadgeSoft();
    }
