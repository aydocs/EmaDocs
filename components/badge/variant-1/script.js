/**
 * Badge Component - minimal Variant
...
(function() {
    ...
    function initBadgeMinimal() {
        const components = document.querySelectorAll('.ema-badge--minimal');
        ...
        console.log(`Badge minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Badge minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Badge minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBadgeMinimal);
    } else {
        initBadgeMinimal();
    }
