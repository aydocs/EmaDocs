/**
 * Badge Component - Main Entry Point
...
// Export component
export { default as Badge } from './badge.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Badge', {
    name: 'Badge',
...
console.log('Badge component loaded with 5 variants');
