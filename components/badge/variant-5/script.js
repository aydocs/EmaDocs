/**
 * Badge Component - premium Variant
...
(function() {
    ...
    function initBadgePremium() {
        const components = document.querySelectorAll('.ema-badge--premium');
        ...
        console.log(`Badge premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Badge component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Badge premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('badge:click', {
    ...
    window.handleClick = function() {
        console.log('Badge premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBadgePremium);
    } else {
        initBadgePremium();
    }
