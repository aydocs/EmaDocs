...
(function() {
    ...
    function initBadgeNeo() {
        const components = document.querySelectorAll('.ema-badge--neo');
        ...
        console.log(`Badge neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Badge neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBadgeNeo);
    } else {
        initBadgeNeo();
    }
