...
(function() {
    ...
    function initBarGlass() {
        const components = document.querySelectorAll('.ema-bar--glass');
        ...
        console.log(`Bar glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Bar glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBarGlass);
    } else {
        initBarGlass();
    }
