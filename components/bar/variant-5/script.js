...
(function() {
    ...
    function initBarPremium() {
        const components = document.querySelectorAll('.ema-bar--premium');
        ...
        console.log(`Bar premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Bar component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bar premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('bar:click', {
    ...
    window.handleClick = function() {
        console.log('Bar premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBarPremium);
    } else {
        initBarPremium();
    }
