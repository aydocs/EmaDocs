...
(function() {
    ...
    function initBarNeo() {
        const components = document.querySelectorAll('.ema-bar--neo');
        ...
        console.log(`Bar neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Bar neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBarNeo);
    } else {
        initBarNeo();
    }
