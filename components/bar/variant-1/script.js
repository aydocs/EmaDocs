...
(function() {
    ...
    function initBarMinimal() {
        const components = document.querySelectorAll('.ema-bar--minimal');
        ...
        console.log(`Bar minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bar minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Bar minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBarMinimal);
    } else {
        initBarMinimal();
    }
