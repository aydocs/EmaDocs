...
(function() {
    ...
    function initBarSoft() {
        const components = document.querySelectorAll('.ema-bar--soft');
        ...
        console.log(`Bar soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Bar soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBarSoft);
    } else {
        initBarSoft();
    }
