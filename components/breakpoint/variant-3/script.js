/**
 * Breakpoint Component - soft Variant
...
(function() {
    ...
    function initBreakpointSoft() {
        const components = document.querySelectorAll('.ema-breakpoint--soft');
        ...
        console.log(`Breakpoint soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breakpoint soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Breakpoint soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakpointSoft);
    } else {
        initBreakpointSoft();
    }
