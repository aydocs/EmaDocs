/**
 * Breakpoint Component - minimal Variant
...
(function() {
    ...
    function initBreakpointMinimal() {
        const components = document.querySelectorAll('.ema-breakpoint--minimal');
        ...
        console.log(`Breakpoint minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breakpoint minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Breakpoint minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakpointMinimal);
    } else {
        initBreakpointMinimal();
    }
