/**
 * Breakpoint Component - neo Variant
...
(function() {
    ...
    function initBreakpointNeo() {
        const components = document.querySelectorAll('.ema-breakpoint--neo');
        ...
        console.log(`Breakpoint neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Breakpoint neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Breakpoint neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakpointNeo);
    } else {
        initBreakpointNeo();
    }
