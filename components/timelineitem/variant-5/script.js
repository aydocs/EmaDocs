/**
 * TimelineItem Component - premium Variant
...
(function() {
    ...
    function initTimelineItemPremium() {
        const components = document.querySelectorAll('.ema-timelineitem--premium');
        ...
        console.log(`TimelineItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimelineItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TimelineItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimelineItemPremium);
    } else {
        initTimelineItemPremium();
    }
