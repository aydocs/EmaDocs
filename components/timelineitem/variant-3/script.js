/**
 * TimelineItem Component - soft Variant
...
(function() {
    ...
    function initTimelineItemSoft() {
        const components = document.querySelectorAll('.ema-timelineitem--soft');
        ...
        console.log(`TimelineItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimelineItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TimelineItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimelineItemSoft);
    } else {
        initTimelineItemSoft();
    }
