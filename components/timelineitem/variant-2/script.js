/**
 * TimelineItem Component - neo Variant
...
(function() {
    ...
    function initTimelineItemNeo() {
        const components = document.querySelectorAll('.ema-timelineitem--neo');
        ...
        console.log(`TimelineItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TimelineItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TimelineItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTimelineItemNeo);
    } else {
        initTimelineItemNeo();
    }
