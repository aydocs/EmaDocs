/**
 * Container Component - minimal Variant
...
(function() {
    ...
    function initContainerMinimal() {
        const components = document.querySelectorAll('.ema-container--minimal');
        ...
        console.log(`Container minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Container component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Container minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('container:click', {
    ...
    window.handleClick = function() {
        console.log('Container minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initContainerMinimal);
    } else {
        initContainerMinimal();
    }
