...
A comprehensive Container component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Container variant="minimal">Minimal</Container>
<Container variant="neo">Neo</Container>
<Container variant="soft">Soft</Container>
<Container variant="glass">Glass</Container>
<Container variant="premium">Premium</Container>
```
...
- `container.ema` - Main component definition
