/**
 * Container Component - glass Variant
...
(function() {
    ...
    function initContainerGlass() {
        const components = document.querySelectorAll('.ema-container--glass');
        ...
        console.log(`Container glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Container glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Container glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initContainerGlass);
    } else {
        initContainerGlass();
    }
