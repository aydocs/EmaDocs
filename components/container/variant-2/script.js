/**
 * Container Component - neo Variant
...
(function() {
    ...
    function initContainerNeo() {
        const components = document.querySelectorAll('.ema-container--neo');
        ...
        console.log(`Container neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Container neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Container neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initContainerNeo);
    } else {
        initContainerNeo();
    }
