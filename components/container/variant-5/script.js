/**
 * Container Component - premium Variant
...
(function() {
    ...
    function initContainerPremium() {
        const components = document.querySelectorAll('.ema-container--premium');
        ...
        console.log(`Container premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Container premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Container premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initContainerPremium);
    } else {
        initContainerPremium();
    }
