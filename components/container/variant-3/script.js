/**
 * Container Component - soft Variant
...
(function() {
    ...
    function initContainerSoft() {
        const components = document.querySelectorAll('.ema-container--soft');
        ...
        console.log(`Container soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Container soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Container soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initContainerSoft);
    } else {
        initContainerSoft();
    }
