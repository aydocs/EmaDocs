...
A comprehensive Screen component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Screen variant="minimal">Minimal</Screen>
<Screen variant="neo">Neo</Screen>
<Screen variant="soft">Soft</Screen>
<Screen variant="glass">Glass</Screen>
<Screen variant="premium">Premium</Screen>
```
...
- `screen.ema` - Main component definition
