/**
 * Screen Component - premium Variant
...
(function() {
    ...
    function initScreenPremium() {
        const components = document.querySelectorAll('.ema-screen--premium');
        ...
        console.log(`Screen premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Screen premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Screen premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScreenPremium);
    } else {
        initScreenPremium();
    }
