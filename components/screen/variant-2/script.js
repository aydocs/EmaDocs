...
(function() {
    ...
    function initScreenNeo() {
        const components = document.querySelectorAll('.ema-screen--neo');
        ...
        console.log(`Screen neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Screen neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Screen neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScreenNeo);
    } else {
        initScreenNeo();
    }
