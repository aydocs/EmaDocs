/**
 * Screen Component - minimal Variant
...
(function() {
    ...
    function initScreenMinimal() {
        const components = document.querySelectorAll('.ema-screen--minimal');
        ...
        console.log(`Screen minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Screen component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Screen minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('screen:click', {
    ...
    window.handleClick = function() {
        console.log('Screen minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScreenMinimal);
    } else {
        initScreenMinimal();
    }
