/**
 * Screen Component - glass Variant
...
(function() {
    ...
    function initScreenGlass() {
        const components = document.querySelectorAll('.ema-screen--glass');
        ...
        console.log(`Screen glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Screen glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Screen glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScreenGlass);
    } else {
        initScreenGlass();
    }
