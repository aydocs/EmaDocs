...
(function() {
    ...
    function initScreenSoft() {
        const components = document.querySelectorAll('.ema-screen--soft');
        ...
        console.log(`Screen soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Screen soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Screen soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initScreenSoft);
    } else {
        initScreenSoft();
    }
