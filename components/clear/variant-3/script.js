...
(function() {
    ...
    function initClearSoft() {
        const components = document.querySelectorAll('.ema-clear--soft');
        ...
        console.log(`Clear soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Clear soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Clear soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClearSoft);
    } else {
        initClearSoft();
    }
