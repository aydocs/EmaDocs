/**
 * Clear Component - minimal Variant
...
(function() {
    ...
    function initClearMinimal() {
        const components = document.querySelectorAll('.ema-clear--minimal');
        ...
        console.log(`Clear minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Clear component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Clear minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('clear:click', {
    ...
    window.handleClick = function() {
        console.log('Clear minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClearMinimal);
    } else {
        initClearMinimal();
    }
