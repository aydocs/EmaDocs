/**
 * Clear Component - premium Variant
...
(function() {
    ...
    function initClearPremium() {
        const components = document.querySelectorAll('.ema-clear--premium');
        ...
        console.log(`Clear premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Clear premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Clear premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClearPremium);
    } else {
        initClearPremium();
    }
