...
(function() {
    ...
    function initClearNeo() {
        const components = document.querySelectorAll('.ema-clear--neo');
        ...
        console.log(`Clear neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Clear neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClearNeo);
    } else {
        initClearNeo();
    }
