...
A comprehensive Clear component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Clear variant="minimal">Minimal</Clear>
<Clear variant="neo">Neo</Clear>
<Clear variant="soft">Soft</Clear>
<Clear variant="glass">Glass</Clear>
<Clear variant="premium">Premium</Clear>
```
...
- `clear.ema` - Main component definition
