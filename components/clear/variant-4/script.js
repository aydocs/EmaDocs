...
(function() {
    ...
    function initClearGlass() {
        const components = document.querySelectorAll('.ema-clear--glass');
        ...
        console.log(`Clear glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Clear glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Clear glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initClearGlass);
    } else {
        initClearGlass();
    }
