/**
 * Column Component - glass Variant
...
(function() {
    ...
    function initColumnGlass() {
        const components = document.querySelectorAll('.ema-column--glass');
        ...
        console.log(`Column glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Column glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Column glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColumnGlass);
    } else {
        initColumnGlass();
    }
