...
(function() {
    ...
    function initColumnNeo() {
        const components = document.querySelectorAll('.ema-column--neo');
        ...
        console.log(`Column neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Column neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Column neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColumnNeo);
    } else {
        initColumnNeo();
    }
