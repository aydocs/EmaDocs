/**
 * Column Component - premium Variant
...
(function() {
    ...
    function initColumnPremium() {
        const components = document.querySelectorAll('.ema-column--premium');
        ...
        console.log(`Column premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Column component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Column premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('column:click', {
    ...
    window.handleClick = function() {
        console.log('Column premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColumnPremium);
    } else {
        initColumnPremium();
    }
