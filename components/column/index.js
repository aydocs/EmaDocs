/**
 * Column Component - Main Entry Point
...
// Export component
export { default as Column } from './column.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Column', {
    name: 'Column',
...
console.log('Column component loaded with 5 variants');
