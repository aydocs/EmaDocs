...
(function() {
    ...
    function initColumnSoft() {
        const components = document.querySelectorAll('.ema-column--soft');
        ...
        console.log(`Column soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Column soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Column soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColumnSoft);
    } else {
        initColumnSoft();
    }
