/**
 * Column Component - minimal Variant
...
(function() {
    ...
    function initColumnMinimal() {
        const components = document.querySelectorAll('.ema-column--minimal');
        ...
        console.log(`Column minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Column minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Column minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColumnMinimal);
    } else {
        initColumnMinimal();
    }
