...
A comprehensive Column component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Column variant="minimal">Minimal</Column>
<Column variant="neo">Neo</Column>
<Column variant="soft">Soft</Column>
<Column variant="glass">Glass</Column>
<Column variant="premium">Premium</Column>
```
...
- `column.ema` - Main component definition
