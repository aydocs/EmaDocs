/**
 * Popover Component - soft Variant
...
(function() {
    ...
    function initPopoverSoft() {
        const components = document.querySelectorAll('.ema-popover--soft');
        ...
        console.log(`Popover soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Popover soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Popover soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPopoverSoft);
    } else {
        initPopoverSoft();
    }
