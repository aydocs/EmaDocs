/**
 * Popover Component - minimal Variant
...
(function() {
    ...
    function initPopoverMinimal() {
        const components = document.querySelectorAll('.ema-popover--minimal');
        ...
        console.log(`Popover minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Popover component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Popover minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('popover:click', {
    ...
    window.handleClick = function() {
        console.log('Popover minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPopoverMinimal);
    } else {
        initPopoverMinimal();
    }
