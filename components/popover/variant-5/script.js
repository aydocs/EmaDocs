/**
 * Popover Component - premium Variant
...
(function() {
    ...
    function initPopoverPremium() {
        const components = document.querySelectorAll('.ema-popover--premium');
        ...
        console.log(`Popover premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Popover premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Popover premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPopoverPremium);
    } else {
        initPopoverPremium();
    }
