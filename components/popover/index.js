/**
 * Popover Component - Main Entry Point
...
// Export component
export { default as Popover } from './popover.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Popover', {
    name: 'Popover',
...
console.log('Popover component loaded with 5 variants');
