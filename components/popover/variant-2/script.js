...
(function() {
    ...
    function initPopoverNeo() {
        const components = document.querySelectorAll('.ema-popover--neo');
        ...
        console.log(`Popover neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Popover neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Popover neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPopoverNeo);
    } else {
        initPopoverNeo();
    }
