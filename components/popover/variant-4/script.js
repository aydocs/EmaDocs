/**
 * Popover Component - glass Variant
...
(function() {
    ...
    function initPopoverGlass() {
        const components = document.querySelectorAll('.ema-popover--glass');
        ...
        console.log(`Popover glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Popover glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Popover glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPopoverGlass);
    } else {
        initPopoverGlass();
    }
