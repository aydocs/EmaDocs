...
(function() {
    ...
    function initBoxMinimal() {
        const components = document.querySelectorAll('.ema-box--minimal');
        ...
        console.log(`Box minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Box component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Box minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('box:click', {
    ...
    window.handleClick = function() {
        console.log('Box minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBoxMinimal);
    } else {
        initBoxMinimal();
    }
