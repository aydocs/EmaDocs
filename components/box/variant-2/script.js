...
(function() {
    ...
    function initBoxNeo() {
        const components = document.querySelectorAll('.ema-box--neo');
        ...
        console.log(`Box neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Box neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBoxNeo);
    } else {
        initBoxNeo();
    }
