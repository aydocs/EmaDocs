...
(function() {
    ...
    function initBoxSoft() {
        const components = document.querySelectorAll('.ema-box--soft');
        ...
        console.log(`Box soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Box soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBoxSoft);
    } else {
        initBoxSoft();
    }
