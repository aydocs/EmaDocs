...
A comprehensive Box component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Box variant="minimal">Minimal</Box>
<Box variant="neo">Neo</Box>
<Box variant="soft">Soft</Box>
<Box variant="glass">Glass</Box>
<Box variant="premium">Premium</Box>
```
...
- `box.ema` - Main component definition
