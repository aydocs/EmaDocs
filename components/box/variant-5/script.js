...
(function() {
    ...
    function initBoxPremium() {
        const components = document.querySelectorAll('.ema-box--premium');
        ...
        console.log(`Box premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Box premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Box premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBoxPremium);
    } else {
        initBoxPremium();
    }
