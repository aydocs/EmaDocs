...
(function() {
    ...
    function initBoxGlass() {
        const components = document.querySelectorAll('.ema-box--glass');
        ...
        console.log(`Box glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Box glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBoxGlass);
    } else {
        initBoxGlass();
    }
