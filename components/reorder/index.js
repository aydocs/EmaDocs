/**
 * Reorder Component - Main Entry Point
...
// Export component
export { default as Reorder } from './reorder.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Reorder', {
    name: 'Reorder',
...
console.log('Reorder component loaded with 5 variants');
