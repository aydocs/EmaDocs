...
(function() {
    ...
    function initReorderNeo() {
        const components = document.querySelectorAll('.ema-reorder--neo');
        ...
        console.log(`Reorder neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reorder neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Reorder neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initReorderNeo);
    } else {
        initReorderNeo();
    }
