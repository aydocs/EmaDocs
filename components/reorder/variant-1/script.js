/**
 * Reorder Component - minimal Variant
...
(function() {
    ...
    function initReorderMinimal() {
        const components = document.querySelectorAll('.ema-reorder--minimal');
        ...
        console.log(`Reorder minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reorder minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Reorder minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initReorderMinimal);
    } else {
        initReorderMinimal();
    }
