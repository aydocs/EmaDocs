/**
 * Reorder Component - glass Variant
...
(function() {
    ...
    function initReorderGlass() {
        const components = document.querySelectorAll('.ema-reorder--glass');
        ...
        console.log(`Reorder glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reorder glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Reorder glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initReorderGlass);
    } else {
        initReorderGlass();
    }
