/**
 * Reorder Component - soft Variant
...
(function() {
    ...
    function initReorderSoft() {
        const components = document.querySelectorAll('.ema-reorder--soft');
        ...
        console.log(`Reorder soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reorder soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Reorder soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initReorderSoft);
    } else {
        initReorderSoft();
    }
