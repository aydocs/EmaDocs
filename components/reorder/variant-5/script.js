...
(function() {
    ...
    function initReorderPremium() {
        const components = document.querySelectorAll('.ema-reorder--premium');
        ...
        console.log(`Reorder premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Reorder component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reorder premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('reorder:click', {
    ...
    window.handleClick = function() {
        console.log('Reorder premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initReorderPremium);
    } else {
        initReorderPremium();
    }
