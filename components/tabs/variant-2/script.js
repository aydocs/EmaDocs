...
(function() {
    ...
    function initTabsNeo() {
        const components = document.querySelectorAll('.ema-tabs--neo');
        ...
        console.log(`Tabs neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tabs neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabsNeo);
    } else {
        initTabsNeo();
    }
