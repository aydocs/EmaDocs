/**
 * Tabs Component - minimal Variant
...
(function() {
    ...
    function initTabsMinimal() {
        const components = document.querySelectorAll('.ema-tabs--minimal');
        ...
        console.log(`Tabs minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tabs minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Tabs minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabsMinimal);
    } else {
        initTabsMinimal();
    }
