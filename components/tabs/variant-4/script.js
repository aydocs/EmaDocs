...
(function() {
    ...
    function initTabsGlass() {
        const components = document.querySelectorAll('.ema-tabs--glass');
        ...
        console.log(`Tabs glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tabs glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Tabs glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabsGlass);
    } else {
        initTabsGlass();
    }
