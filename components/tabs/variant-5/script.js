/**
 * Tabs Component - premium Variant
...
(function() {
    ...
    function initTabsPremium() {
        const components = document.querySelectorAll('.ema-tabs--premium');
        ...
        console.log(`Tabs premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Tabs component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Tabs premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tabs:click', {
    ...
    window.handleClick = function() {
        console.log('Tabs premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabsPremium);
    } else {
        initTabsPremium();
    }
