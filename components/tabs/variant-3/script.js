...
(function() {
    ...
    function initTabsSoft() {
        const components = document.querySelectorAll('.ema-tabs--soft');
        ...
        console.log(`Tabs soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Tabs soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabsSoft);
    } else {
        initTabsSoft();
    }
