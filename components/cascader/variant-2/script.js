/**
 * Cascader Component - neo Variant
...
(function() {
    ...
    function initCascaderNeo() {
        const components = document.querySelectorAll('.ema-cascader--neo');
        ...
        console.log(`Cascader neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Cascader neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Cascader neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCascaderNeo);
    } else {
        initCascaderNeo();
    }
