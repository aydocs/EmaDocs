/**
 * Cascader Component - premium Variant
...
(function() {
    ...
    function initCascaderPremium() {
        const components = document.querySelectorAll('.ema-cascader--premium');
        ...
        console.log(`Cascader premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Cascader premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Cascader premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCascaderPremium);
    } else {
        initCascaderPremium();
    }
