/**
 * Cascader Component - soft Variant
...
(function() {
    ...
    function initCascaderSoft() {
        const components = document.querySelectorAll('.ema-cascader--soft');
        ...
        console.log(`Cascader soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Cascader soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Cascader soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCascaderSoft);
    } else {
        initCascaderSoft();
    }
