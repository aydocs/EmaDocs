/**
 * Cascader Component - glass Variant
...
(function() {
    ...
    function initCascaderGlass() {
        const components = document.querySelectorAll('.ema-cascader--glass');
        ...
        console.log(`Cascader glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Cascader glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Cascader glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCascaderGlass);
    } else {
        initCascaderGlass();
    }
