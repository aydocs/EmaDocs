/**
 * Cascader Component - minimal Variant
...
(function() {
    ...
    function initCascaderMinimal() {
        const components = document.querySelectorAll('.ema-cascader--minimal');
        ...
        console.log(`Cascader minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Cascader component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Cascader minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('cascader:click', {
    ...
    window.handleClick = function() {
        console.log('Cascader minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCascaderMinimal);
    } else {
        initCascaderMinimal();
    }
