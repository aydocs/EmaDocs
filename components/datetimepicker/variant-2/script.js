/**
 * DateTimePicker Component - neo Variant
...
(function() {
    ...
    function initDateTimePickerNeo() {
        const components = document.querySelectorAll('.ema-datetimepicker--neo');
        ...
        console.log(`DateTimePicker neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DateTimePicker neo clicked`);
    ...
    window.handleClick = function() {
        console.log('DateTimePicker neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDateTimePickerNeo);
    } else {
        initDateTimePickerNeo();
    }
