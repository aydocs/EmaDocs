...
A comprehensive DateTimePicker component for Emadocs Framework with 5 beautiful variants.
...
```ema
<DateTimePicker variant="minimal">
...
```ema
<DateTimePicker variant="minimal">Minimal</DateTimePicker>
<DateTimePicker variant="neo">Neo</DateTimePicker>
<DateTimePicker variant="soft">Soft</DateTimePicker>
<DateTimePicker variant="glass">Glass</DateTimePicker>
<DateTimePicker variant="premium">Premium</DateTimePicker>
```
...
- `datetimepicker.ema` - Main component definition
