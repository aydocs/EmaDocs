/**
 * DateTimePicker Component - soft Variant
...
(function() {
    ...
    function initDateTimePickerSoft() {
        const components = document.querySelectorAll('.ema-datetimepicker--soft');
        ...
        console.log(`DateTimePicker soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DateTimePicker soft clicked`);
    ...
    window.handleClick = function() {
        console.log('DateTimePicker soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDateTimePickerSoft);
    } else {
        initDateTimePickerSoft();
    }
