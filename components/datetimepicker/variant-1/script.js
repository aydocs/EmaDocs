/**
 * DateTimePicker Component - minimal Variant
...
(function() {
    ...
    function initDateTimePickerMinimal() {
        const components = document.querySelectorAll('.ema-datetimepicker--minimal');
        ...
        console.log(`DateTimePicker minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `DateTimePicker component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DateTimePicker minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('datetimepicker:click', {
    ...
    window.handleClick = function() {
        console.log('DateTimePicker minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDateTimePickerMinimal);
    } else {
        initDateTimePickerMinimal();
    }
