/**
 * DateTimePicker Component - Main Entry Point
...
// Export component
export { default as DateTimePicker } from './datetimepicker.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('DateTimePicker', {
    name: 'DateTimePicker',
...
console.log('DateTimePicker component loaded with 5 variants');
