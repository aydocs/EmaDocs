/**
 * DateTimePicker Component - glass Variant
...
(function() {
    ...
    function initDateTimePickerGlass() {
        const components = document.querySelectorAll('.ema-datetimepicker--glass');
        ...
        console.log(`DateTimePicker glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DateTimePicker glass clicked`);
    ...
    window.handleClick = function() {
        console.log('DateTimePicker glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDateTimePickerGlass);
    } else {
        initDateTimePickerGlass();
    }
