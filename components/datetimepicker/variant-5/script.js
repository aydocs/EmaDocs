/**
 * DateTimePicker Component - premium Variant
...
(function() {
    ...
    function initDateTimePickerPremium() {
        const components = document.querySelectorAll('.ema-datetimepicker--premium');
        ...
        console.log(`DateTimePicker premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DateTimePicker premium clicked`);
    ...
    window.handleClick = function() {
        console.log('DateTimePicker premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDateTimePickerPremium);
    } else {
        initDateTimePickerPremium();
    }
