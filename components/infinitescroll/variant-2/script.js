/**
 * InfiniteScroll Component - neo Variant
...
(function() {
    ...
    function initInfiniteScrollNeo() {
        const components = document.querySelectorAll('.ema-infinitescroll--neo');
        ...
        console.log(`InfiniteScroll neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteScroll neo clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteScroll neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteScrollNeo);
    } else {
        initInfiniteScrollNeo();
    }
