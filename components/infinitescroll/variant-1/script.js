/**
 * InfiniteScroll Component - minimal Variant
...
(function() {
    ...
    function initInfiniteScrollMinimal() {
        const components = document.querySelectorAll('.ema-infinitescroll--minimal');
        ...
        console.log(`InfiniteScroll minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `InfiniteScroll component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteScroll minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('infinitescroll:click', {
    ...
    window.handleClick = function() {
        console.log('InfiniteScroll minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteScrollMinimal);
    } else {
        initInfiniteScrollMinimal();
    }
