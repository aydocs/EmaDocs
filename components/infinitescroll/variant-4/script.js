/**
 * InfiniteScroll Component - glass Variant
...
(function() {
    ...
    function initInfiniteScrollGlass() {
        const components = document.querySelectorAll('.ema-infinitescroll--glass');
        ...
        console.log(`InfiniteScroll glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteScroll glass clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteScroll glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteScrollGlass);
    } else {
        initInfiniteScrollGlass();
    }
