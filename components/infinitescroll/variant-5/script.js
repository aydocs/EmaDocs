/**
 * InfiniteScroll Component - premium Variant
...
(function() {
    ...
    function initInfiniteScrollPremium() {
        const components = document.querySelectorAll('.ema-infinitescroll--premium');
        ...
        console.log(`InfiniteScroll premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteScroll premium clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteScroll premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteScrollPremium);
    } else {
        initInfiniteScrollPremium();
    }
