/**
 * InfiniteScroll Component - Main Entry Point
...
// Export component
export { default as InfiniteScroll } from './infinitescroll.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('InfiniteScroll', {
    name: 'InfiniteScroll',
...
console.log('InfiniteScroll component loaded with 5 variants');
