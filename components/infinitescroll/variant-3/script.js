...
(function() {
    ...
    function initInfiniteScrollSoft() {
        const components = document.querySelectorAll('.ema-infinitescroll--soft');
        ...
        console.log(`InfiniteScroll soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteScroll soft clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteScroll soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteScrollSoft);
    } else {
        initInfiniteScrollSoft();
    }
