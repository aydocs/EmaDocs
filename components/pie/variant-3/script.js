...
(function() {
    ...
    function initPieSoft() {
        const components = document.querySelectorAll('.ema-pie--soft');
        ...
        console.log(`Pie soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Pie soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPieSoft);
    } else {
        initPieSoft();
    }
