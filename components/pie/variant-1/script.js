...
(function() {
    ...
    function initPieMinimal() {
        const components = document.querySelectorAll('.ema-pie--minimal');
        ...
        console.log(`Pie minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pie minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Pie minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPieMinimal);
    } else {
        initPieMinimal();
    }
