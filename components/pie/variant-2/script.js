...
(function() {
    ...
    function initPieNeo() {
        const components = document.querySelectorAll('.ema-pie--neo');
        ...
        console.log(`Pie neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Pie neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPieNeo);
    } else {
        initPieNeo();
    }
