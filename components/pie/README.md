...
A comprehensive Pie component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Pie variant="minimal">Minimal</Pie>
<Pie variant="neo">Neo</Pie>
<Pie variant="soft">Soft</Pie>
<Pie variant="glass">Glass</Pie>
<Pie variant="premium">Premium</Pie>
```
...
- `pie.ema` - Main component definition
