...
(function() {
    ...
    function initPieGlass() {
        const components = document.querySelectorAll('.ema-pie--glass');
        ...
        console.log(`Pie glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Pie glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPieGlass);
    } else {
        initPieGlass();
    }
