...
(function() {
    ...
    function initPiePremium() {
        const components = document.querySelectorAll('.ema-pie--premium');
        ...
        console.log(`Pie premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Pie component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Pie premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('pie:click', {
    ...
    window.handleClick = function() {
        console.log('Pie premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPiePremium);
    } else {
        initPiePremium();
    }
