/**
 * NavbarBrand Component - glass Variant
...
(function() {
    ...
    function initNavbarBrandGlass() {
        const components = document.querySelectorAll('.ema-navbarbrand--glass');
        ...
        console.log(`NavbarBrand glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarBrand glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarBrand glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarBrandGlass);
    } else {
        initNavbarBrandGlass();
    }
