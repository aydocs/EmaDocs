/**
 * NavbarBrand Component - soft Variant
...
(function() {
    ...
    function initNavbarBrandSoft() {
        const components = document.querySelectorAll('.ema-navbarbrand--soft');
        ...
        console.log(`NavbarBrand soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarBrand soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarBrand soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarBrandSoft);
    } else {
        initNavbarBrandSoft();
    }
