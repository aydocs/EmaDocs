/**
 * NavbarBrand Component - Main Entry Point
...
// Export component
export { default as NavbarBrand } from './navbarbrand.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarBrand', {
    name: 'NavbarBrand',
...
console.log('NavbarBrand component loaded with 5 variants');
