/**
 * NavbarBrand Component - neo Variant
...
(function() {
    ...
    function initNavbarBrandNeo() {
        const components = document.querySelectorAll('.ema-navbarbrand--neo');
        ...
        console.log(`NavbarBrand neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarBrand neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarBrand neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarBrandNeo);
    } else {
        initNavbarBrandNeo();
    }
