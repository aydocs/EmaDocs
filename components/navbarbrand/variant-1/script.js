/**
 * NavbarBrand Component - minimal Variant
...
(function() {
    ...
    function initNavbarBrandMinimal() {
        const components = document.querySelectorAll('.ema-navbarbrand--minimal');
        ...
        console.log(`NavbarBrand minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarBrand component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarBrand minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarbrand:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarBrand minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarBrandMinimal);
    } else {
        initNavbarBrandMinimal();
    }
