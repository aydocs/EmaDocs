/**
 * NavbarBrand Component - premium Variant
...
(function() {
    ...
    function initNavbarBrandPremium() {
        const components = document.querySelectorAll('.ema-navbarbrand--premium');
        ...
        console.log(`NavbarBrand premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarBrand premium clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarBrand premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarBrandPremium);
    } else {
        initNavbarBrandPremium();
    }
