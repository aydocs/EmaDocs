...
(function() {
    ...
    function initDotNeo() {
        const components = document.querySelectorAll('.ema-dot--neo');
        ...
        console.log(`Dot neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Dot neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDotNeo);
    } else {
        initDotNeo();
    }
