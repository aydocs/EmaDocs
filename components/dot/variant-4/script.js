...
(function() {
    ...
    function initDotGlass() {
        const components = document.querySelectorAll('.ema-dot--glass');
        ...
        console.log(`Dot glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Dot glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDotGlass);
    } else {
        initDotGlass();
    }
