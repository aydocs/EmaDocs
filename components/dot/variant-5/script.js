...
(function() {
    ...
    function initDotPremium() {
        const components = document.querySelectorAll('.ema-dot--premium');
        ...
        console.log(`Dot premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Dot component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dot premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('dot:click', {
    ...
    window.handleClick = function() {
        console.log('Dot premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDotPremium);
    } else {
        initDotPremium();
    }
