...
(function() {
    ...
    function initDotSoft() {
        const components = document.querySelectorAll('.ema-dot--soft');
        ...
        console.log(`Dot soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Dot soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDotSoft);
    } else {
        initDotSoft();
    }
