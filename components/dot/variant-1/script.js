...
(function() {
    ...
    function initDotMinimal() {
        const components = document.querySelectorAll('.ema-dot--minimal');
        ...
        console.log(`Dot minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Dot minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Dot minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDotMinimal);
    } else {
        initDotMinimal();
    }
