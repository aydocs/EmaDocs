...
A comprehensive Dot component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Dot variant="minimal">Minimal</Dot>
<Dot variant="neo">Neo</Dot>
<Dot variant="soft">Soft</Dot>
<Dot variant="glass">Glass</Dot>
<Dot variant="premium">Premium</Dot>
```
...
- `dot.ema` - Main component definition
