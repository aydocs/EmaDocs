/**
 * DatePicker Component - glass Variant
...
(function() {
    ...
    function initDatePickerGlass() {
        const components = document.querySelectorAll('.ema-datepicker--glass');
        ...
        console.log(`DatePicker glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DatePicker glass clicked`);
    ...
    window.handleClick = function() {
        console.log('DatePicker glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDatePickerGlass);
    } else {
        initDatePickerGlass();
    }
