/**
 * DatePicker Component - Main Entry Point
...
// Export component
export { default as DatePicker } from './datepicker.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('DatePicker', {
    name: 'DatePicker',
...
console.log('DatePicker component loaded with 5 variants');
