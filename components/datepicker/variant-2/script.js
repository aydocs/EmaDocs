/**
 * DatePicker Component - neo Variant
...
(function() {
    ...
    function initDatePickerNeo() {
        const components = document.querySelectorAll('.ema-datepicker--neo');
        ...
        console.log(`DatePicker neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DatePicker neo clicked`);
    ...
    window.handleClick = function() {
        console.log('DatePicker neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDatePickerNeo);
    } else {
        initDatePickerNeo();
    }
