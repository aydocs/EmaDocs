...
A comprehensive DatePicker component for Emadocs Framework with 5 beautiful variants.
...
```ema
<DatePicker variant="minimal">Minimal</DatePicker>
<DatePicker variant="neo">Neo</DatePicker>
<DatePicker variant="soft">Soft</DatePicker>
<DatePicker variant="glass">Glass</DatePicker>
<DatePicker variant="premium">Premium</DatePicker>
```
...
- `datepicker.ema` - Main component definition
