/**
 * DatePicker Component - soft Variant
...
(function() {
    ...
    function initDatePickerSoft() {
        const components = document.querySelectorAll('.ema-datepicker--soft');
        ...
        console.log(`DatePicker soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DatePicker soft clicked`);
    ...
    window.handleClick = function() {
        console.log('DatePicker soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDatePickerSoft);
    } else {
        initDatePickerSoft();
    }
