/**
 * DatePicker Component - premium Variant
...
(function() {
    ...
    function initDatePickerPremium() {
        const components = document.querySelectorAll('.ema-datepicker--premium');
        ...
        console.log(`DatePicker premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `DatePicker component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DatePicker premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('datepicker:click', {
    ...
    window.handleClick = function() {
        console.log('DatePicker premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDatePickerPremium);
    } else {
        initDatePickerPremium();
    }
