/**
 * DatePicker Component - minimal Variant
...
(function() {
    ...
    function initDatePickerMinimal() {
        const components = document.querySelectorAll('.ema-datepicker--minimal');
        ...
        console.log(`DatePicker minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DatePicker minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('DatePicker minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDatePickerMinimal);
    } else {
        initDatePickerMinimal();
    }
