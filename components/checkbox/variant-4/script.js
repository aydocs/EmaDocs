/**
 * Checkbox Component - glass Variant
...
(function() {
    ...
    function initCheckboxGlass() {
        const components = document.querySelectorAll('.ema-checkbox--glass');
        ...
        console.log(`Checkbox glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Checkbox glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Checkbox glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCheckboxGlass);
    } else {
        initCheckboxGlass();
    }
