/**
 * Checkbox Component - soft Variant
...
(function() {
    ...
    function initCheckboxSoft() {
        const components = document.querySelectorAll('.ema-checkbox--soft');
        ...
        console.log(`Checkbox soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Checkbox soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Checkbox soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCheckboxSoft);
    } else {
        initCheckboxSoft();
    }
