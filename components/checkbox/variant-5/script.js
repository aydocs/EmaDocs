/**
 * Checkbox Component - premium Variant
...
(function() {
    ...
    function initCheckboxPremium() {
        const components = document.querySelectorAll('.ema-checkbox--premium');
        ...
        console.log(`Checkbox premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Checkbox premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Checkbox premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCheckboxPremium);
    } else {
        initCheckboxPremium();
    }
