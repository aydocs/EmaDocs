/**
 * Checkbox Component - minimal Variant
...
(function() {
    ...
    function initCheckboxMinimal() {
        const components = document.querySelectorAll('.ema-checkbox--minimal');
        ...
        console.log(`Checkbox minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Checkbox component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Checkbox minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('checkbox:click', {
    ...
    window.handleClick = function() {
        console.log('Checkbox minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCheckboxMinimal);
    } else {
        initCheckboxMinimal();
    }
