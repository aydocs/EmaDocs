/**
 * Checkbox Component - neo Variant
...
(function() {
    ...
    function initCheckboxNeo() {
        const components = document.querySelectorAll('.ema-checkbox--neo');
        ...
        console.log(`Checkbox neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Checkbox neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Checkbox neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCheckboxNeo);
    } else {
        initCheckboxNeo();
    }
