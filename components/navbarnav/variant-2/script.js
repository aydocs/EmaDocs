/**
 * NavbarNav Component - neo Variant
...
(function() {
    ...
    function initNavbarNavNeo() {
        const components = document.querySelectorAll('.ema-navbarnav--neo');
        ...
        console.log(`NavbarNav neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNav neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarNav neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNavNeo);
    } else {
        initNavbarNavNeo();
    }
