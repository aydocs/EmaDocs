/**
 * NavbarNav Component - soft Variant
...
(function() {
    ...
    function initNavbarNavSoft() {
        const components = document.querySelectorAll('.ema-navbarnav--soft');
        ...
        console.log(`NavbarNav soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNav soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarNav soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNavSoft);
    } else {
        initNavbarNavSoft();
    }
