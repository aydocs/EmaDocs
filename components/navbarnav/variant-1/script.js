/**
 * NavbarNav Component - minimal Variant
...
(function() {
    ...
    function initNavbarNavMinimal() {
        const components = document.querySelectorAll('.ema-navbarnav--minimal');
        ...
        console.log(`NavbarNav minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNav minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarNav minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNavMinimal);
    } else {
        initNavbarNavMinimal();
    }
