/**
 * NavbarNav Component - glass Variant
...
(function() {
    ...
    function initNavbarNavGlass() {
        const components = document.querySelectorAll('.ema-navbarnav--glass');
        ...
        console.log(`NavbarNav glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNav glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarNav glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNavGlass);
    } else {
        initNavbarNavGlass();
    }
