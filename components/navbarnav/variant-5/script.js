/**
 * NavbarNav Component - premium Variant
...
(function() {
    ...
    function initNavbarNavPremium() {
        const components = document.querySelectorAll('.ema-navbarnav--premium');
        ...
        console.log(`NavbarNav premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarNav component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNav premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarnav:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarNav premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNavPremium);
    } else {
        initNavbarNavPremium();
    }
