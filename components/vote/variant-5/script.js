/**
 * Vote Component - premium Variant
...
(function() {
    ...
    function initVotePremium() {
        const components = document.querySelectorAll('.ema-vote--premium');
        ...
        console.log(`Vote premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Vote component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Vote premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('vote:click', {
    ...
    window.handleClick = function() {
        console.log('Vote premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVotePremium);
    } else {
        initVotePremium();
    }
