/**
 * Vote Component - minimal Variant
...
(function() {
    ...
    function initVoteMinimal() {
        const components = document.querySelectorAll('.ema-vote--minimal');
        ...
        console.log(`Vote minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Vote minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Vote minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVoteMinimal);
    } else {
        initVoteMinimal();
    }
