...
(function() {
    ...
    function initVoteSoft() {
        const components = document.querySelectorAll('.ema-vote--soft');
        ...
        console.log(`Vote soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Vote soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVoteSoft);
    } else {
        initVoteSoft();
    }
