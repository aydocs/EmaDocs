...
(function() {
    ...
    function initVoteGlass() {
        const components = document.querySelectorAll('.ema-vote--glass');
        ...
        console.log(`Vote glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Vote glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Vote glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVoteGlass);
    } else {
        initVoteGlass();
    }
