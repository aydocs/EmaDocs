...
(function() {
    ...
    function initVoteNeo() {
        const components = document.querySelectorAll('.ema-vote--neo');
        ...
        console.log(`Vote neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Vote neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVoteNeo);
    } else {
        initVoteNeo();
    }
