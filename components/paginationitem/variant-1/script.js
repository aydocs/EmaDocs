/**
 * PaginationItem Component - minimal Variant
...
(function() {
    ...
    function initPaginationItemMinimal() {
        const components = document.querySelectorAll('.ema-paginationitem--minimal');
        ...
        console.log(`PaginationItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `PaginationItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`PaginationItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('paginationitem:click', {
    ...
    window.handleClick = function() {
        console.log('PaginationItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationItemMinimal);
    } else {
        initPaginationItemMinimal();
    }
