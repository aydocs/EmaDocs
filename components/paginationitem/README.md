...
A comprehensive PaginationItem component for Emadocs Framework with 5 beautiful variants.
...
```ema
<PaginationItem variant="minimal">
  Basic PaginationItem
</PaginationItem>
```
...
```ema
<PaginationItem variant="minimal">Minimal</PaginationItem>
<PaginationItem variant="neo">Neo</PaginationItem>
<PaginationItem variant="soft">Soft</PaginationItem>
<PaginationItem variant="glass">Glass</PaginationItem>
<PaginationItem variant="premium">Premium</PaginationItem>
```
...
- `paginationitem.ema` - Main component definition
