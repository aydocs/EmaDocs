/**
 * PaginationItem Component - soft Variant
...
(function() {
    ...
    function initPaginationItemSoft() {
        const components = document.querySelectorAll('.ema-paginationitem--soft');
        ...
        console.log(`PaginationItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`PaginationItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('PaginationItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationItemSoft);
    } else {
        initPaginationItemSoft();
    }
