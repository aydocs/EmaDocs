/**
 * PaginationItem Component - Main Entry Point
...
// Export component
export { default as PaginationItem } from './paginationitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('PaginationItem', {
    name: 'PaginationItem',
...
console.log('PaginationItem component loaded with 5 variants');
