/**
 * PaginationItem Component - premium Variant
...
(function() {
    ...
    function initPaginationItemPremium() {
        const components = document.querySelectorAll('.ema-paginationitem--premium');
        ...
        console.log(`PaginationItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`PaginationItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('PaginationItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationItemPremium);
    } else {
        initPaginationItemPremium();
    }
