/**
 * PaginationItem Component - glass Variant
...
(function() {
    ...
    function initPaginationItemGlass() {
        const components = document.querySelectorAll('.ema-paginationitem--glass');
        ...
        console.log(`PaginationItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`PaginationItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('PaginationItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationItemGlass);
    } else {
        initPaginationItemGlass();
    }
