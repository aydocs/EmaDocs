/**
 * PaginationItem Component - neo Variant
...
(function() {
    ...
    function initPaginationItemNeo() {
        const components = document.querySelectorAll('.ema-paginationitem--neo');
        ...
        console.log(`PaginationItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`PaginationItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('PaginationItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginationItemNeo);
    } else {
        initPaginationItemNeo();
    }
