...
A comprehensive Filter component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Filter variant="minimal">Minimal</Filter>
<Filter variant="neo">Neo</Filter>
<Filter variant="soft">Soft</Filter>
<Filter variant="glass">Glass</Filter>
<Filter variant="premium">Premium</Filter>
```
...
- `filter.ema` - Main component definition
