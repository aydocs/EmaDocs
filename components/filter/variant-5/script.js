...
(function() {
    ...
    function initFilterPremium() {
        const components = document.querySelectorAll('.ema-filter--premium');
        ...
        console.log(`Filter premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Filter component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Filter premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('filter:click', {
    ...
    window.handleClick = function() {
        console.log('Filter premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFilterPremium);
    } else {
        initFilterPremium();
    }
