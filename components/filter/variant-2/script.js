...
(function() {
    ...
    function initFilterNeo() {
        const components = document.querySelectorAll('.ema-filter--neo');
        ...
        console.log(`Filter neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Filter neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Filter neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFilterNeo);
    } else {
        initFilterNeo();
    }
