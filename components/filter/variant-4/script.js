/**
 * Filter Component - glass Variant
...
(function() {
    ...
    function initFilterGlass() {
        const components = document.querySelectorAll('.ema-filter--glass');
        ...
        console.log(`Filter glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Filter glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Filter glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFilterGlass);
    } else {
        initFilterGlass();
    }
