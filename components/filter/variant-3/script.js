...
(function() {
    ...
    function initFilterSoft() {
        const components = document.querySelectorAll('.ema-filter--soft');
        ...
        console.log(`Filter soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Filter soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Filter soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFilterSoft);
    } else {
        initFilterSoft();
    }
