/**
 * Filter Component - minimal Variant
...
(function() {
    ...
    function initFilterMinimal() {
        const components = document.querySelectorAll('.ema-filter--minimal');
        ...
        console.log(`Filter minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Filter minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Filter minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFilterMinimal);
    } else {
        initFilterMinimal();
    }
