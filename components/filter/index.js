/**
 * Filter Component - Main Entry Point
...
// Export component
export { default as Filter } from './filter.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Filter', {
    name: 'Filter',
...
console.log('Filter component loaded with 5 variants');
