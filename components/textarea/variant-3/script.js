/**
 * Textarea Component - soft Variant
...
(function() {
    ...
    function initTextareaSoft() {
        const components = document.querySelectorAll('.ema-textarea--soft');
        ...
        console.log(`Textarea soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Textarea soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Textarea soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTextareaSoft);
    } else {
        initTextareaSoft();
    }
