/**
 * Textarea Component - premium Variant
...
(function() {
    ...
    function initTextareaPremium() {
        const components = document.querySelectorAll('.ema-textarea--premium');
        ...
        console.log(`Textarea premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Textarea component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Textarea premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('textarea:click', {
    ...
    window.handleClick = function() {
        console.log('Textarea premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTextareaPremium);
    } else {
        initTextareaPremium();
    }
