/**
 * Textarea Component - minimal Variant
...
(function() {
    ...
    function initTextareaMinimal() {
        const components = document.querySelectorAll('.ema-textarea--minimal');
        ...
        console.log(`Textarea minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Textarea minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Textarea minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTextareaMinimal);
    } else {
        initTextareaMinimal();
    }
