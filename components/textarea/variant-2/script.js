/**
 * Textarea Component - neo Variant
...
(function() {
    ...
    function initTextareaNeo() {
        const components = document.querySelectorAll('.ema-textarea--neo');
        ...
        console.log(`Textarea neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Textarea neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Textarea neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTextareaNeo);
    } else {
        initTextareaNeo();
    }
