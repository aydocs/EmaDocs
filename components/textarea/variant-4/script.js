/**
 * Textarea Component - glass Variant
...
(function() {
    ...
    function initTextareaGlass() {
        const components = document.querySelectorAll('.ema-textarea--glass');
        ...
        console.log(`Textarea glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Textarea glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Textarea glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTextareaGlass);
    } else {
        initTextareaGlass();
    }
