...
(function() {
    ...
    function initStackNeo() {
        const components = document.querySelectorAll('.ema-stack--neo');
        ...
        console.log(`Stack neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Stack neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStackNeo);
    } else {
        initStackNeo();
    }
