...
(function() {
    ...
    function initStackSoft() {
        const components = document.querySelectorAll('.ema-stack--soft');
        ...
        console.log(`Stack soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stack soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Stack soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStackSoft);
    } else {
        initStackSoft();
    }
