...
(function() {
    ...
    function initStackGlass() {
        const components = document.querySelectorAll('.ema-stack--glass');
        ...
        console.log(`Stack glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stack glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Stack glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStackGlass);
    } else {
        initStackGlass();
    }
