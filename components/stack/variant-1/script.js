/**
 * Stack Component - minimal Variant
...
(function() {
    ...
    function initStackMinimal() {
        const components = document.querySelectorAll('.ema-stack--minimal');
        ...
        console.log(`Stack minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stack minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Stack minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStackMinimal);
    } else {
        initStackMinimal();
    }
