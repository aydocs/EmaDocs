/**
 * Stack Component - premium Variant
...
(function() {
    ...
    function initStackPremium() {
        const components = document.querySelectorAll('.ema-stack--premium');
        ...
        console.log(`Stack premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Stack component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stack premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('stack:click', {
    ...
    window.handleClick = function() {
        console.log('Stack premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStackPremium);
    } else {
        initStackPremium();
    }
