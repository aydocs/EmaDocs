/**
 * Sidebar Component - minimal Variant
...
(function() {
    ...
    function initSidebarMinimal() {
        const components = document.querySelectorAll('.ema-sidebar--minimal');
        ...
        console.log(`Sidebar minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sidebar minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Sidebar minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarMinimal);
    } else {
        initSidebarMinimal();
    }
