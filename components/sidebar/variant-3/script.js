/**
 * Sidebar Component - soft Variant
...
(function() {
    ...
    function initSidebarSoft() {
        const components = document.querySelectorAll('.ema-sidebar--soft');
        ...
        console.log(`Sidebar soft variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Sidebar component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sidebar soft clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('sidebar:click', {
    ...
    window.handleClick = function() {
        console.log('Sidebar soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarSoft);
    } else {
        initSidebarSoft();
    }
