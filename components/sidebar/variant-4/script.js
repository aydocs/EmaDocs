/**
 * Sidebar Component - glass Variant
...
(function() {
    ...
    function initSidebarGlass() {
        const components = document.querySelectorAll('.ema-sidebar--glass');
        ...
        console.log(`Sidebar glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Sidebar glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarGlass);
    } else {
        initSidebarGlass();
    }
