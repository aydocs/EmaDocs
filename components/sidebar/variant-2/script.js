...
(function() {
    ...
    function initSidebarNeo() {
        const components = document.querySelectorAll('.ema-sidebar--neo');
        ...
        console.log(`Sidebar neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sidebar neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Sidebar neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarNeo);
    } else {
        initSidebarNeo();
    }
