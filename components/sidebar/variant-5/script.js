/**
 * Sidebar Component - premium Variant
...
(function() {
    ...
    function initSidebarPremium() {
        const components = document.querySelectorAll('.ema-sidebar--premium');
        ...
        console.log(`Sidebar premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sidebar premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Sidebar premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSidebarPremium);
    } else {
        initSidebarPremium();
    }
