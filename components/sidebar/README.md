...
A comprehensive Sidebar component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Sidebar variant="minimal">Minimal</Sidebar>
<Sidebar variant="neo">Neo</Sidebar>
<Sidebar variant="soft">Soft</Sidebar>
<Sidebar variant="glass">Glass</Sidebar>
<Sidebar variant="premium">Premium</Sidebar>
```
...
- `sidebar.ema` - Main component definition
