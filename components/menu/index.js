/**
 * Menu Component - Main Entry Point
...
// Export component
export { default as Menu } from './menu.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Menu', {
    name: 'Menu',
...
console.log('Menu component loaded with 5 variants');
