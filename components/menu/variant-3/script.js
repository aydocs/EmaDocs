...
(function() {
    ...
    function initMenuSoft() {
        const components = document.querySelectorAll('.ema-menu--soft');
        ...
        console.log(`Menu soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Menu soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuSoft);
    } else {
        initMenuSoft();
    }
