/**
 * Menu Component - premium Variant
...
(function() {
    ...
    function initMenuPremium() {
        const components = document.querySelectorAll('.ema-menu--premium');
        ...
        console.log(`Menu premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Menu component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Menu premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('menu:click', {
    ...
    window.handleClick = function() {
        console.log('Menu premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuPremium);
    } else {
        initMenuPremium();
    }
