...
(function() {
    ...
    function initMenuNeo() {
        const components = document.querySelectorAll('.ema-menu--neo');
        ...
        console.log(`Menu neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Menu neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuNeo);
    } else {
        initMenuNeo();
    }
