/**
 * Menu Component - minimal Variant
...
(function() {
    ...
    function initMenuMinimal() {
        const components = document.querySelectorAll('.ema-menu--minimal');
        ...
        console.log(`Menu minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Menu minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Menu minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuMinimal);
    } else {
        initMenuMinimal();
    }
