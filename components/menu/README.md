...
A comprehensive Menu component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Menu variant="minimal">Minimal</Menu>
<Menu variant="neo">Neo</Menu>
<Menu variant="soft">Soft</Menu>
<Menu variant="glass">Glass</Menu>
<Menu variant="premium">Premium</Menu>
```
...
- `menu.ema` - Main component definition
