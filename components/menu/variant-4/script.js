...
(function() {
    ...
    function initMenuGlass() {
        const components = document.querySelectorAll('.ema-menu--glass');
        ...
        console.log(`Menu glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Menu glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Menu glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMenuGlass);
    } else {
        initMenuGlass();
    }
