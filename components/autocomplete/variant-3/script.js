/**
 * Autocomplete Component - soft Variant
...
(function() {
    ...
    function initAutocompleteSoft() {
        const components = document.querySelectorAll('.ema-autocomplete--soft');
        ...
        console.log(`Autocomplete soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Autocomplete soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Autocomplete soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAutocompleteSoft);
    } else {
        initAutocompleteSoft();
    }
