/**
 * Autocomplete Component - minimal Variant
...
(function() {
    ...
    function initAutocompleteMinimal() {
        const components = document.querySelectorAll('.ema-autocomplete--minimal');
        ...
        console.log(`Autocomplete minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Autocomplete component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Autocomplete minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('autocomplete:click', {
    ...
    window.handleClick = function() {
        console.log('Autocomplete minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAutocompleteMinimal);
    } else {
        initAutocompleteMinimal();
    }
