/**
 * Autocomplete Component - glass Variant
...
(function() {
    ...
    function initAutocompleteGlass() {
        const components = document.querySelectorAll('.ema-autocomplete--glass');
        ...
        console.log(`Autocomplete glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Autocomplete glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Autocomplete glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAutocompleteGlass);
    } else {
        initAutocompleteGlass();
    }
