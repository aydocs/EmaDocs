/**
 * Autocomplete Component - premium Variant
...
(function() {
    ...
    function initAutocompletePremium() {
        const components = document.querySelectorAll('.ema-autocomplete--premium');
        ...
        console.log(`Autocomplete premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Autocomplete premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Autocomplete premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAutocompletePremium);
    } else {
        initAutocompletePremium();
    }
