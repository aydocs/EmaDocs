/**
 * Autocomplete Component - neo Variant
...
(function() {
    ...
    function initAutocompleteNeo() {
        const components = document.querySelectorAll('.ema-autocomplete--neo');
        ...
        console.log(`Autocomplete neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Autocomplete neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Autocomplete neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAutocompleteNeo);
    } else {
        initAutocompleteNeo();
    }
