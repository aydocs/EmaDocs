...
A comprehensive Autocomplete component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Autocomplete variant="minimal">Minimal</Autocomplete>
<Autocomplete variant="neo">Neo</Autocomplete>
<Autocomplete variant="soft">Soft</Autocomplete>
<Autocomplete variant="glass">Glass</Autocomplete>
<Autocomplete variant="premium">Premium</Autocomplete>
```
...
- `autocomplete.ema` - Main component definition
