...
(function() {
    ...
    function initPaginateNeo() {
        const components = document.querySelectorAll('.ema-paginate--neo');
        ...
        console.log(`Paginate neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Paginate neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Paginate neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginateNeo);
    } else {
        initPaginateNeo();
    }
