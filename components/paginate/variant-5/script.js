/**
 * Paginate Component - premium Variant
...
(function() {
    ...
    function initPaginatePremium() {
        const components = document.querySelectorAll('.ema-paginate--premium');
        ...
        console.log(`Paginate premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Paginate component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Paginate premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('paginate:click', {
    ...
    window.handleClick = function() {
        console.log('Paginate premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginatePremium);
    } else {
        initPaginatePremium();
    }
