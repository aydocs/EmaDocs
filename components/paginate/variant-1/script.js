/**
 * Paginate Component - minimal Variant
...
(function() {
    ...
    function initPaginateMinimal() {
        const components = document.querySelectorAll('.ema-paginate--minimal');
        ...
        console.log(`Paginate minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Paginate minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Paginate minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginateMinimal);
    } else {
        initPaginateMinimal();
    }
