/**
 * Paginate Component - glass Variant
...
(function() {
    ...
    function initPaginateGlass() {
        const components = document.querySelectorAll('.ema-paginate--glass');
        ...
        console.log(`Paginate glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Paginate glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Paginate glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginateGlass);
    } else {
        initPaginateGlass();
    }
