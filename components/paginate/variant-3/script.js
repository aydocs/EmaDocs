/**
 * Paginate Component - soft Variant
...
(function() {
    ...
    function initPaginateSoft() {
        const components = document.querySelectorAll('.ema-paginate--soft');
        ...
        console.log(`Paginate soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Paginate soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Paginate soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPaginateSoft);
    } else {
        initPaginateSoft();
    }
