...
A comprehensive Paginate component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Paginate variant="minimal">Minimal</Paginate>
<Paginate variant="neo">Neo</Paginate>
<Paginate variant="soft">Soft</Paginate>
<Paginate variant="glass">Glass</Paginate>
<Paginate variant="premium">Premium</Paginate>
```
...
- `paginate.ema` - Main component definition
