/**
 * TreeSelect Component - neo Variant
...
(function() {
    ...
    function initTreeSelectNeo() {
        const components = document.querySelectorAll('.ema-treeselect--neo');
        ...
        console.log(`TreeSelect neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeSelect neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeSelect neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSelectNeo);
    } else {
        initTreeSelectNeo();
    }
