/**
 * TreeSelect Component - glass Variant
...
(function() {
    ...
    function initTreeSelectGlass() {
        const components = document.querySelectorAll('.ema-treeselect--glass');
        ...
        console.log(`TreeSelect glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeSelect glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeSelect glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSelectGlass);
    } else {
        initTreeSelectGlass();
    }
