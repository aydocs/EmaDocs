/**
 * TreeSelect Component - premium Variant
...
(function() {
    ...
    function initTreeSelectPremium() {
        const components = document.querySelectorAll('.ema-treeselect--premium');
        ...
        console.log(`TreeSelect premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeSelect premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeSelect premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSelectPremium);
    } else {
        initTreeSelectPremium();
    }
