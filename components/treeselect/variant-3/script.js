/**
 * TreeSelect Component - soft Variant
...
(function() {
    ...
    function initTreeSelectSoft() {
        const components = document.querySelectorAll('.ema-treeselect--soft');
        ...
        console.log(`TreeSelect soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeSelect soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeSelect soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSelectSoft);
    } else {
        initTreeSelectSoft();
    }
