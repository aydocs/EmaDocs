/**
 * TreeSelect Component - minimal Variant
...
(function() {
    ...
    function initTreeSelectMinimal() {
        const components = document.querySelectorAll('.ema-treeselect--minimal');
        ...
        console.log(`TreeSelect minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TreeSelect component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeSelect minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('treeselect:click', {
    ...
    window.handleClick = function() {
        console.log('TreeSelect minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeSelectMinimal);
    } else {
        initTreeSelectMinimal();
    }
