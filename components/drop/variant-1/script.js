/**
 * Drop Component - minimal Variant
...
(function() {
    ...
    function initDropMinimal() {
        const components = document.querySelectorAll('.ema-drop--minimal');
        ...
        console.log(`Drop minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Drop component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drop minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('drop:click', {
    ...
    window.handleClick = function() {
        console.log('Drop minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropMinimal);
    } else {
        initDropMinimal();
    }
