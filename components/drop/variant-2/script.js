...
(function() {
    ...
    function initDropNeo() {
        const components = document.querySelectorAll('.ema-drop--neo');
        ...
        console.log(`Drop neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Drop neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropNeo);
    } else {
        initDropNeo();
    }
