...
(function() {
    ...
    function initDropSoft() {
        const components = document.querySelectorAll('.ema-drop--soft');
        ...
        console.log(`Drop soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Drop soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropSoft);
    } else {
        initDropSoft();
    }
