...
(function() {
    ...
    function initDropGlass() {
        const components = document.querySelectorAll('.ema-drop--glass');
        ...
        console.log(`Drop glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drop glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Drop glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropGlass);
    } else {
        initDropGlass();
    }
