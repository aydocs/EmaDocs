/**
 * Drop Component - premium Variant
...
(function() {
    ...
    function initDropPremium() {
        const components = document.querySelectorAll('.ema-drop--premium');
        ...
        console.log(`Drop premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drop premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Drop premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDropPremium);
    } else {
        initDropPremium();
    }
