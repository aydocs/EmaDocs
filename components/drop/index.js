/**
 * Drop Component - Main Entry Point
...
// Export component
export { default as Drop } from './drop.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Drop', {
    name: 'Drop',
...
console.log('Drop component loaded with 5 variants');
