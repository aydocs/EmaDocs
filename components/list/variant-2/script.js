...
(function() {
    ...
    function initListNeo() {
        const components = document.querySelectorAll('.ema-list--neo');
        ...
        console.log(`List neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('List neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListNeo);
    } else {
        initListNeo();
    }
