/**
 * List Component - minimal Variant
...
(function() {
    ...
    function initListMinimal() {
        const components = document.querySelectorAll('.ema-list--minimal');
        ...
        console.log(`List minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`List minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('List minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListMinimal);
    } else {
        initListMinimal();
    }
