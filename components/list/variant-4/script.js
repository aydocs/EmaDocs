...
(function() {
    ...
    function initListGlass() {
        const components = document.querySelectorAll('.ema-list--glass');
        ...
        console.log(`List glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`List glass clicked`);
    ...
    window.handleClick = function() {
        console.log('List glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListGlass);
    } else {
        initListGlass();
    }
