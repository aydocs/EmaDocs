...
(function() {
    ...
    function initListSoft() {
        const components = document.querySelectorAll('.ema-list--soft');
        ...
        console.log(`List soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('List soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListSoft);
    } else {
        initListSoft();
    }
