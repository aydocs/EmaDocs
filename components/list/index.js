/**
 * List Component - Main Entry Point
...
// Export component
export { default as List } from './list.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('List', {
    name: 'List',
...
console.log('List component loaded with 5 variants');
