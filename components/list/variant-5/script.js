...
(function() {
    ...
    function initListPremium() {
        const components = document.querySelectorAll('.ema-list--premium');
        ...
        console.log(`List premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `List component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`List premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('list:click', {
    ...
    window.handleClick = function() {
        console.log('List premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListPremium);
    } else {
        initListPremium();
    }
