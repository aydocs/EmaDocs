...
A comprehensive DataTable component for Emadocs Framework with 5 beautiful variants.
...
```ema
<DataTable variant="minimal">Minimal</DataTable>
<DataTable variant="neo">Neo</DataTable>
<DataTable variant="soft">Soft</DataTable>
<DataTable variant="glass">Glass</DataTable>
<DataTable variant="premium">Premium</DataTable>
```
...
- `datatable.ema` - Main component definition
