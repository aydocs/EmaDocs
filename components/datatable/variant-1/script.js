/**
 * DataTable Component - minimal Variant
...
(function() {
    ...
    function initDataTableMinimal() {
        const components = document.querySelectorAll('.ema-datatable--minimal');
        ...
        console.log(`DataTable minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `DataTable component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DataTable minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('datatable:click', {
    ...
    window.handleClick = function() {
        console.log('DataTable minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDataTableMinimal);
    } else {
        initDataTableMinimal();
    }
