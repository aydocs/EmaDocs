/**
 * DataTable Component - soft Variant
...
(function() {
    ...
    function initDataTableSoft() {
        const components = document.querySelectorAll('.ema-datatable--soft');
        ...
        console.log(`DataTable soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DataTable soft clicked`);
    ...
    window.handleClick = function() {
        console.log('DataTable soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDataTableSoft);
    } else {
        initDataTableSoft();
    }
