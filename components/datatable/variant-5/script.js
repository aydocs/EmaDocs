/**
 * DataTable Component - premium Variant
...
(function() {
    ...
    function initDataTablePremium() {
        const components = document.querySelectorAll('.ema-datatable--premium');
        ...
        console.log(`DataTable premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DataTable premium clicked`);
    ...
    window.handleClick = function() {
        console.log('DataTable premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDataTablePremium);
    } else {
        initDataTablePremium();
    }
