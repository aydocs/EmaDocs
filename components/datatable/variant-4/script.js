/**
 * DataTable Component - glass Variant
...
(function() {
    ...
    function initDataTableGlass() {
        const components = document.querySelectorAll('.ema-datatable--glass');
        ...
        console.log(`DataTable glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DataTable glass clicked`);
    ...
    window.handleClick = function() {
        console.log('DataTable glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDataTableGlass);
    } else {
        initDataTableGlass();
    }
