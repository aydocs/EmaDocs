/**
 * DataTable Component - neo Variant
...
(function() {
    ...
    function initDataTableNeo() {
        const components = document.querySelectorAll('.ema-datatable--neo');
        ...
        console.log(`DataTable neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`DataTable neo clicked`);
    ...
    window.handleClick = function() {
        console.log('DataTable neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDataTableNeo);
    } else {
        initDataTableNeo();
    }
