/**
 * Avatar Component - minimal Variant
...
(function() {
    ...
    function initAvatarMinimal() {
        const components = document.querySelectorAll('.ema-avatar--minimal');
        ...
        console.log(`Avatar minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Avatar component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Avatar minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('avatar:click', {
    ...
    window.handleClick = function() {
        console.log('Avatar minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAvatarMinimal);
    } else {
        initAvatarMinimal();
    }
