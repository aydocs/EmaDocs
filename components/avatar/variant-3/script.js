...
(function() {
    ...
    function initAvatarSoft() {
        const components = document.querySelectorAll('.ema-avatar--soft');
        ...
        console.log(`Avatar soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Avatar soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Avatar soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAvatarSoft);
    } else {
        initAvatarSoft();
    }
