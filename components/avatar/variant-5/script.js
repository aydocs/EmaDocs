/**
 * Avatar Component - premium Variant
...
(function() {
    ...
    function initAvatarPremium() {
        const components = document.querySelectorAll('.ema-avatar--premium');
        ...
        console.log(`Avatar premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Avatar premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Avatar premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAvatarPremium);
    } else {
        initAvatarPremium();
    }
