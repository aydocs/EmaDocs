...
(function() {
    ...
    function initAvatarNeo() {
        const components = document.querySelectorAll('.ema-avatar--neo');
        ...
        console.log(`Avatar neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Avatar neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Avatar neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAvatarNeo);
    } else {
        initAvatarNeo();
    }
