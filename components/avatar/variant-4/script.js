...
(function() {
    ...
    function initAvatarGlass() {
        const components = document.querySelectorAll('.ema-avatar--glass');
        ...
        console.log(`Avatar glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Avatar glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Avatar glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAvatarGlass);
    } else {
        initAvatarGlass();
    }
