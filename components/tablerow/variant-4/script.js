/**
 * TableRow Component - glass Variant
...
(function() {
    ...
    function initTableRowGlass() {
        const components = document.querySelectorAll('.ema-tablerow--glass');
        ...
        console.log(`TableRow glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableRow glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TableRow glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableRowGlass);
    } else {
        initTableRowGlass();
    }
