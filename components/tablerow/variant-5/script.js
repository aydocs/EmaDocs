/**
 * TableRow Component - premium Variant
...
(function() {
    ...
    function initTableRowPremium() {
        const components = document.querySelectorAll('.ema-tablerow--premium');
        ...
        console.log(`TableRow premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TableRow component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableRow premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tablerow:click', {
    ...
    window.handleClick = function() {
        console.log('TableRow premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableRowPremium);
    } else {
        initTableRowPremium();
    }
