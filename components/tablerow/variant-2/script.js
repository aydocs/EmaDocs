/**
 * TableRow Component - neo Variant
...
(function() {
    ...
    function initTableRowNeo() {
        const components = document.querySelectorAll('.ema-tablerow--neo');
        ...
        console.log(`TableRow neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableRow neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TableRow neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableRowNeo);
    } else {
        initTableRowNeo();
    }
