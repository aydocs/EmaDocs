/**
 * TableRow Component - minimal Variant
...
(function() {
    ...
    function initTableRowMinimal() {
        const components = document.querySelectorAll('.ema-tablerow--minimal');
        ...
        console.log(`TableRow minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableRow minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('TableRow minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableRowMinimal);
    } else {
        initTableRowMinimal();
    }
