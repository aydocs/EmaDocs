/**
 * TableRow Component - soft Variant
...
(function() {
    ...
    function initTableRowSoft() {
        const components = document.querySelectorAll('.ema-tablerow--soft');
        ...
        console.log(`TableRow soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TableRow soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TableRow soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableRowSoft);
    } else {
        initTableRowSoft();
    }
