...
A comprehensive Reset component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Reset variant="minimal">Minimal</Reset>
<Reset variant="neo">Neo</Reset>
<Reset variant="soft">Soft</Reset>
<Reset variant="glass">Glass</Reset>
<Reset variant="premium">Premium</Reset>
```
...
- `reset.ema` - Main component definition
