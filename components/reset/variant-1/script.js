/**
 * Reset Component - minimal Variant
...
(function() {
    ...
    function initResetMinimal() {
        const components = document.querySelectorAll('.ema-reset--minimal');
        ...
        console.log(`Reset minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reset minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Reset minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResetMinimal);
    } else {
        initResetMinimal();
    }
