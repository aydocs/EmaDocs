/**
 * Reset Component - premium Variant
...
(function() {
    ...
    function initResetPremium() {
        const components = document.querySelectorAll('.ema-reset--premium');
        ...
        console.log(`Reset premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Reset component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reset premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('reset:click', {
    ...
    window.handleClick = function() {
        console.log('Reset premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResetPremium);
    } else {
        initResetPremium();
    }
