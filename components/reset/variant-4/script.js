...
(function() {
    ...
    function initResetGlass() {
        const components = document.querySelectorAll('.ema-reset--glass');
        ...
        console.log(`Reset glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reset glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Reset glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResetGlass);
    } else {
        initResetGlass();
    }
