...
(function() {
    ...
    function initResetNeo() {
        const components = document.querySelectorAll('.ema-reset--neo');
        ...
        console.log(`Reset neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Reset neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResetNeo);
    } else {
        initResetNeo();
    }
