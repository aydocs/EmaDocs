...
(function() {
    ...
    function initResetSoft() {
        const components = document.querySelectorAll('.ema-reset--soft');
        ...
        console.log(`Reset soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Reset soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Reset soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResetSoft);
    } else {
        initResetSoft();
    }
