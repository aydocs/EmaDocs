/**
 * Submenu Component - minimal Variant
...
(function() {
    ...
    function initSubmenuMinimal() {
        const components = document.querySelectorAll('.ema-submenu--minimal');
        ...
        console.log(`Submenu minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Submenu component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Submenu minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('submenu:click', {
    ...
    window.handleClick = function() {
        console.log('Submenu minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSubmenuMinimal);
    } else {
        initSubmenuMinimal();
    }
