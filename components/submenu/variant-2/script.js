...
(function() {
    ...
    function initSubmenuNeo() {
        const components = document.querySelectorAll('.ema-submenu--neo');
        ...
        console.log(`Submenu neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Submenu neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Submenu neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSubmenuNeo);
    } else {
        initSubmenuNeo();
    }
