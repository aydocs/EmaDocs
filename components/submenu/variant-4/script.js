/**
 * Submenu Component - glass Variant
...
(function() {
    ...
    function initSubmenuGlass() {
        const components = document.querySelectorAll('.ema-submenu--glass');
        ...
        console.log(`Submenu glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Submenu glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Submenu glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSubmenuGlass);
    } else {
        initSubmenuGlass();
    }
