/**
 * Submenu Component - premium Variant
...
(function() {
    ...
    function initSubmenuPremium() {
        const components = document.querySelectorAll('.ema-submenu--premium');
        ...
        console.log(`Submenu premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Submenu premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Submenu premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSubmenuPremium);
    } else {
        initSubmenuPremium();
    }
