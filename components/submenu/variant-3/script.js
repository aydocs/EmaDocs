/**
 * Submenu Component - soft Variant
...
(function() {
    ...
    function initSubmenuSoft() {
        const components = document.querySelectorAll('.ema-submenu--soft');
        ...
        console.log(`Submenu soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Submenu soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Submenu soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSubmenuSoft);
    } else {
        initSubmenuSoft();
    }
