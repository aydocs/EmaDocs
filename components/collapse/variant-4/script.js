/**
 * Collapse Component - glass Variant
...
(function() {
    ...
    function initCollapseGlass() {
        const components = document.querySelectorAll('.ema-collapse--glass');
        ...
        console.log(`Collapse glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Collapse glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Collapse glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCollapseGlass);
    } else {
        initCollapseGlass();
    }
