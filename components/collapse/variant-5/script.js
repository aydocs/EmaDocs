/**
 * Collapse Component - premium Variant
...
(function() {
    ...
    function initCollapsePremium() {
        const components = document.querySelectorAll('.ema-collapse--premium');
        ...
        console.log(`Collapse premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Collapse premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Collapse premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCollapsePremium);
    } else {
        initCollapsePremium();
    }
