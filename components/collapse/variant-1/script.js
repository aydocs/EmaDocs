/**
 * Collapse Component - minimal Variant
...
(function() {
    ...
    function initCollapseMinimal() {
        const components = document.querySelectorAll('.ema-collapse--minimal');
        ...
        console.log(`Collapse minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Collapse component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Collapse minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('collapse:click', {
    ...
    window.handleClick = function() {
        console.log('Collapse minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCollapseMinimal);
    } else {
        initCollapseMinimal();
    }
