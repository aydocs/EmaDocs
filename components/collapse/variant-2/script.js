/**
 * Collapse Component - neo Variant
...
(function() {
    ...
    function initCollapseNeo() {
        const components = document.querySelectorAll('.ema-collapse--neo');
        ...
        console.log(`Collapse neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Collapse neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Collapse neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCollapseNeo);
    } else {
        initCollapseNeo();
    }
