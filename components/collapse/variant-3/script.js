/**
 * Collapse Component - soft Variant
...
(function() {
    ...
    function initCollapseSoft() {
        const components = document.querySelectorAll('.ema-collapse--soft');
        ...
        console.log(`Collapse soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Collapse soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Collapse soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCollapseSoft);
    } else {
        initCollapseSoft();
    }
