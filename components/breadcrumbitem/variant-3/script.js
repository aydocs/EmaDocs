/**
 * BreadcrumbItem Component - soft Variant
...
(function() {
    ...
    function initBreadcrumbItemSoft() {
        const components = document.querySelectorAll('.ema-breadcrumbitem--soft');
        ...
        console.log(`BreadcrumbItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`BreadcrumbItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('BreadcrumbItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbItemSoft);
    } else {
        initBreadcrumbItemSoft();
    }
