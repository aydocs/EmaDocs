/**
 * BreadcrumbItem Component - premium Variant
...
(function() {
    ...
    function initBreadcrumbItemPremium() {
        const components = document.querySelectorAll('.ema-breadcrumbitem--premium');
        ...
        console.log(`BreadcrumbItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`BreadcrumbItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('BreadcrumbItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbItemPremium);
    } else {
        initBreadcrumbItemPremium();
    }
