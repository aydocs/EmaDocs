/**
 * BreadcrumbItem Component - neo Variant
...
(function() {
    ...
    function initBreadcrumbItemNeo() {
        const components = document.querySelectorAll('.ema-breadcrumbitem--neo');
        ...
        console.log(`BreadcrumbItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`BreadcrumbItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('BreadcrumbItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbItemNeo);
    } else {
        initBreadcrumbItemNeo();
    }
