/**
 * BreadcrumbItem Component - minimal Variant
...
(function() {
    ...
    function initBreadcrumbItemMinimal() {
        const components = document.querySelectorAll('.ema-breadcrumbitem--minimal');
        ...
        console.log(`BreadcrumbItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `BreadcrumbItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`BreadcrumbItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('breadcrumbitem:click', {
    ...
    window.handleClick = function() {
        console.log('BreadcrumbItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbItemMinimal);
    } else {
        initBreadcrumbItemMinimal();
    }
