/**
 * BreadcrumbItem Component - glass Variant
...
(function() {
    ...
    function initBreadcrumbItemGlass() {
        const components = document.querySelectorAll('.ema-breadcrumbitem--glass');
        ...
        console.log(`BreadcrumbItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`BreadcrumbItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('BreadcrumbItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreadcrumbItemGlass);
    } else {
        initBreadcrumbItemGlass();
    }
