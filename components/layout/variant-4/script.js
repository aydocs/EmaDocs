/**
 * Layout Component - glass Variant
...
(function() {
    ...
    function initLayoutGlass() {
        const components = document.querySelectorAll('.ema-layout--glass');
        ...
        console.log(`Layout glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Layout glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Layout glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLayoutGlass);
    } else {
        initLayoutGlass();
    }
