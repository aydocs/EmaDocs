...
(function() {
    ...
    function initLayoutNeo() {
        const components = document.querySelectorAll('.ema-layout--neo');
        ...
        console.log(`Layout neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Layout neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Layout neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLayoutNeo);
    } else {
        initLayoutNeo();
    }
