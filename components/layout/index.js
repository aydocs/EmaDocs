/**
 * Layout Component - Main Entry Point
...
// Export component
export { default as Layout } from './layout.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Layout', {
    name: 'Layout',
...
console.log('Layout component loaded with 5 variants');
