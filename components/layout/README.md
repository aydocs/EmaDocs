...
A comprehensive Layout component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Layout variant="minimal">Minimal</Layout>
<Layout variant="neo">Neo</Layout>
<Layout variant="soft">Soft</Layout>
<Layout variant="glass">Glass</Layout>
<Layout variant="premium">Premium</Layout>
```
...
- `layout.ema` - Main component definition
