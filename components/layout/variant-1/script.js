/**
 * Layout Component - minimal Variant
...
(function() {
    ...
    function initLayoutMinimal() {
        const components = document.querySelectorAll('.ema-layout--minimal');
        ...
        console.log(`Layout minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Layout component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Layout minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('layout:click', {
    ...
    window.handleClick = function() {
        console.log('Layout minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLayoutMinimal);
    } else {
        initLayoutMinimal();
    }
