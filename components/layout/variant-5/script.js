/**
 * Layout Component - premium Variant
...
(function() {
    ...
    function initLayoutPremium() {
        const components = document.querySelectorAll('.ema-layout--premium');
        ...
        console.log(`Layout premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Layout premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Layout premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLayoutPremium);
    } else {
        initLayoutPremium();
    }
