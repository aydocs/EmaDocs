...
(function() {
    ...
    function initLayoutSoft() {
        const components = document.querySelectorAll('.ema-layout--soft');
        ...
        console.log(`Layout soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Layout soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Layout soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLayoutSoft);
    } else {
        initLayoutSoft();
    }
