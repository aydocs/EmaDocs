/**
 * Spacer Component - premium Variant
...
(function() {
    ...
    function initSpacerPremium() {
        const components = document.querySelectorAll('.ema-spacer--premium');
        ...
        console.log(`Spacer premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Spacer component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spacer premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('spacer:click', {
    ...
    window.handleClick = function() {
        console.log('Spacer premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpacerPremium);
    } else {
        initSpacerPremium();
    }
