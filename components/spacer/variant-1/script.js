/**
 * Spacer Component - minimal Variant
...
(function() {
    ...
    function initSpacerMinimal() {
        const components = document.querySelectorAll('.ema-spacer--minimal');
        ...
        console.log(`Spacer minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spacer minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Spacer minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpacerMinimal);
    } else {
        initSpacerMinimal();
    }
