...
(function() {
    ...
    function initSpacerNeo() {
        const components = document.querySelectorAll('.ema-spacer--neo');
        ...
        console.log(`Spacer neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spacer neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Spacer neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpacerNeo);
    } else {
        initSpacerNeo();
    }
