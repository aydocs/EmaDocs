...
A comprehensive Spacer component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Spacer variant="minimal">Minimal</Spacer>
<Spacer variant="neo">Neo</Spacer>
<Spacer variant="soft">Soft</Spacer>
<Spacer variant="glass">Glass</Spacer>
<Spacer variant="premium">Premium</Spacer>
```
...
- `spacer.ema` - Main component definition
