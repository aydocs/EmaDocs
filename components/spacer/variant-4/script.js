/**
 * Spacer Component - glass Variant
...
(function() {
    ...
    function initSpacerGlass() {
        const components = document.querySelectorAll('.ema-spacer--glass');
        ...
        console.log(`Spacer glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spacer glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Spacer glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpacerGlass);
    } else {
        initSpacerGlass();
    }
