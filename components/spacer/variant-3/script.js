...
(function() {
    ...
    function initSpacerSoft() {
        const components = document.querySelectorAll('.ema-spacer--soft');
        ...
        console.log(`Spacer soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Spacer soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Spacer soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSpacerSoft);
    } else {
        initSpacerSoft();
    }
