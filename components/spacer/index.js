/**
 * Spacer Component - Main Entry Point
...
// Export component
export { default as Spacer } from './spacer.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Spacer', {
    name: 'Spacer',
...
console.log('Spacer component loaded with 5 variants');
