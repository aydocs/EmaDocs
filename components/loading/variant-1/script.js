/**
 * Loading Component - minimal Variant
...
(function() {
    ...
    function initLoadingMinimal() {
        const components = document.querySelectorAll('.ema-loading--minimal');
        ...
        console.log(`Loading minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Loading minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Loading minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLoadingMinimal);
    } else {
        initLoadingMinimal();
    }
