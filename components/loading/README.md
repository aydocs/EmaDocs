...
A comprehensive Loading component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Loading variant="minimal">Minimal</Loading>
<Loading variant="neo">Neo</Loading>
<Loading variant="soft">Soft</Loading>
<Loading variant="glass">Glass</Loading>
<Loading variant="premium">Premium</Loading>
```
...
- `loading.ema` - Main component definition
