/**
 * Loading Component - premium Variant
...
(function() {
    ...
    function initLoadingPremium() {
        const components = document.querySelectorAll('.ema-loading--premium');
        ...
        console.log(`Loading premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Loading component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Loading premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('loading:click', {
    ...
    window.handleClick = function() {
        console.log('Loading premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLoadingPremium);
    } else {
        initLoadingPremium();
    }
