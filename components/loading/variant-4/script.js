/**
 * Loading Component - glass Variant
...
(function() {
    ...
    function initLoadingGlass() {
        const components = document.querySelectorAll('.ema-loading--glass');
        ...
        console.log(`Loading glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Loading glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Loading glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLoadingGlass);
    } else {
        initLoadingGlass();
    }
