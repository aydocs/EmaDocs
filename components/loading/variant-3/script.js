/**
 * Loading Component - soft Variant
...
(function() {
    ...
    function initLoadingSoft() {
        const components = document.querySelectorAll('.ema-loading--soft');
        ...
        console.log(`Loading soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Loading soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Loading soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLoadingSoft);
    } else {
        initLoadingSoft();
    }
