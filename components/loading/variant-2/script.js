...
(function() {
    ...
    function initLoadingNeo() {
        const components = document.querySelectorAll('.ema-loading--neo');
        ...
        console.log(`Loading neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Loading neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Loading neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLoadingNeo);
    } else {
        initLoadingNeo();
    }
