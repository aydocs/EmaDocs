/**
 * Loading Component - Main Entry Point
...
// Export component
export { default as Loading } from './loading.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Loading', {
    name: 'Loading',
...
console.log('Loading component loaded with 5 variants');
