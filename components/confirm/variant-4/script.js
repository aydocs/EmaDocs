/**
 * Confirm Component - glass Variant
...
(function() {
    ...
    function initConfirmGlass() {
        const components = document.querySelectorAll('.ema-confirm--glass');
        ...
        console.log(`Confirm glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Confirm glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Confirm glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initConfirmGlass);
    } else {
        initConfirmGlass();
    }
