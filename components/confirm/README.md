...
A comprehensive Confirm component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Confirm variant="minimal">Minimal</Confirm>
<Confirm variant="neo">Neo</Confirm>
<Confirm variant="soft">Soft</Confirm>
<Confirm variant="glass">Glass</Confirm>
<Confirm variant="premium">Premium</Confirm>
```
...
- `confirm.ema` - Main component definition
