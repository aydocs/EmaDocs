/**
 * Confirm Component - soft Variant
...
(function() {
    ...
    function initConfirmSoft() {
        const components = document.querySelectorAll('.ema-confirm--soft');
        ...
        console.log(`Confirm soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Confirm soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Confirm soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initConfirmSoft);
    } else {
        initConfirmSoft();
    }
