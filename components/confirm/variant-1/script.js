/**
 * Confirm Component - minimal Variant
...
(function() {
    ...
    function initConfirmMinimal() {
        const components = document.querySelectorAll('.ema-confirm--minimal');
        ...
        console.log(`Confirm minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Confirm component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Confirm minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('confirm:click', {
    ...
    window.handleClick = function() {
        console.log('Confirm minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initConfirmMinimal);
    } else {
        initConfirmMinimal();
    }
