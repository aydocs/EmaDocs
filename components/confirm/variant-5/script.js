/**
 * Confirm Component - premium Variant
...
(function() {
    ...
    function initConfirmPremium() {
        const components = document.querySelectorAll('.ema-confirm--premium');
        ...
        console.log(`Confirm premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Confirm premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Confirm premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initConfirmPremium);
    } else {
        initConfirmPremium();
    }
