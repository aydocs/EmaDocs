...
(function() {
    ...
    function initConfirmNeo() {
        const components = document.querySelectorAll('.ema-confirm--neo');
        ...
        console.log(`Confirm neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Confirm neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Confirm neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initConfirmNeo);
    } else {
        initConfirmNeo();
    }
