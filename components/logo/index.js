/**
 * Logo Component - Main Entry Point
...
// Export component
export { default as Logo } from './logo.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Logo', {
    name: 'Logo',
...
console.log('Logo component loaded with 5 variants');
