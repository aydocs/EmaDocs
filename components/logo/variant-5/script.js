/**
 * Logo Component - premium Variant
...
(function() {
    ...
    function initLogoPremium() {
        const components = document.querySelectorAll('.ema-logo--premium');
        ...
        console.log(`Logo premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Logo component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Logo premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('logo:click', {
    ...
    window.handleClick = function() {
        console.log('Logo premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLogoPremium);
    } else {
        initLogoPremium();
    }
