...
(function() {
    ...
    function initLogoNeo() {
        const components = document.querySelectorAll('.ema-logo--neo');
        ...
        console.log(`Logo neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Logo neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLogoNeo);
    } else {
        initLogoNeo();
    }
