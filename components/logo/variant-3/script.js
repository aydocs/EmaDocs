...
(function() {
    ...
    function initLogoSoft() {
        const components = document.querySelectorAll('.ema-logo--soft');
        ...
        console.log(`Logo soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Logo soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLogoSoft);
    } else {
        initLogoSoft();
    }
