/**
 * Logo Component - minimal Variant
...
(function() {
    ...
    function initLogoMinimal() {
        const components = document.querySelectorAll('.ema-logo--minimal');
        ...
        console.log(`Logo minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Logo minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Logo minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLogoMinimal);
    } else {
        initLogoMinimal();
    }
