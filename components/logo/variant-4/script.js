...
(function() {
    ...
    function initLogoGlass() {
        const components = document.querySelectorAll('.ema-logo--glass');
        ...
        console.log(`Logo glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Logo glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Logo glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLogoGlass);
    } else {
        initLogoGlass();
    }
