...
A comprehensive Logo component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Logo variant="minimal">Minimal</Logo>
<Logo variant="neo">Neo</Logo>
<Logo variant="soft">Soft</Logo>
<Logo variant="glass">Glass</Logo>
<Logo variant="premium">Premium</Logo>
```
...
- `logo.ema` - Main component definition
