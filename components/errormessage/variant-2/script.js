/**
 * ErrorMessage Component - neo Variant
...
(function() {
    ...
    function initErrorMessageNeo() {
        const components = document.querySelectorAll('.ema-errormessage--neo');
        ...
        console.log(`ErrorMessage neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ErrorMessage neo clicked`);
    ...
    window.handleClick = function() {
        console.log('ErrorMessage neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMessageNeo);
    } else {
        initErrorMessageNeo();
    }
