/**
 * ErrorMessage Component - premium Variant
...
(function() {
    ...
    function initErrorMessagePremium() {
        const components = document.querySelectorAll('.ema-errormessage--premium');
        ...
        console.log(`ErrorMessage premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `ErrorMessage component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ErrorMessage premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('errormessage:click', {
    ...
    window.handleClick = function() {
        console.log('ErrorMessage premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMessagePremium);
    } else {
        initErrorMessagePremium();
    }
