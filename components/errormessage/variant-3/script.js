/**
 * ErrorMessage Component - soft Variant
...
(function() {
    ...
    function initErrorMessageSoft() {
        const components = document.querySelectorAll('.ema-errormessage--soft');
        ...
        console.log(`ErrorMessage soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ErrorMessage soft clicked`);
    ...
    window.handleClick = function() {
        console.log('ErrorMessage soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMessageSoft);
    } else {
        initErrorMessageSoft();
    }
