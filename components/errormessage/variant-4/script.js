/**
 * ErrorMessage Component - glass Variant
...
(function() {
    ...
    function initErrorMessageGlass() {
        const components = document.querySelectorAll('.ema-errormessage--glass');
        ...
        console.log(`ErrorMessage glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ErrorMessage glass clicked`);
    ...
    window.handleClick = function() {
        console.log('ErrorMessage glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMessageGlass);
    } else {
        initErrorMessageGlass();
    }
