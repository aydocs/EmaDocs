/**
 * ErrorMessage Component - minimal Variant
...
(function() {
    ...
    function initErrorMessageMinimal() {
        const components = document.querySelectorAll('.ema-errormessage--minimal');
        ...
        console.log(`ErrorMessage minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ErrorMessage minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('ErrorMessage minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMessageMinimal);
    } else {
        initErrorMessageMinimal();
    }
