...
A comprehensive Progress component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Progress variant="minimal">Minimal</Progress>
<Progress variant="neo">Neo</Progress>
<Progress variant="soft">Soft</Progress>
<Progress variant="glass">Glass</Progress>
<Progress variant="premium">Premium</Progress>
```
...
- `progress.ema` - Main component definition
