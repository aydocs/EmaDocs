/**
 * Progress Component - neo Variant
...
(function() {
    ...
    function initProgressNeo() {
        const components = document.querySelectorAll('.ema-progress--neo');
        ...
        console.log(`Progress neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Progress neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Progress neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initProgressNeo);
    } else {
        initProgressNeo();
    }
