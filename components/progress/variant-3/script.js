/**
 * Progress Component - soft Variant
...
(function() {
    ...
    function initProgressSoft() {
        const components = document.querySelectorAll('.ema-progress--soft');
        ...
        console.log(`Progress soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Progress soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Progress soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initProgressSoft);
    } else {
        initProgressSoft();
    }
