/**
 * Progress Component - minimal Variant
...
(function() {
    ...
    function initProgressMinimal() {
        const components = document.querySelectorAll('.ema-progress--minimal');
        ...
        console.log(`Progress minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Progress minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Progress minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initProgressMinimal);
    } else {
        initProgressMinimal();
    }
