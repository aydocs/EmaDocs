/**
 * ColorPicker Component - glass Variant
...
(function() {
    ...
    function initColorPickerGlass() {
        const components = document.querySelectorAll('.ema-colorpicker--glass');
        ...
        console.log(`ColorPicker glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ColorPicker glass clicked`);
    ...
    window.handleClick = function() {
        console.log('ColorPicker glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColorPickerGlass);
    } else {
        initColorPickerGlass();
    }
