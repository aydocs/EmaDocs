/**
 * ColorPicker Component - premium Variant
...
(function() {
    ...
    function initColorPickerPremium() {
        const components = document.querySelectorAll('.ema-colorpicker--premium');
        ...
        console.log(`ColorPicker premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ColorPicker premium clicked`);
    ...
    window.handleClick = function() {
        console.log('ColorPicker premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColorPickerPremium);
    } else {
        initColorPickerPremium();
    }
