/**
 * ColorPicker Component - soft Variant
...
(function() {
    ...
    function initColorPickerSoft() {
        const components = document.querySelectorAll('.ema-colorpicker--soft');
        ...
        console.log(`ColorPicker soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ColorPicker soft clicked`);
    ...
    window.handleClick = function() {
        console.log('ColorPicker soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColorPickerSoft);
    } else {
        initColorPickerSoft();
    }
