/**
 * ColorPicker Component - minimal Variant
...
(function() {
    ...
    function initColorPickerMinimal() {
        const components = document.querySelectorAll('.ema-colorpicker--minimal');
        ...
        console.log(`ColorPicker minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `ColorPicker component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ColorPicker minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('colorpicker:click', {
    ...
    window.handleClick = function() {
        console.log('ColorPicker minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColorPickerMinimal);
    } else {
        initColorPickerMinimal();
    }
