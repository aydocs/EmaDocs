/**
 * ColorPicker Component - neo Variant
...
(function() {
    ...
    function initColorPickerNeo() {
        const components = document.querySelectorAll('.ema-colorpicker--neo');
        ...
        console.log(`ColorPicker neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ColorPicker neo clicked`);
    ...
    window.handleClick = function() {
        console.log('ColorPicker neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColorPickerNeo);
    } else {
        initColorPickerNeo();
    }
