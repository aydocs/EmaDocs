/**
 * Form Component - Main Entry Point
...
// Export component
export { default as Form } from './form.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Form', {
    name: 'Form',
...
console.log('Form component loaded with 5 variants');
