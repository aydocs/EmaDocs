/**
 * Form Component - premium Variant
...
(function() {
    ...
    function initFormPremium() {
        const components = document.querySelectorAll('.ema-form--premium');
        ...
        console.log(`Form premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Form premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Form premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFormPremium);
    } else {
        initFormPremium();
    }
