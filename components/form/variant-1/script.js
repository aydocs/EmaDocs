/**
 * Form Component - minimal Variant
...
(function() {
    ...
    function initFormMinimal() {
        const components = document.querySelectorAll('.ema-form--minimal');
        ...
        console.log(`Form minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Form component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Form minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('form:click', {
    ...
    window.handleClick = function() {
        console.log('Form minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFormMinimal);
    } else {
        initFormMinimal();
    }
