...
(function() {
    ...
    function initFormSoft() {
        const components = document.querySelectorAll('.ema-form--soft');
        ...
        console.log(`Form soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Form soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFormSoft);
    } else {
        initFormSoft();
    }
