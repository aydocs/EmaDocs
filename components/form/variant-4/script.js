...
(function() {
    ...
    function initFormGlass() {
        const components = document.querySelectorAll('.ema-form--glass');
        ...
        console.log(`Form glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Form glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Form glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFormGlass);
    } else {
        initFormGlass();
    }
