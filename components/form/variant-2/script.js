...
(function() {
    ...
    function initFormNeo() {
        const components = document.querySelectorAll('.ema-form--neo');
        ...
        console.log(`Form neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Form neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFormNeo);
    } else {
        initFormNeo();
    }
