/**
 * Hide Component - premium Variant
...
(function() {
    ...
    function initHidePremium() {
        const components = document.querySelectorAll('.ema-hide--premium');
        ...
        console.log(`Hide premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Hide component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hide premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('hide:click', {
    ...
    window.handleClick = function() {
        console.log('Hide premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHidePremium);
    } else {
        initHidePremium();
    }
