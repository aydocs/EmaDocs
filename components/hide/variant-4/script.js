...
(function() {
    ...
    function initHideGlass() {
        const components = document.querySelectorAll('.ema-hide--glass');
        ...
        console.log(`Hide glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hide glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Hide glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHideGlass);
    } else {
        initHideGlass();
    }
