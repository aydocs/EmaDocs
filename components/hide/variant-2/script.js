...
(function() {
    ...
    function initHideNeo() {
        const components = document.querySelectorAll('.ema-hide--neo');
        ...
        console.log(`Hide neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Hide neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHideNeo);
    } else {
        initHideNeo();
    }
