/**
 * Hide Component - minimal Variant
...
(function() {
    ...
    function initHideMinimal() {
        const components = document.querySelectorAll('.ema-hide--minimal');
        ...
        console.log(`Hide minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hide minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Hide minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHideMinimal);
    } else {
        initHideMinimal();
    }
