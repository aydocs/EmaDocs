...
(function() {
    ...
    function initHideSoft() {
        const components = document.querySelectorAll('.ema-hide--soft');
        ...
        console.log(`Hide soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Hide soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHideSoft);
    } else {
        initHideSoft();
    }
