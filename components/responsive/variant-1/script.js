/**
 * Responsive Component - minimal Variant
...
(function() {
    ...
    function initResponsiveMinimal() {
        const components = document.querySelectorAll('.ema-responsive--minimal');
        ...
        console.log(`Responsive minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Responsive component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Responsive minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('responsive:click', {
    ...
    window.handleClick = function() {
        console.log('Responsive minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResponsiveMinimal);
    } else {
        initResponsiveMinimal();
    }
