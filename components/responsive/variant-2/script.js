/**
 * Responsive Component - neo Variant
...
(function() {
    ...
    function initResponsiveNeo() {
        const components = document.querySelectorAll('.ema-responsive--neo');
        ...
        console.log(`Responsive neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Responsive neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Responsive neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResponsiveNeo);
    } else {
        initResponsiveNeo();
    }
