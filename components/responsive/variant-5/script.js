/**
 * Responsive Component - premium Variant
...
(function() {
    ...
    function initResponsivePremium() {
        const components = document.querySelectorAll('.ema-responsive--premium');
        ...
        console.log(`Responsive premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Responsive premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Responsive premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResponsivePremium);
    } else {
        initResponsivePremium();
    }
