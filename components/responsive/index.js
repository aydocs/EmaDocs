/**
 * Responsive Component - Main Entry Point
...
// Export component
export { default as Responsive } from './responsive.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Responsive', {
    name: 'Responsive',
...
console.log('Responsive component loaded with 5 variants');
