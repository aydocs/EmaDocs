...
(function() {
    ...
    function initResponsiveGlass() {
        const components = document.querySelectorAll('.ema-responsive--glass');
        ...
        console.log(`Responsive glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Responsive glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Responsive glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResponsiveGlass);
    } else {
        initResponsiveGlass();
    }
