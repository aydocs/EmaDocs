/**
 * Responsive Component - soft Variant
...
(function() {
    ...
    function initResponsiveSoft() {
        const components = document.querySelectorAll('.ema-responsive--soft');
        ...
        console.log(`Responsive soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Responsive soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Responsive soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initResponsiveSoft);
    } else {
        initResponsiveSoft();
    }
