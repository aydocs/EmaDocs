/**
 * Sort Component - premium Variant
...
(function() {
    ...
    function initSortPremium() {
        const components = document.querySelectorAll('.ema-sort--premium');
        ...
        console.log(`Sort premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sort premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Sort premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortPremium);
    } else {
        initSortPremium();
    }
