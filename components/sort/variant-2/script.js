...
(function() {
    ...
    function initSortNeo() {
        const components = document.querySelectorAll('.ema-sort--neo');
        ...
        console.log(`Sort neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Sort neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortNeo);
    } else {
        initSortNeo();
    }
