/**
 * Sort Component - minimal Variant
...
(function() {
    ...
    function initSortMinimal() {
        const components = document.querySelectorAll('.ema-sort--minimal');
        ...
        console.log(`Sort minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Sort component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sort minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('sort:click', {
    ...
    window.handleClick = function() {
        console.log('Sort minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortMinimal);
    } else {
        initSortMinimal();
    }
