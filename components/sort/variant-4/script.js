...
(function() {
    ...
    function initSortGlass() {
        const components = document.querySelectorAll('.ema-sort--glass');
        ...
        console.log(`Sort glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sort glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Sort glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortGlass);
    } else {
        initSortGlass();
    }
