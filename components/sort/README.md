...
A comprehensive Sort component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Sort variant="minimal">Minimal</Sort>
<Sort variant="neo">Neo</Sort>
<Sort variant="soft">Soft</Sort>
<Sort variant="glass">Glass</Sort>
<Sort variant="premium">Premium</Sort>
```
...
- `sort.ema` - Main component definition
