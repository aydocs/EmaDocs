...
(function() {
    ...
    function initSortSoft() {
        const components = document.querySelectorAll('.ema-sort--soft');
        ...
        console.log(`Sort soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Sort soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortSoft);
    } else {
        initSortSoft();
    }
