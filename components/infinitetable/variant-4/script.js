/**
 * InfiniteTable Component - glass Variant
...
(function() {
    ...
    function initInfiniteTableGlass() {
        const components = document.querySelectorAll('.ema-infinitetable--glass');
        ...
        console.log(`InfiniteTable glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteTable glass clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteTable glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteTableGlass);
    } else {
        initInfiniteTableGlass();
    }
