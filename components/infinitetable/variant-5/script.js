/**
 * InfiniteTable Component - premium Variant
...
(function() {
    ...
    function initInfiniteTablePremium() {
        const components = document.querySelectorAll('.ema-infinitetable--premium');
        ...
        console.log(`InfiniteTable premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `InfiniteTable component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteTable premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('infinitetable:click', {
    ...
    window.handleClick = function() {
        console.log('InfiniteTable premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteTablePremium);
    } else {
        initInfiniteTablePremium();
    }
