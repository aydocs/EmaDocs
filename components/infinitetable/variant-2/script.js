/**
 * InfiniteTable Component - neo Variant
...
(function() {
    ...
    function initInfiniteTableNeo() {
        const components = document.querySelectorAll('.ema-infinitetable--neo');
        ...
        console.log(`InfiniteTable neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteTable neo clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteTable neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteTableNeo);
    } else {
        initInfiniteTableNeo();
    }
