/**
 * InfiniteTable Component - minimal Variant
...
(function() {
    ...
    function initInfiniteTableMinimal() {
        const components = document.querySelectorAll('.ema-infinitetable--minimal');
        ...
        console.log(`InfiniteTable minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteTable minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteTable minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteTableMinimal);
    } else {
        initInfiniteTableMinimal();
    }
