/**
 * InfiniteTable Component - soft Variant
...
(function() {
    ...
    function initInfiniteTableSoft() {
        const components = document.querySelectorAll('.ema-infinitetable--soft');
        ...
        console.log(`InfiniteTable soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteTable soft clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteTable soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteTableSoft);
    } else {
        initInfiniteTableSoft();
    }
