/**
 * MultiSelect Component - minimal Variant
...
(function() {
    ...
    function initMultiSelectMinimal() {
        const components = document.querySelectorAll('.ema-multiselect--minimal');
        ...
        console.log(`MultiSelect minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MultiSelect minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('MultiSelect minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMultiSelectMinimal);
    } else {
        initMultiSelectMinimal();
    }
