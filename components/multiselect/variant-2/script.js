/**
 * MultiSelect Component - neo Variant
...
(function() {
    ...
    function initMultiSelectNeo() {
        const components = document.querySelectorAll('.ema-multiselect--neo');
        ...
        console.log(`MultiSelect neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MultiSelect neo clicked`);
    ...
    window.handleClick = function() {
        console.log('MultiSelect neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMultiSelectNeo);
    } else {
        initMultiSelectNeo();
    }
