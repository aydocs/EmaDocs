/**
 * MultiSelect Component - glass Variant
...
(function() {
    ...
    function initMultiSelectGlass() {
        const components = document.querySelectorAll('.ema-multiselect--glass');
        ...
        console.log(`MultiSelect glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MultiSelect glass clicked`);
    ...
    window.handleClick = function() {
        console.log('MultiSelect glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMultiSelectGlass);
    } else {
        initMultiSelectGlass();
    }
