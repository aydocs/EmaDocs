/**
 * MultiSelect Component - premium Variant
...
(function() {
    ...
    function initMultiSelectPremium() {
        const components = document.querySelectorAll('.ema-multiselect--premium');
        ...
        console.log(`MultiSelect premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `MultiSelect component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MultiSelect premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('multiselect:click', {
    ...
    window.handleClick = function() {
        console.log('MultiSelect premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMultiSelectPremium);
    } else {
        initMultiSelectPremium();
    }
