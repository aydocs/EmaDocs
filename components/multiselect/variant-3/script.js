/**
 * MultiSelect Component - soft Variant
...
(function() {
    ...
    function initMultiSelectSoft() {
        const components = document.querySelectorAll('.ema-multiselect--soft');
        ...
        console.log(`MultiSelect soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`MultiSelect soft clicked`);
    ...
    window.handleClick = function() {
        console.log('MultiSelect soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMultiSelectSoft);
    } else {
        initMultiSelectSoft();
    }
