...
(function() {
    ...
    function initTabItemNeo() {
        const components = document.querySelectorAll('.ema-tabitem--neo');
        ...
        console.log(`TabItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TabItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TabItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabItemNeo);
    } else {
        initTabItemNeo();
    }
