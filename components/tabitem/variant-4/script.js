/**
 * TabItem Component - glass Variant
...
(function() {
    ...
    function initTabItemGlass() {
        const components = document.querySelectorAll('.ema-tabitem--glass');
        ...
        console.log(`TabItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TabItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TabItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabItemGlass);
    } else {
        initTabItemGlass();
    }
