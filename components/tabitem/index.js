/**
 * TabItem Component - Main Entry Point
...
// Export component
export { default as TabItem } from './tabitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('TabItem', {
    name: 'TabItem',
...
console.log('TabItem component loaded with 5 variants');
