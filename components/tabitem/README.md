...
A comprehensive TabItem component for Emadocs Framework with 5 beautiful variants.
...
```ema
<TabItem variant="minimal">Minimal</TabItem>
<TabItem variant="neo">Neo</TabItem>
<TabItem variant="soft">Soft</TabItem>
<TabItem variant="glass">Glass</TabItem>
<TabItem variant="premium">Premium</TabItem>
```
...
- `tabitem.ema` - Main component definition
