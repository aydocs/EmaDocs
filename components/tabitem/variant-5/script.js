/**
 * TabItem Component - premium Variant
...
(function() {
    ...
    function initTabItemPremium() {
        const components = document.querySelectorAll('.ema-tabitem--premium');
        ...
        console.log(`TabItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TabItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TabItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabItemPremium);
    } else {
        initTabItemPremium();
    }
