/**
 * TabItem Component - soft Variant
...
(function() {
    ...
    function initTabItemSoft() {
        const components = document.querySelectorAll('.ema-tabitem--soft');
        ...
        console.log(`TabItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TabItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TabItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabItemSoft);
    } else {
        initTabItemSoft();
    }
