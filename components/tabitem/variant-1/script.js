/**
 * TabItem Component - minimal Variant
...
(function() {
    ...
    function initTabItemMinimal() {
        const components = document.querySelectorAll('.ema-tabitem--minimal');
        ...
        console.log(`TabItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TabItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TabItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('tabitem:click', {
    ...
    window.handleClick = function() {
        console.log('TabItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTabItemMinimal);
    } else {
        initTabItemMinimal();
    }
