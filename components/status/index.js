/**
 * Status Component - Main Entry Point
...
// Export component
export { default as Status } from './status.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Status', {
    name: 'Status',
...
console.log('Status component loaded with 5 variants');
