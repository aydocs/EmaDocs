/**
 * Status Component - minimal Variant
...
(function() {
    ...
    function initStatusMinimal() {
        const components = document.querySelectorAll('.ema-status--minimal');
        ...
        console.log(`Status minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Status component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Status minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('status:click', {
    ...
    window.handleClick = function() {
        console.log('Status minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStatusMinimal);
    } else {
        initStatusMinimal();
    }
