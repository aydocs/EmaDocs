...
(function() {
    ...
    function initStatusSoft() {
        const components = document.querySelectorAll('.ema-status--soft');
        ...
        console.log(`Status soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Status soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Status soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStatusSoft);
    } else {
        initStatusSoft();
    }
