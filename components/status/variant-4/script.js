/**
 * Status Component - glass Variant
...
(function() {
    ...
    function initStatusGlass() {
        const components = document.querySelectorAll('.ema-status--glass');
        ...
        console.log(`Status glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Status glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Status glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStatusGlass);
    } else {
        initStatusGlass();
    }
