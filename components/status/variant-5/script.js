/**
 * Status Component - premium Variant
...
(function() {
    ...
    function initStatusPremium() {
        const components = document.querySelectorAll('.ema-status--premium');
        ...
        console.log(`Status premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Status premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Status premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStatusPremium);
    } else {
        initStatusPremium();
    }
