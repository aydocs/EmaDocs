...
(function() {
    ...
    function initStatusNeo() {
        const components = document.querySelectorAll('.ema-status--neo');
        ...
        console.log(`Status neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Status neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Status neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStatusNeo);
    } else {
        initStatusNeo();
    }
