...
(function() {
    ...
    function initTableGlass() {
        const components = document.querySelectorAll('.ema-table--glass');
        ...
        console.log(`Table glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Table glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Table glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableGlass);
    } else {
        initTableGlass();
    }
