...
(function() {
    ...
    function initTableNeo() {
        const components = document.querySelectorAll('.ema-table--neo');
        ...
        console.log(`Table neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Table neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableNeo);
    } else {
        initTableNeo();
    }
