/**
 * Table Component - Main Entry Point
...
// Export component
export { default as Table } from './table.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Table', {
    name: 'Table',
...
console.log('Table component loaded with 5 variants');
