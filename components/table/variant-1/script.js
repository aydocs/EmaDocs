/**
 * Table Component - minimal Variant
...
(function() {
    ...
    function initTableMinimal() {
        const components = document.querySelectorAll('.ema-table--minimal');
        ...
        console.log(`Table minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Table minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Table minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableMinimal);
    } else {
        initTableMinimal();
    }
