...
(function() {
    ...
    function initTableSoft() {
        const components = document.querySelectorAll('.ema-table--soft');
        ...
        console.log(`Table soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Table soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Table soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTableSoft);
    } else {
        initTableSoft();
    }
