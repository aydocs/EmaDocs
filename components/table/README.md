...
A comprehensive Table component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Table variant="minimal">Minimal</Table>
<Table variant="neo">Neo</Table>
<Table variant="soft">Soft</Table>
<Table variant="glass">Glass</Table>
<Table variant="premium">Premium</Table>
```
...
- `table.ema` - Main component definition
