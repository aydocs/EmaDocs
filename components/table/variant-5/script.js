...
(function() {
    ...
    function initTablePremium() {
        const components = document.querySelectorAll('.ema-table--premium');
        ...
        console.log(`Table premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Table component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Table premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('table:click', {
    ...
    window.handleClick = function() {
        console.log('Table premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTablePremium);
    } else {
        initTablePremium();
    }
