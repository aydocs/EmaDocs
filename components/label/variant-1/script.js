/**
 * Label Component - minimal Variant
...
(function() {
    ...
    function initLabelMinimal() {
        const components = document.querySelectorAll('.ema-label--minimal');
        ...
        console.log(`Label minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Label component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Label minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('label:click', {
    ...
    window.handleClick = function() {
        console.log('Label minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLabelMinimal);
    } else {
        initLabelMinimal();
    }
