...
(function() {
    ...
    function initLabelGlass() {
        const components = document.querySelectorAll('.ema-label--glass');
        ...
        console.log(`Label glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Label glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Label glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLabelGlass);
    } else {
        initLabelGlass();
    }
