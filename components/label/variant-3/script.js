...
(function() {
    ...
    function initLabelSoft() {
        const components = document.querySelectorAll('.ema-label--soft');
        ...
        console.log(`Label soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Label soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Label soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLabelSoft);
    } else {
        initLabelSoft();
    }
