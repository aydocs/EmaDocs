...
(function() {
    ...
    function initLabelNeo() {
        const components = document.querySelectorAll('.ema-label--neo');
        ...
        console.log(`Label neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Label neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLabelNeo);
    } else {
        initLabelNeo();
    }
