/**
 * Label Component - premium Variant
...
(function() {
    ...
    function initLabelPremium() {
        const components = document.querySelectorAll('.ema-label--premium');
        ...
        console.log(`Label premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Label premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Label premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLabelPremium);
    } else {
        initLabelPremium();
    }
