/**
 * Image Component - minimal Variant
...
(function() {
    ...
    function initImageMinimal() {
        const components = document.querySelectorAll('.ema-image--minimal');
        ...
        console.log(`Image minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Image component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Image minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('image:click', {
    ...
    window.handleClick = function() {
        console.log('Image minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImageMinimal);
    } else {
        initImageMinimal();
    }
