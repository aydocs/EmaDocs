...
(function() {
    ...
    function initImageNeo() {
        const components = document.querySelectorAll('.ema-image--neo');
        ...
        console.log(`Image neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Image neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImageNeo);
    } else {
        initImageNeo();
    }
