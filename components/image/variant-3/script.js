...
(function() {
    ...
    function initImageSoft() {
        const components = document.querySelectorAll('.ema-image--soft');
        ...
        console.log(`Image soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Image soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Image soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImageSoft);
    } else {
        initImageSoft();
    }
