/**
 * Image Component - premium Variant
...
(function() {
    ...
    function initImagePremium() {
        const components = document.querySelectorAll('.ema-image--premium');
        ...
        console.log(`Image premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Image premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Image premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImagePremium);
    } else {
        initImagePremium();
    }
