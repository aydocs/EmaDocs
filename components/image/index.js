/**
 * Image Component - Main Entry Point
...
// Export component
export { default as Image } from './image.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Image', {
    name: 'Image',
...
console.log('Image component loaded with 5 variants');
