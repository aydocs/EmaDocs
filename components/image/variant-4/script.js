...
(function() {
    ...
    function initImageGlass() {
        const components = document.querySelectorAll('.ema-image--glass');
        ...
        console.log(`Image glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Image glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Image glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initImageGlass);
    } else {
        initImageGlass();
    }
