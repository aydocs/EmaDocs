/**
 * Article Component - soft Variant
...
(function() {
    ...
    function initArticleSoft() {
        const components = document.querySelectorAll('.ema-article--soft');
        ...
        console.log(`Article soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Article soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Article soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initArticleSoft);
    } else {
        initArticleSoft();
    }
