/**
 * Article Component - glass Variant
...
(function() {
    ...
    function initArticleGlass() {
        const components = document.querySelectorAll('.ema-article--glass');
        ...
        console.log(`Article glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Article glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Article glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initArticleGlass);
    } else {
        initArticleGlass();
    }
