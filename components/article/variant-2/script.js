...
(function() {
    ...
    function initArticleNeo() {
        const components = document.querySelectorAll('.ema-article--neo');
        ...
        console.log(`Article neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Article neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Article neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initArticleNeo);
    } else {
        initArticleNeo();
    }
