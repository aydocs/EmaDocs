/**
 * Article Component - minimal Variant
...
(function() {
    ...
    function initArticleMinimal() {
        const components = document.querySelectorAll('.ema-article--minimal');
        ...
        console.log(`Article minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Article component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Article minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('article:click', {
    ...
    window.handleClick = function() {
        console.log('Article minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initArticleMinimal);
    } else {
        initArticleMinimal();
    }
