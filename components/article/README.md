...
A comprehensive Article component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Article variant="minimal">Minimal</Article>
<Article variant="neo">Neo</Article>
<Article variant="soft">Soft</Article>
<Article variant="glass">Glass</Article>
<Article variant="premium">Premium</Article>
```
...
- `article.ema` - Main component definition
