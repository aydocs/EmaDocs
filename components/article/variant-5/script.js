/**
 * Article Component - premium Variant
...
(function() {
    ...
    function initArticlePremium() {
        const components = document.querySelectorAll('.ema-article--premium');
        ...
        console.log(`Article premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Article premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Article premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initArticlePremium);
    } else {
        initArticlePremium();
    }
