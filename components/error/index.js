/**
 * Error Component - Main Entry Point
...
// Export component
export { default as Error } from './error.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Error', {
    name: 'Error',
...
console.log('Error component loaded with 5 variants');
