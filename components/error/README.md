...
A comprehensive Error component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Error variant="minimal">Minimal</Error>
<Error variant="neo">Neo</Error>
<Error variant="soft">Soft</Error>
<Error variant="glass">Glass</Error>
<Error variant="premium">Premium</Error>
```
...
- `error.ema` - Main component definition
