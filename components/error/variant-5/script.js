/**
 * Error Component - premium Variant
...
(function() {
    ...
    function initErrorPremium() {
        const components = document.querySelectorAll('.ema-error--premium');
        ...
        console.log(`Error premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Error component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Error premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('error:click', {
    ...
    window.handleClick = function() {
        console.log('Error premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorPremium);
    } else {
        initErrorPremium();
    }
