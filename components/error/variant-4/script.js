...
(function() {
    ...
    function initErrorGlass() {
        const components = document.querySelectorAll('.ema-error--glass');
        ...
        console.log(`Error glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Error glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Error glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorGlass);
    } else {
        initErrorGlass();
    }
