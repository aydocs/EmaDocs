...
(function() {
    ...
    function initErrorNeo() {
        const components = document.querySelectorAll('.ema-error--neo');
        ...
        console.log(`Error neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Error neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorNeo);
    } else {
        initErrorNeo();
    }
