/**
 * Error Component - minimal Variant
...
(function() {
    ...
    function initErrorMinimal() {
        const components = document.querySelectorAll('.ema-error--minimal');
        ...
        console.log(`Error minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Error minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Error minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorMinimal);
    } else {
        initErrorMinimal();
    }
