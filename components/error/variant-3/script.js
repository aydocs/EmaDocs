...
(function() {
    ...
    function initErrorSoft() {
        const components = document.querySelectorAll('.ema-error--soft');
        ...
        console.log(`Error soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Error soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Error soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initErrorSoft);
    } else {
        initErrorSoft();
    }
