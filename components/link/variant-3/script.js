...
(function() {
    ...
    function initLinkSoft() {
        const components = document.querySelectorAll('.ema-link--soft');
        ...
        console.log(`Link soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Link soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinkSoft);
    } else {
        initLinkSoft();
    }
