...
(function() {
    ...
    function initLinkNeo() {
        const components = document.querySelectorAll('.ema-link--neo');
        ...
        console.log(`Link neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Link neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinkNeo);
    } else {
        initLinkNeo();
    }
