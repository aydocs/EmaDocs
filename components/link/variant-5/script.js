/**
 * Link Component - premium Variant
...
(function() {
    ...
    function initLinkPremium() {
        const components = document.querySelectorAll('.ema-link--premium');
        ...
        console.log(`Link premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Link component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Link premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('link:click', {
    ...
    window.handleClick = function() {
        console.log('Link premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinkPremium);
    } else {
        initLinkPremium();
    }
