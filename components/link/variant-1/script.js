/**
 * Link Component - minimal Variant
...
(function() {
    ...
    function initLinkMinimal() {
        const components = document.querySelectorAll('.ema-link--minimal');
        ...
        console.log(`Link minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Link minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Link minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinkMinimal);
    } else {
        initLinkMinimal();
    }
