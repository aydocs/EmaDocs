...
A comprehensive Link component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Link variant="minimal">Minimal</Link>
<Link variant="neo">Neo</Link>
<Link variant="soft">Soft</Link>
<Link variant="glass">Glass</Link>
<Link variant="premium">Premium</Link>
```
...
- `link.ema` - Main component definition
