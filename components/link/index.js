/**
 * Link Component - Main Entry Point
...
// Export component
export { default as Link } from './link.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Link', {
    name: 'Link',
...
console.log('Link component loaded with 5 variants');
