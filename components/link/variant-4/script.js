...
(function() {
    ...
    function initLinkGlass() {
        const components = document.querySelectorAll('.ema-link--glass');
        ...
        console.log(`Link glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Link glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Link glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinkGlass);
    } else {
        initLinkGlass();
    }
