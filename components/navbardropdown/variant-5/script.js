/**
 * NavbarDropdown Component - premium Variant
...
(function() {
    ...
    function initNavbarDropdownPremium() {
        const components = document.querySelectorAll('.ema-navbardropdown--premium');
        ...
        console.log(`NavbarDropdown premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarDropdown premium clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarDropdown premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarDropdownPremium);
    } else {
        initNavbarDropdownPremium();
    }
