/**
 * NavbarDropdown Component - soft Variant
...
(function() {
    ...
    function initNavbarDropdownSoft() {
        const components = document.querySelectorAll('.ema-navbardropdown--soft');
        ...
        console.log(`NavbarDropdown soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarDropdown soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarDropdown soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarDropdownSoft);
    } else {
        initNavbarDropdownSoft();
    }
