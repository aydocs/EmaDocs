...
(function() {
    ...
    function initNavbarDropdownGlass() {
        const components = document.querySelectorAll('.ema-navbardropdown--glass');
        ...
        console.log(`NavbarDropdown glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarDropdown glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarDropdown glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarDropdownGlass);
    } else {
        initNavbarDropdownGlass();
    }
