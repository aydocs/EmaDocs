/**
 * NavbarDropdown Component - neo Variant
...
(function() {
    ...
    function initNavbarDropdownNeo() {
        const components = document.querySelectorAll('.ema-navbardropdown--neo');
        ...
        console.log(`NavbarDropdown neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarDropdown neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarDropdown neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarDropdownNeo);
    } else {
        initNavbarDropdownNeo();
    }
