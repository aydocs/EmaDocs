/**
 * NavbarDropdown Component - Main Entry Point
...
// Export component
export { default as NavbarDropdown } from './navbardropdown.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarDropdown', {
    name: 'NavbarDropdown',
...
console.log('NavbarDropdown component loaded with 5 variants');
