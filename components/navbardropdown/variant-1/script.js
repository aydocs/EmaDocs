/**
 * NavbarDropdown Component - minimal Variant
...
(function() {
    ...
    function initNavbarDropdownMinimal() {
        const components = document.querySelectorAll('.ema-navbardropdown--minimal');
        ...
        console.log(`NavbarDropdown minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarDropdown component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarDropdown minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbardropdown:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarDropdown minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarDropdownMinimal);
    } else {
        initNavbarDropdownMinimal();
    }
