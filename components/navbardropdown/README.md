...
A comprehensive NavbarDropdown component for Emadocs Framework with 5 beautiful variants.
...
```ema
<NavbarDropdown variant="minimal">
  Basic NavbarDropdown
</NavbarDropdown>
```
...
```ema
<NavbarDropdown variant="minimal">Minimal</NavbarDropdown>
<NavbarDropdown variant="neo">Neo</NavbarDropdown>
<NavbarDropdown variant="soft">Soft</NavbarDropdown>
<NavbarDropdown variant="glass">Glass</NavbarDropdown>
<NavbarDropdown variant="premium">Premium</NavbarDropdown>
```
...
- `navbardropdown.ema` - Main component definition
