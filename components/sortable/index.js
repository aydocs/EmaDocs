/**
 * Sortable Component - Main Entry Point
...
// Export component
export { default as Sortable } from './sortable.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Sortable', {
    name: 'Sortable',
...
console.log('Sortable component loaded with 5 variants');
