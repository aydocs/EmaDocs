...
A comprehensive Sortable component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Sortable variant="minimal">Minimal</Sortable>
<Sortable variant="neo">Neo</Sortable>
<Sortable variant="soft">Soft</Sortable>
<Sortable variant="glass">Glass</Sortable>
<Sortable variant="premium">Premium</Sortable>
```
...
- `sortable.ema` - Main component definition
