/**
 * Sortable Component - glass Variant
...
(function() {
    ...
    function initSortableGlass() {
        const components = document.querySelectorAll('.ema-sortable--glass');
        ...
        console.log(`Sortable glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sortable glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Sortable glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableGlass);
    } else {
        initSortableGlass();
    }
