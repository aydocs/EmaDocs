/**
 * Sortable Component - neo Variant
...
(function() {
    ...
    function initSortableNeo() {
        const components = document.querySelectorAll('.ema-sortable--neo');
        ...
        console.log(`Sortable neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sortable neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Sortable neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableNeo);
    } else {
        initSortableNeo();
    }
