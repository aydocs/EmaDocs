/**
 * Sortable Component - premium Variant
...
(function() {
    ...
    function initSortablePremium() {
        const components = document.querySelectorAll('.ema-sortable--premium');
        ...
        console.log(`Sortable premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sortable premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Sortable premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortablePremium);
    } else {
        initSortablePremium();
    }
