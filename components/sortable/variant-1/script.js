/**
 * Sortable Component - minimal Variant
...
(function() {
    ...
    function initSortableMinimal() {
        const components = document.querySelectorAll('.ema-sortable--minimal');
        ...
        console.log(`Sortable minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Sortable component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sortable minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('sortable:click', {
    ...
    window.handleClick = function() {
        console.log('Sortable minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableMinimal);
    } else {
        initSortableMinimal();
    }
