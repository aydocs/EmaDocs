/**
 * Sortable Component - soft Variant
...
(function() {
    ...
    function initSortableSoft() {
        const components = document.querySelectorAll('.ema-sortable--soft');
        ...
        console.log(`Sortable soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Sortable soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Sortable soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSortableSoft);
    } else {
        initSortableSoft();
    }
