/**
 * Crop Component - Main Entry Point
...
// Export component
export { default as Crop } from './crop.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Crop', {
    name: 'Crop',
...
console.log('Crop component loaded with 5 variants');
