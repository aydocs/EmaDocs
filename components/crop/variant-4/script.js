...
(function() {
    ...
    function initCropGlass() {
        const components = document.querySelectorAll('.ema-crop--glass');
        ...
        console.log(`Crop glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Crop glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Crop glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCropGlass);
    } else {
        initCropGlass();
    }
