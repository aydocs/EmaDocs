/**
 * Crop Component - minimal Variant
...
(function() {
    ...
    function initCropMinimal() {
        const components = document.querySelectorAll('.ema-crop--minimal');
        ...
        console.log(`Crop minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Crop minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Crop minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCropMinimal);
    } else {
        initCropMinimal();
    }
