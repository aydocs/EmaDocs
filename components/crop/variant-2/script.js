...
(function() {
    ...
    function initCropNeo() {
        const components = document.querySelectorAll('.ema-crop--neo');
        ...
        console.log(`Crop neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Crop neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCropNeo);
    } else {
        initCropNeo();
    }
