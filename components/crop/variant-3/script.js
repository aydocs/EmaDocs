...
(function() {
    ...
    function initCropSoft() {
        const components = document.querySelectorAll('.ema-crop--soft');
        ...
        console.log(`Crop soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Crop soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCropSoft);
    } else {
        initCropSoft();
    }
