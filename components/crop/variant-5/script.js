/**
 * Crop Component - premium Variant
...
(function() {
    ...
    function initCropPremium() {
        const components = document.querySelectorAll('.ema-crop--premium');
        ...
        console.log(`Crop premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Crop component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Crop premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('crop:click', {
    ...
    window.handleClick = function() {
        console.log('Crop premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCropPremium);
    } else {
        initCropPremium();
    }
