/**
 * Export Component - premium Variant
...
(function() {
    ...
    function initExportPremium() {
        const components = document.querySelectorAll('.ema-export--premium');
        ...
        console.log(`Export premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Export premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Export premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExportPremium);
    } else {
        initExportPremium();
    }
