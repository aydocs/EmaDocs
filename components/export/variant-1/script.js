/**
 * Export Component - minimal Variant
...
(function() {
    ...
    function initExportMinimal() {
        const components = document.querySelectorAll('.ema-export--minimal');
        ...
        console.log(`Export minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Export component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Export minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('export:click', {
    ...
    window.handleClick = function() {
        console.log('Export minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExportMinimal);
    } else {
        initExportMinimal();
    }
