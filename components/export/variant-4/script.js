/**
 * Export Component - glass Variant
...
(function() {
    ...
    function initExportGlass() {
        const components = document.querySelectorAll('.ema-export--glass');
        ...
        console.log(`Export glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Export glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Export glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExportGlass);
    } else {
        initExportGlass();
    }
