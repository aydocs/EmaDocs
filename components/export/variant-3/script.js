...
(function() {
    ...
    function initExportSoft() {
        const components = document.querySelectorAll('.ema-export--soft');
        ...
        console.log(`Export soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Export soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Export soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExportSoft);
    } else {
        initExportSoft();
    }
