...
(function() {
    ...
    function initExportNeo() {
        const components = document.querySelectorAll('.ema-export--neo');
        ...
        console.log(`Export neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Export neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Export neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExportNeo);
    } else {
        initExportNeo();
    }
