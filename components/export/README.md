...
A comprehensive Export component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Export variant="minimal">Minimal</Export>
<Export variant="neo">Neo</Export>
<Export variant="soft">Soft</Export>
<Export variant="glass">Glass</Export>
<Export variant="premium">Premium</Export>
```
...
- `export.ema` - Main component definition
