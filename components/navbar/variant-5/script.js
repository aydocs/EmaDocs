/**
 * Navbar Component - premium Variant
...
(function() {
    ...
    function initNavbarPremium() {
        const components = document.querySelectorAll('.ema-navbar--premium');
        ...
        console.log(`Navbar premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navbar premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Navbar premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarPremium);
    } else {
        initNavbarPremium();
    }
