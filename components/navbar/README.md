...
A comprehensive Navbar component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Navbar variant="minimal">Minimal</Navbar>
<Navbar variant="neo">Neo</Navbar>
<Navbar variant="soft">Soft</Navbar>
<Navbar variant="glass">Glass</Navbar>
<Navbar variant="premium">Premium</Navbar>
```
...
- `navbar.ema` - Main component definition
