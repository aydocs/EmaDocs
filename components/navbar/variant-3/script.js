...
(function() {
    ...
    function initNavbarSoft() {
        const components = document.querySelectorAll('.ema-navbar--soft');
        ...
        console.log(`Navbar soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navbar soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Navbar soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSoft);
    } else {
        initNavbarSoft();
    }
