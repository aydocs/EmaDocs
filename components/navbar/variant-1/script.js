/**
 * Navbar Component - minimal Variant
...
(function() {
    ...
    function initNavbarMinimal() {
        const components = document.querySelectorAll('.ema-navbar--minimal');
        ...
        console.log(`Navbar minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Navbar component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navbar minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbar:click', {
    ...
    window.handleClick = function() {
        console.log('Navbar minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarMinimal);
    } else {
        initNavbarMinimal();
    }
