/**
 * Navbar Component - glass Variant
...
(function() {
    ...
    function initNavbarGlass() {
        const components = document.querySelectorAll('.ema-navbar--glass');
        ...
        console.log(`Navbar glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navbar glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Navbar glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarGlass);
    } else {
        initNavbarGlass();
    }
