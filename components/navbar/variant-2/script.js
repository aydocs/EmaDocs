...
(function() {
    ...
    function initNavbarNeo() {
        const components = document.querySelectorAll('.ema-navbar--neo');
        ...
        console.log(`Navbar neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Navbar neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Navbar neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNeo);
    } else {
        initNavbarNeo();
    }
