/**
 * ListItem Component - minimal Variant
...
(function() {
    ...
    function initListItemMinimal() {
        const components = document.querySelectorAll('.ema-listitem--minimal');
        ...
        console.log(`ListItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `ListItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ListItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('listitem:click', {
    ...
    window.handleClick = function() {
        console.log('ListItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListItemMinimal);
    } else {
        initListItemMinimal();
    }
