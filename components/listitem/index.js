/**
 * ListItem Component - Main Entry Point
...
// Export component
export { default as ListItem } from './listitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('ListItem', {
    name: 'ListItem',
...
console.log('ListItem component loaded with 5 variants');
