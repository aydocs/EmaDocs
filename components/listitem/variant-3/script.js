/**
 * ListItem Component - soft Variant
...
(function() {
    ...
    function initListItemSoft() {
        const components = document.querySelectorAll('.ema-listitem--soft');
        ...
        console.log(`ListItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ListItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('ListItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListItemSoft);
    } else {
        initListItemSoft();
    }
