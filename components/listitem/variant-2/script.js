/**
 * ListItem Component - neo Variant
...
(function() {
    ...
    function initListItemNeo() {
        const components = document.querySelectorAll('.ema-listitem--neo');
        ...
        console.log(`ListItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ListItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('ListItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListItemNeo);
    } else {
        initListItemNeo();
    }
