/**
 * ListItem Component - glass Variant
...
(function() {
    ...
    function initListItemGlass() {
        const components = document.querySelectorAll('.ema-listitem--glass');
        ...
        console.log(`ListItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ListItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('ListItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListItemGlass);
    } else {
        initListItemGlass();
    }
