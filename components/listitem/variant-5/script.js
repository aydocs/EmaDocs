/**
 * ListItem Component - premium Variant
...
(function() {
    ...
    function initListItemPremium() {
        const components = document.querySelectorAll('.ema-listitem--premium');
        ...
        console.log(`ListItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`ListItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('ListItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initListItemPremium);
    } else {
        initListItemPremium();
    }
