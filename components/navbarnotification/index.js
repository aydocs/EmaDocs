/**
 * NavbarNotification Component - Main Entry Point
...
// Export component
export { default as NavbarNotification } from './navbarnotification.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarNotification', {
...
console.log('NavbarNotification component loaded with 5 variants');
