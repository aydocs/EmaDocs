/**
 * NavbarNotification Component - glass Variant
...
(function() {
    ...
    function initNavbarNotificationGlass() {
        const components = document.querySelectorAll('.ema-navbarnotification--glass');
        ...
        console.log(`NavbarNotification glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNotification glass clicked`);
        ...
        event.target.dispatchEvent(new CustomEvent('navbarnotification:click', {
            detail: { variant: 'glass', component: event.target },
            bubbles: true
        }));
    }
    ...
    window.handleClick = function() {
        console.log('NavbarNotification glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNotificationGlass);
    } else {
        initNavbarNotificationGlass();
    }
