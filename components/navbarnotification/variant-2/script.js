/**
 * NavbarNotification Component - neo Variant
...
(function() {
    ...
    function initNavbarNotificationNeo() {
        const components = document.querySelectorAll('.ema-navbarnotification--neo');
        ...
        console.log(`NavbarNotification neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNotification neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarNotification neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNotificationNeo);
    } else {
        initNavbarNotificationNeo();
    }
