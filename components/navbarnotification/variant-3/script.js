/**
 * NavbarNotification Component - soft Variant
...
(function() {
    ...
    function initNavbarNotificationSoft() {
        const components = document.querySelectorAll('.ema-navbarnotification--soft');
        ...
        console.log(`NavbarNotification soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNotification soft clicked`);
        ...
        event.target.dispatchEvent(new CustomEvent('navbarnotification:click', {
            detail: { variant: 'soft', component: event.target },
            bubbles: true
        }));
    }
    ...
    window.handleClick = function() {
        console.log('NavbarNotification soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNotificationSoft);
    } else {
        initNavbarNotificationSoft();
    }
