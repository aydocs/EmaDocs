/**
 * NavbarNotification Component - minimal Variant
...
(function() {
    ...
    function initNavbarNotificationMinimal() {
        const components = document.querySelectorAll('.ema-navbarnotification--minimal');
        ...
        console.log(`NavbarNotification minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNotification minimal clicked`);
        ...
        event.target.dispatchEvent(new CustomEvent('navbarnotification:click', {
            detail: { variant: 'minimal', component: event.target },
            bubbles: true
        }));
    }
    ...
    window.handleClick = function() {
        console.log('NavbarNotification minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNotificationMinimal);
    } else {
        initNavbarNotificationMinimal();
    }
