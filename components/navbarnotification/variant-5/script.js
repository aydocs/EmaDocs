/**
 * NavbarNotification Component - premium Variant
...
(function() {
    ...
    function initNavbarNotificationPremium() {
        const components = document.querySelectorAll('.ema-navbarnotification--premium');
        ...
        console.log(`NavbarNotification premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarNotification component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarNotification premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarnotification:click', {
            detail: { variant: 'premium', component: event.target },
            bubbles: true
        }));
    }
    ...
    window.handleClick = function() {
        console.log('NavbarNotification premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarNotificationPremium);
    } else {
        initNavbarNotificationPremium();
    }
