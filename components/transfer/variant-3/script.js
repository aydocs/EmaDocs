/**
 * Transfer Component - soft Variant
...
(function() {
    ...
    function initTransferSoft() {
        const components = document.querySelectorAll('.ema-transfer--soft');
        ...
        console.log(`Transfer soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Transfer soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Transfer soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransferSoft);
    } else {
        initTransferSoft();
    }
