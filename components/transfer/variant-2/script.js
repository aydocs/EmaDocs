/**
 * Transfer Component - neo Variant
...
(function() {
    ...
    function initTransferNeo() {
        const components = document.querySelectorAll('.ema-transfer--neo');
        ...
        console.log(`Transfer neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Transfer neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Transfer neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransferNeo);
    } else {
        initTransferNeo();
    }
