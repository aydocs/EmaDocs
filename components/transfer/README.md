...
A comprehensive Transfer component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Transfer variant="minimal">Minimal</Transfer>
<Transfer variant="neo">Neo</Transfer>
<Transfer variant="soft">Soft</Transfer>
<Transfer variant="glass">Glass</Transfer>
<Transfer variant="premium">Premium</Transfer>
```
...
- `transfer.ema` - Main component definition
