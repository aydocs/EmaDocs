/**
 * Transfer Component - glass Variant
...
(function() {
    ...
    function initTransferGlass() {
        const components = document.querySelectorAll('.ema-transfer--glass');
        ...
        console.log(`Transfer glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Transfer glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Transfer glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransferGlass);
    } else {
        initTransferGlass();
    }
