/**
 * Transfer Component - premium Variant
...
(function() {
    ...
    function initTransferPremium() {
        const components = document.querySelectorAll('.ema-transfer--premium');
        ...
        console.log(`Transfer premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Transfer premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Transfer premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransferPremium);
    } else {
        initTransferPremium();
    }
