/**
 * Transfer Component - minimal Variant
...
(function() {
    ...
    function initTransferMinimal() {
        const components = document.querySelectorAll('.ema-transfer--minimal');
        ...
        console.log(`Transfer minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Transfer component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Transfer minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('transfer:click', {
    ...
    window.handleClick = function() {
        console.log('Transfer minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTransferMinimal);
    } else {
        initTransferMinimal();
    }
