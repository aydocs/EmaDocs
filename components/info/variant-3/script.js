...
(function() {
    ...
    function initInfoSoft() {
        const components = document.querySelectorAll('.ema-info--soft');
        ...
        console.log(`Info soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Info soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfoSoft);
    } else {
        initInfoSoft();
    }
