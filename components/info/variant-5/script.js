/**
 * Info Component - premium Variant
...
(function() {
    ...
    function initInfoPremium() {
        const components = document.querySelectorAll('.ema-info--premium');
        ...
        console.log(`Info premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Info premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Info premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfoPremium);
    } else {
        initInfoPremium();
    }
