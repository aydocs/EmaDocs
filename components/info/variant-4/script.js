...
(function() {
    ...
    function initInfoGlass() {
        const components = document.querySelectorAll('.ema-info--glass');
        ...
        console.log(`Info glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Info glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Info glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfoGlass);
    } else {
        initInfoGlass();
    }
