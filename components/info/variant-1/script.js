/**
 * Info Component - minimal Variant
...
(function() {
    ...
    function initInfoMinimal() {
        const components = document.querySelectorAll('.ema-info--minimal');
        ...
        console.log(`Info minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Info component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Info minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('info:click', {
    ...
    window.handleClick = function() {
        console.log('Info minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfoMinimal);
    } else {
        initInfoMinimal();
    }
