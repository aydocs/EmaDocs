...
(function() {
    ...
    function initInfoNeo() {
        const components = document.querySelectorAll('.ema-info--neo');
        ...
        console.log(`Info neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Info neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfoNeo);
    } else {
        initInfoNeo();
    }
