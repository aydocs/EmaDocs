...
A comprehensive Info component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Info variant="minimal">Minimal</Info>
<Info variant="neo">Neo</Info>
<Info variant="soft">Soft</Info>
<Info variant="glass">Glass</Info>
<Info variant="premium">Premium</Info>
```
...
- `info.ema` - Main component definition
