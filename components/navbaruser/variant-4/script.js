/**
 * NavbarUser Component - glass Variant
...
(function() {
    ...
    function initNavbarUserGlass() {
        const components = document.querySelectorAll('.ema-navbaruser--glass');
        ...
        console.log(`NavbarUser glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarUser glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarUser glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarUserGlass);
    } else {
        initNavbarUserGlass();
    }
