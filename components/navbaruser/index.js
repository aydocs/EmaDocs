/**
 * NavbarUser Component - Main Entry Point
...
// Export component
export { default as NavbarUser } from './navbaruser.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarUser', {
    name: 'NavbarUser',
...
console.log('NavbarUser component loaded with 5 variants');
