/**
 * NavbarUser Component - premium Variant
...
(function() {
    ...
    function initNavbarUserPremium() {
        const components = document.querySelectorAll('.ema-navbaruser--premium');
        ...
        console.log(`NavbarUser premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarUser premium clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarUser premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarUserPremium);
    } else {
        initNavbarUserPremium();
    }
