/**
 * NavbarUser Component - neo Variant
...
(function() {
    ...
    function initNavbarUserNeo() {
        const components = document.querySelectorAll('.ema-navbaruser--neo');
        ...
        console.log(`NavbarUser neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarUser neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarUser neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarUserNeo);
    } else {
        initNavbarUserNeo();
    }
