/**
 * NavbarUser Component - minimal Variant
...
(function() {
    ...
    function initNavbarUserMinimal() {
        const components = document.querySelectorAll('.ema-navbaruser--minimal');
        ...
        console.log(`NavbarUser minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarUser component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarUser minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbaruser:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarUser minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarUserMinimal);
    } else {
        initNavbarUserMinimal();
    }
