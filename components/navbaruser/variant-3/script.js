/**
 * NavbarUser Component - soft Variant
...
(function() {
    ...
    function initNavbarUserSoft() {
        const components = document.querySelectorAll('.ema-navbaruser--soft');
        ...
        console.log(`NavbarUser soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarUser soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarUser soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarUserSoft);
    } else {
        initNavbarUserSoft();
    }
