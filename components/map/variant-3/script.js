...
(function() {
    ...
    function initMapSoft() {
        const components = document.querySelectorAll('.ema-map--soft');
        ...
        console.log(`Map soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Map soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMapSoft);
    } else {
        initMapSoft();
    }
