...
(function() {
    ...
    function initMapMinimal() {
        const components = document.querySelectorAll('.ema-map--minimal');
        ...
        console.log(`Map minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Map component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Map minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('map:click', {
    ...
    window.handleClick = function() {
        console.log('Map minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMapMinimal);
    } else {
        initMapMinimal();
    }
