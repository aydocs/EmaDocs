...
(function() {
    ...
    function initMapGlass() {
        const components = document.querySelectorAll('.ema-map--glass');
        ...
        console.log(`Map glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Map glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMapGlass);
    } else {
        initMapGlass();
    }
