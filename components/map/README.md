...
A comprehensive Map component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Map variant="minimal">Minimal</Map>
<Map variant="neo">Neo</Map>
<Map variant="soft">Soft</Map>
<Map variant="glass">Glass</Map>
<Map variant="premium">Premium</Map>
```
...
- `map.ema` - Main component definition
