...
(function() {
    ...
    function initMapPremium() {
        const components = document.querySelectorAll('.ema-map--premium');
        ...
        console.log(`Map premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Map premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Map premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMapPremium);
    } else {
        initMapPremium();
    }
