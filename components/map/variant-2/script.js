...
(function() {
    ...
    function initMapNeo() {
        const components = document.querySelectorAll('.ema-map--neo');
        ...
        console.log(`Map neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Map neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initMapNeo);
    } else {
        initMapNeo();
    }
