...
(function() {
    ...
    function initColGlass() {
        const components = document.querySelectorAll('.ema-col--glass');
        ...
        console.log(`Col glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Col glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColGlass);
    } else {
        initColGlass();
    }
