...
(function() {
    ...
    function initColSoft() {
        const components = document.querySelectorAll('.ema-col--soft');
        ...
        console.log(`Col soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Col soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColSoft);
    } else {
        initColSoft();
    }
