...
(function() {
    ...
    function initColPremium() {
        const components = document.querySelectorAll('.ema-col--premium');
        ...
        console.log(`Col premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Col premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Col premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColPremium);
    } else {
        initColPremium();
    }
