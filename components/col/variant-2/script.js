...
(function() {
    ...
    function initColNeo() {
        const components = document.querySelectorAll('.ema-col--neo');
        ...
        console.log(`Col neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Col neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColNeo);
    } else {
        initColNeo();
    }
