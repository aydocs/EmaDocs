...
(function() {
    ...
    function initColMinimal() {
        const components = document.querySelectorAll('.ema-col--minimal');
        ...
        console.log(`Col minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Col component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Col minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('col:click', {
    ...
    window.handleClick = function() {
        console.log('Col minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initColMinimal);
    } else {
        initColMinimal();
    }
