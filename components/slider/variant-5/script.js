/**
 * Slider Component - premium Variant
...
(function() {
    ...
    function initSliderPremium() {
        const components = document.querySelectorAll('.ema-slider--premium');
        ...
        console.log(`Slider premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Slider premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Slider premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSliderPremium);
    } else {
        initSliderPremium();
    }
