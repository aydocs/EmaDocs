/**
 * Slider Component - glass Variant
...
(function() {
    ...
    function initSliderGlass() {
        const components = document.querySelectorAll('.ema-slider--glass');
        ...
        console.log(`Slider glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Slider glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Slider glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSliderGlass);
    } else {
        initSliderGlass();
    }
