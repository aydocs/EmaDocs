/**
 * Slider Component - minimal Variant
...
(function() {
    ...
    function initSliderMinimal() {
        const components = document.querySelectorAll('.ema-slider--minimal');
        ...
        console.log(`Slider minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Slider component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Slider minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('slider:click', {
    ...
    window.handleClick = function() {
        console.log('Slider minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSliderMinimal);
    } else {
        initSliderMinimal();
    }
