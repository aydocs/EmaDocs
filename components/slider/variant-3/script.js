...
(function() {
    ...
    function initSliderSoft() {
        const components = document.querySelectorAll('.ema-slider--soft');
        ...
        console.log(`Slider soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Slider soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Slider soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSliderSoft);
    } else {
        initSliderSoft();
    }
