...
(function() {
    ...
    function initSliderNeo() {
        const components = document.querySelectorAll('.ema-slider--neo');
        ...
        console.log(`Slider neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Slider neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Slider neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSliderNeo);
    } else {
        initSliderNeo();
    }
