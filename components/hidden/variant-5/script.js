/**
 * Hidden Component - premium Variant
...
(function() {
    ...
    function initHiddenPremium() {
        const components = document.querySelectorAll('.ema-hidden--premium');
        ...
        console.log(`Hidden premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hidden premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Hidden premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHiddenPremium);
    } else {
        initHiddenPremium();
    }
