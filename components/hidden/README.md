...
A comprehensive Hidden component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Hidden variant="minimal">Minimal</Hidden>
<Hidden variant="neo">Neo</Hidden>
<Hidden variant="soft">Soft</Hidden>
<Hidden variant="glass">Glass</Hidden>
<Hidden variant="premium">Premium</Hidden>
```
...
- `hidden.ema` - Main component definition
