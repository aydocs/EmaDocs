...
(function() {
    ...
    function initHiddenNeo() {
        const components = document.querySelectorAll('.ema-hidden--neo');
        ...
        console.log(`Hidden neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hidden neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Hidden neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHiddenNeo);
    } else {
        initHiddenNeo();
    }
