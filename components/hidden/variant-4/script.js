/**
 * Hidden Component - glass Variant
...
(function() {
    ...
    function initHiddenGlass() {
        const components = document.querySelectorAll('.ema-hidden--glass');
        ...
        console.log(`Hidden glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hidden glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Hidden glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHiddenGlass);
    } else {
        initHiddenGlass();
    }
