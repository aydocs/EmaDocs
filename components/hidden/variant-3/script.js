...
(function() {
    ...
    function initHiddenSoft() {
        const components = document.querySelectorAll('.ema-hidden--soft');
        ...
        console.log(`Hidden soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hidden soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Hidden soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHiddenSoft);
    } else {
        initHiddenSoft();
    }
