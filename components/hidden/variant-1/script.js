...
(function() {
    ...
    function initHiddenMinimal() {
        const components = document.querySelectorAll('.ema-hidden--minimal');
        ...
        console.log(`Hidden minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Hidden component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Hidden minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('hidden:click', {
    ...
    window.handleClick = function() {
        console.log('Hidden minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initHiddenMinimal);
    } else {
        initHiddenMinimal();
    }
