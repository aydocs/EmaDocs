...
(function() {
    ...
    function initIconNeo() {
        const components = document.querySelectorAll('.ema-icon--neo');
        ...
        console.log(`Icon neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Icon neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIconNeo);
    } else {
        initIconNeo();
    }
