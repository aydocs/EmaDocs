...
(function() {
    ...
    function initIconGlass() {
        const components = document.querySelectorAll('.ema-icon--glass');
        ...
        console.log(`Icon glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Icon glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Icon glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIconGlass);
    } else {
        initIconGlass();
    }
