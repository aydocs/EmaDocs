/**
 * Icon Component - Main Entry Point
...
// Export component
export { default as Icon } from './icon.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Icon', {
    name: 'Icon',
...
console.log('Icon component loaded with 5 variants');
