/**
 * Icon Component - premium Variant
...
(function() {
    ...
    function initIconPremium() {
        const components = document.querySelectorAll('.ema-icon--premium');
        ...
        console.log(`Icon premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Icon component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Icon premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('icon:click', {
    ...
    window.handleClick = function() {
        console.log('Icon premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIconPremium);
    } else {
        initIconPremium();
    }
