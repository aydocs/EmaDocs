...
(function() {
    ...
    function initIconSoft() {
        const components = document.querySelectorAll('.ema-icon--soft');
        ...
        console.log(`Icon soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Icon soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIconSoft);
    } else {
        initIconSoft();
    }
