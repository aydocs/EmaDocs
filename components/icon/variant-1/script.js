/**
 * Icon Component - minimal Variant
...
(function() {
    ...
    function initIconMinimal() {
        const components = document.querySelectorAll('.ema-icon--minimal');
        ...
        console.log(`Icon minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Icon minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Icon minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIconMinimal);
    } else {
        initIconMinimal();
    }
