/**
 * VirtualList Component - premium Variant
...
(function() {
    ...
    function initVirtualListPremium() {
        const components = document.querySelectorAll('.ema-virtuallist--premium');
        ...
        console.log(`VirtualList premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualList premium clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualList premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualListPremium);
    } else {
        initVirtualListPremium();
    }
