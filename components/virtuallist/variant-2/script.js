/**
 * VirtualList Component - neo Variant
...
(function() {
    ...
    function initVirtualListNeo() {
        const components = document.querySelectorAll('.ema-virtuallist--neo');
        ...
        console.log(`VirtualList neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualList neo clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualList neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualListNeo);
    } else {
        initVirtualListNeo();
    }
