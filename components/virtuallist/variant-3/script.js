/**
 * VirtualList Component - soft Variant
...
(function() {
    ...
    function initVirtualListSoft() {
        const components = document.querySelectorAll('.ema-virtuallist--soft');
        ...
        console.log(`VirtualList soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualList soft clicked`);
    ...
    window.handleClick = function() {
        console.log('VirtualList soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualListSoft);
    } else {
        initVirtualListSoft();
    }
