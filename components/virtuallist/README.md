...
A comprehensive VirtualList component for Emadocs Framework with 5 beautiful variants.
...
```ema
<VirtualList variant="minimal">Minimal</VirtualList>
<VirtualList variant="neo">Neo</VirtualList>
<VirtualList variant="soft">Soft</VirtualList>
<VirtualList variant="glass">Glass</VirtualList>
<VirtualList variant="premium">Premium</VirtualList>
```
...
- `virtuallist.ema` - Main component definition
