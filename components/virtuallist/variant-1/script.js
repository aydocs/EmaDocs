/**
 * VirtualList Component - minimal Variant
...
(function() {
    ...
    function initVirtualListMinimal() {
        const components = document.querySelectorAll('.ema-virtuallist--minimal');
        ...
        console.log(`VirtualList minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `VirtualList component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`VirtualList minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('virtuallist:click', {
    ...
    window.handleClick = function() {
        console.log('VirtualList minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initVirtualListMinimal);
    } else {
        initVirtualListMinimal();
    }
