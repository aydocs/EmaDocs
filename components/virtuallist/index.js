/**
 * VirtualList Component - Main Entry Point
...
// Export component
export { default as VirtualList } from './virtuallist.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('VirtualList', {
    name: 'VirtualList',
...
console.log('VirtualList component loaded with 5 variants');
