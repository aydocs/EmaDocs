/**
 * Success Component - glass Variant
...
(function() {
    ...
    function initSuccessGlass() {
        const components = document.querySelectorAll('.ema-success--glass');
        ...
        console.log(`Success glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Success glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Success glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSuccessGlass);
    } else {
        initSuccessGlass();
    }
