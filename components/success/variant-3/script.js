/**
 * Success Component - soft Variant
...
(function() {
    ...
    function initSuccessSoft() {
        const components = document.querySelectorAll('.ema-success--soft');
        ...
        console.log(`Success soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Success soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Success soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSuccessSoft);
    } else {
        initSuccessSoft();
    }
