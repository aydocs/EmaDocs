...
(function() {
    ...
    function initSuccessNeo() {
        const components = document.querySelectorAll('.ema-success--neo');
        ...
        console.log(`Success neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Success neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Success neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSuccessNeo);
    } else {
        initSuccessNeo();
    }
