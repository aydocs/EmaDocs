/**
 * Success Component - premium Variant
...
(function() {
    ...
    function initSuccessPremium() {
        const components = document.querySelectorAll('.ema-success--premium');
        ...
        console.log(`Success premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Success premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Success premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSuccessPremium);
    } else {
        initSuccessPremium();
    }
