/**
 * Success Component - minimal Variant
...
(function() {
    ...
    function initSuccessMinimal() {
        const components = document.querySelectorAll('.ema-success--minimal');
        ...
        console.log(`Success minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Success component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Success minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('success:click', {
    ...
    window.handleClick = function() {
        console.log('Success minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSuccessMinimal);
    } else {
        initSuccessMinimal();
    }
