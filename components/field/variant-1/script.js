/**
 * Field Component - minimal Variant
...
(function() {
    ...
    function initFieldMinimal() {
        const components = document.querySelectorAll('.ema-field--minimal');
        ...
        console.log(`Field minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Field component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Field minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('field:click', {
    ...
    window.handleClick = function() {
        console.log('Field minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldMinimal);
    } else {
        initFieldMinimal();
    }
