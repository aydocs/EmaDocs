/**
 * Field Component - premium Variant
...
(function() {
    ...
    function initFieldPremium() {
        const components = document.querySelectorAll('.ema-field--premium');
        ...
        console.log(`Field premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Field premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Field premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldPremium);
    } else {
        initFieldPremium();
    }
