...
(function() {
    ...
    function initFieldSoft() {
        const components = document.querySelectorAll('.ema-field--soft');
        ...
        console.log(`Field soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Field soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Field soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldSoft);
    } else {
        initFieldSoft();
    }
