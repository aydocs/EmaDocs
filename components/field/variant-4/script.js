...
(function() {
    ...
    function initFieldGlass() {
        const components = document.querySelectorAll('.ema-field--glass');
        ...
        console.log(`Field glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Field glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Field glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldGlass);
    } else {
        initFieldGlass();
    }
