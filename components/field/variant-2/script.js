...
(function() {
    ...
    function initFieldNeo() {
        const components = document.querySelectorAll('.ema-field--neo');
        ...
        console.log(`Field neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Field neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFieldNeo);
    } else {
        initFieldNeo();
    }
