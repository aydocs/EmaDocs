/**
 * Expand Component - Main Entry Point
...
// Export component
export { default as Expand } from './expand.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Expand', {
    name: 'Expand',
...
console.log('Expand component loaded with 5 variants');
