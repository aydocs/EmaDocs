/**
 * Expand Component - glass Variant
...
(function() {
    ...
    function initExpandGlass() {
        const components = document.querySelectorAll('.ema-expand--glass');
        ...
        console.log(`Expand glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Expand glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Expand glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExpandGlass);
    } else {
        initExpandGlass();
    }
