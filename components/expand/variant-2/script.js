...
(function() {
    ...
    function initExpandNeo() {
        const components = document.querySelectorAll('.ema-expand--neo');
        ...
        console.log(`Expand neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Expand neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Expand neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExpandNeo);
    } else {
        initExpandNeo();
    }
