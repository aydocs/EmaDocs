/**
 * Expand Component - premium Variant
...
(function() {
    ...
    function initExpandPremium() {
        const components = document.querySelectorAll('.ema-expand--premium');
        ...
        console.log(`Expand premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Expand premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Expand premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExpandPremium);
    } else {
        initExpandPremium();
    }
