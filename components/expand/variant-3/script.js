...
(function() {
    ...
    function initExpandSoft() {
        const components = document.querySelectorAll('.ema-expand--soft');
        ...
        console.log(`Expand soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Expand soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Expand soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExpandSoft);
    } else {
        initExpandSoft();
    }
