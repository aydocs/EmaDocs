/**
 * Expand Component - minimal Variant
...
(function() {
    ...
    function initExpandMinimal() {
        const components = document.querySelectorAll('.ema-expand--minimal');
        ...
        console.log(`Expand minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Expand component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Expand minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('expand:click', {
    ...
    window.handleClick = function() {
        console.log('Expand minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initExpandMinimal);
    } else {
        initExpandMinimal();
    }
