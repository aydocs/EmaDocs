...
(function() {
    ...
    function initRadioSoft() {
        const components = document.querySelectorAll('.ema-radio--soft');
        ...
        console.log(`Radio soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Radio soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Radio soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRadioSoft);
    } else {
        initRadioSoft();
    }
