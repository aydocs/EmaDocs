...
(function() {
    ...
    function initRadioGlass() {
        const components = document.querySelectorAll('.ema-radio--glass');
        ...
        console.log(`Radio glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Radio glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Radio glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRadioGlass);
    } else {
        initRadioGlass();
    }
