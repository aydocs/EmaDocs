/**
 * Radio Component - minimal Variant
...
(function() {
    ...
    function initRadioMinimal() {
        const components = document.querySelectorAll('.ema-radio--minimal');
        ...
        console.log(`Radio minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Radio component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Radio minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('radio:click', {
    ...
    window.handleClick = function() {
        console.log('Radio minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRadioMinimal);
    } else {
        initRadioMinimal();
    }
