...
A comprehensive Radio component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Radio variant="minimal">Minimal</Radio>
<Radio variant="neo">Neo</Radio>
<Radio variant="soft">Soft</Radio>
<Radio variant="glass">Glass</Radio>
<Radio variant="premium">Premium</Radio>
```
...
- `radio.ema` - Main component definition
