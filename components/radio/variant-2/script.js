...
(function() {
    ...
    function initRadioNeo() {
        const components = document.querySelectorAll('.ema-radio--neo');
        ...
        console.log(`Radio neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Radio neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRadioNeo);
    } else {
        initRadioNeo();
    }
