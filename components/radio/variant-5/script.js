/**
 * Radio Component - premium Variant
...
(function() {
    ...
    function initRadioPremium() {
        const components = document.querySelectorAll('.ema-radio--premium');
        ...
        console.log(`Radio premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Radio premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Radio premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRadioPremium);
    } else {
        initRadioPremium();
    }
