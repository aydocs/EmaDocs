...
(function() {
    ...
    function initLikeSoft() {
        const components = document.querySelectorAll('.ema-like--soft');
        ...
        console.log(`Like soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Like soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLikeSoft);
    } else {
        initLikeSoft();
    }
