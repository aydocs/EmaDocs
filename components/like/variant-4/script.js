...
(function() {
    ...
    function initLikeGlass() {
        const components = document.querySelectorAll('.ema-like--glass');
        ...
        console.log(`Like glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Like glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Like glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLikeGlass);
    } else {
        initLikeGlass();
    }
