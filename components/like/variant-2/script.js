...
(function() {
    ...
    function initLikeNeo() {
        const components = document.querySelectorAll('.ema-like--neo');
        ...
        console.log(`Like neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Like neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLikeNeo);
    } else {
        initLikeNeo();
    }
