/**
 * Like Component - minimal Variant
...
(function() {
    ...
    function initLikeMinimal() {
        const components = document.querySelectorAll('.ema-like--minimal');
        ...
        console.log(`Like minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Like minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Like minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLikeMinimal);
    } else {
        initLikeMinimal();
    }
