/**
 * Like Component - premium Variant
...
(function() {
    ...
    function initLikePremium() {
        const components = document.querySelectorAll('.ema-like--premium');
        ...
        console.log(`Like premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Like component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Like premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('like:click', {
    ...
    window.handleClick = function() {
        console.log('Like premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLikePremium);
    } else {
        initLikePremium();
    }
