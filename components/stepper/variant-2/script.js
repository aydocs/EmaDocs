...
(function() {
    ...
    function initStepperNeo() {
        const components = document.querySelectorAll('.ema-stepper--neo');
        ...
        console.log(`Stepper neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stepper neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Stepper neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepperNeo);
    } else {
        initStepperNeo();
    }
