/**
 * Stepper Component - premium Variant
...
(function() {
    ...
    function initStepperPremium() {
        const components = document.querySelectorAll('.ema-stepper--premium');
        ...
        console.log(`Stepper premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Stepper component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stepper premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('stepper:click', {
    ...
    window.handleClick = function() {
        console.log('Stepper premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepperPremium);
    } else {
        initStepperPremium();
    }
