/**
 * Stepper Component - soft Variant
...
(function() {
    ...
    function initStepperSoft() {
        const components = document.querySelectorAll('.ema-stepper--soft');
        ...
        console.log(`Stepper soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stepper soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Stepper soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepperSoft);
    } else {
        initStepperSoft();
    }
