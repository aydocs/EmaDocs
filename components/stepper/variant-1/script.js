/**
 * Stepper Component - minimal Variant
...
(function() {
    ...
    function initStepperMinimal() {
        const components = document.querySelectorAll('.ema-stepper--minimal');
        ...
        console.log(`Stepper minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stepper minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Stepper minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepperMinimal);
    } else {
        initStepperMinimal();
    }
