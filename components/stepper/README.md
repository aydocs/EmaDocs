...
A comprehensive Stepper component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Stepper variant="minimal">Minimal</Stepper>
<Stepper variant="neo">Neo</Stepper>
<Stepper variant="soft">Soft</Stepper>
<Stepper variant="glass">Glass</Stepper>
<Stepper variant="premium">Premium</Stepper>
```
...
- `stepper.ema` - Main component definition
