/**
 * Stepper Component - Main Entry Point
...
// Export component
export { default as Stepper } from './stepper.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Stepper', {
    name: 'Stepper',
...
console.log('Stepper component loaded with 5 variants');
