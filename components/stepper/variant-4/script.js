/**
 * Stepper Component - glass Variant
...
(function() {
    ...
    function initStepperGlass() {
        const components = document.querySelectorAll('.ema-stepper--glass');
        ...
        console.log(`Stepper glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Stepper glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Stepper glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initStepperGlass);
    } else {
        initStepperGlass();
    }
