...
(function() {
    ...
    function initSplitPremium() {
        const components = document.querySelectorAll('.ema-split--premium');
        ...
        console.log(`Split premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Split component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Split premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('split:click', {
    ...
    window.handleClick = function() {
        console.log('Split premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSplitPremium);
    } else {
        initSplitPremium();
    }
