...
(function() {
    ...
    function initSplitSoft() {
        const components = document.querySelectorAll('.ema-split--soft');
        ...
        console.log(`Split soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Split soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Split soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSplitSoft);
    } else {
        initSplitSoft();
    }
