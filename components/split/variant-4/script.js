...
(function() {
    ...
    function initSplitGlass() {
        const components = document.querySelectorAll('.ema-split--glass');
        ...
        console.log(`Split glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Split glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Split glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSplitGlass);
    } else {
        initSplitGlass();
    }
