/**
 * Split Component - minimal Variant
...
(function() {
    ...
    function initSplitMinimal() {
        const components = document.querySelectorAll('.ema-split--minimal');
        ...
        console.log(`Split minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Split minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Split minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSplitMinimal);
    } else {
        initSplitMinimal();
    }
