...
(function() {
    ...
    function initSplitNeo() {
        const components = document.querySelectorAll('.ema-split--neo');
        ...
        console.log(`Split neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Split neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSplitNeo);
    } else {
        initSplitNeo();
    }
