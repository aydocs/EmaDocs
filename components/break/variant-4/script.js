...
(function() {
    ...
    function initBreakGlass() {
        const components = document.querySelectorAll('.ema-break--glass');
        ...
        console.log(`Break glass variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Break glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakGlass);
    } else {
        initBreakGlass();
    }
