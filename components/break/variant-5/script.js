/**
 * Break Component - premium Variant
...
(function() {
    ...
    function initBreakPremium() {
        const components = document.querySelectorAll('.ema-break--premium');
        ...
        console.log(`Break premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Break premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Break premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakPremium);
    } else {
        initBreakPremium();
    }
