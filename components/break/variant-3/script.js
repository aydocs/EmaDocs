...
(function() {
    ...
    function initBreakSoft() {
        const components = document.querySelectorAll('.ema-break--soft');
        ...
        console.log(`Break soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Break soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Break soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakSoft);
    } else {
        initBreakSoft();
    }
