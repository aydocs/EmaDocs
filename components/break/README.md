...
A comprehensive Break component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Break variant="minimal">Minimal</Break>
<Break variant="neo">Neo</Break>
<Break variant="soft">Soft</Break>
<Break variant="glass">Glass</Break>
<Break variant="premium">Premium</Break>
```
...
- `break.ema` - Main component definition
