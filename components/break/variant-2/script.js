...
(function() {
    ...
    function initBreakNeo() {
        const components = document.querySelectorAll('.ema-break--neo');
        ...
        console.log(`Break neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Break neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBreakNeo);
    } else {
        initBreakNeo();
    }
