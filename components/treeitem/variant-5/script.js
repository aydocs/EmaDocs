/**
 * TreeItem Component - premium Variant
...
(function() {
    ...
    function initTreeItemPremium() {
        const components = document.querySelectorAll('.ema-treeitem--premium');
        ...
        console.log(`TreeItem premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeItem premium clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeItemPremium);
    } else {
        initTreeItemPremium();
    }
