/**
 * TreeItem Component - soft Variant
...
(function() {
    ...
    function initTreeItemSoft() {
        const components = document.querySelectorAll('.ema-treeitem--soft');
        ...
        console.log(`TreeItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeItemSoft);
    } else {
        initTreeItemSoft();
    }
