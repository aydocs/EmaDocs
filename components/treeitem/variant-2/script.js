/**
 * TreeItem Component - neo Variant
...
(function() {
    ...
    function initTreeItemNeo() {
        const components = document.querySelectorAll('.ema-treeitem--neo');
        ...
        console.log(`TreeItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeItemNeo);
    } else {
        initTreeItemNeo();
    }
