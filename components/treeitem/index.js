/**
 * TreeItem Component - Main Entry Point
...
// Export component
export { default as TreeItem } from './treeitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('TreeItem', {
    name: 'TreeItem',
...
console.log('TreeItem component loaded with 5 variants');
