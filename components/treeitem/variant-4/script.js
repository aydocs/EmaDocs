/**
 * TreeItem Component - glass Variant
...
(function() {
    ...
    function initTreeItemGlass() {
        const components = document.querySelectorAll('.ema-treeitem--glass');
        ...
        console.log(`TreeItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('TreeItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeItemGlass);
    } else {
        initTreeItemGlass();
    }
