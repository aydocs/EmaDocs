/**
 * TreeItem Component - minimal Variant
...
(function() {
    ...
    function initTreeItemMinimal() {
        const components = document.querySelectorAll('.ema-treeitem--minimal');
        ...
        console.log(`TreeItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `TreeItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`TreeItem minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('treeitem:click', {
    ...
    window.handleClick = function() {
        console.log('TreeItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTreeItemMinimal);
    } else {
        initTreeItemMinimal();
    }
