/**
 * NavbarSearch Component - soft Variant
...
(function() {
    ...
    function initNavbarSearchSoft() {
        const components = document.querySelectorAll('.ema-navbarsearch--soft');
        ...
        console.log(`NavbarSearch soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarSearch soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarSearch soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSearchSoft);
    } else {
        initNavbarSearchSoft();
    }
