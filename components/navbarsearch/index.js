/**
 * NavbarSearch Component - Main Entry Point
...
// Export component
export { default as NavbarSearch } from './navbarsearch.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavbarSearch', {
    name: 'NavbarSearch',
...
console.log('NavbarSearch component loaded with 5 variants');
