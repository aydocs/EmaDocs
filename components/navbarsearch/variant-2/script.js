/**
 * NavbarSearch Component - neo Variant
...
(function() {
    ...
    function initNavbarSearchNeo() {
        const components = document.querySelectorAll('.ema-navbarsearch--neo');
        ...
        console.log(`NavbarSearch neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarSearch neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarSearch neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSearchNeo);
    } else {
        initNavbarSearchNeo();
    }
