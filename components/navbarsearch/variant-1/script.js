/**
 * NavbarSearch Component - minimal Variant
...
(function() {
    ...
    function initNavbarSearchMinimal() {
        const components = document.querySelectorAll('.ema-navbarsearch--minimal');
        ...
        console.log(`NavbarSearch minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavbarSearch component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarSearch minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navbarsearch:click', {
    ...
    window.handleClick = function() {
        console.log('NavbarSearch minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSearchMinimal);
    } else {
        initNavbarSearchMinimal();
    }
