/**
 * NavbarSearch Component - glass Variant
...
(function() {
    ...
    function initNavbarSearchGlass() {
        const components = document.querySelectorAll('.ema-navbarsearch--glass');
        ...
        console.log(`NavbarSearch glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarSearch glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarSearch glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSearchGlass);
    } else {
        initNavbarSearchGlass();
    }
