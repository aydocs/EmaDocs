/**
 * NavbarSearch Component - premium Variant
...
(function() {
    ...
    function initNavbarSearchPremium() {
        const components = document.querySelectorAll('.ema-navbarsearch--premium');
        ...
        console.log(`NavbarSearch premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavbarSearch premium clicked`);
    ...
    window.handleClick = function() {
        console.log('NavbarSearch premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavbarSearchPremium);
    } else {
        initNavbarSearchPremium();
    }
