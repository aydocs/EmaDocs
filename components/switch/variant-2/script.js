...
(function() {
    ...
    function initSwitchNeo() {
        const components = document.querySelectorAll('.ema-switch--neo');
        ...
        console.log(`Switch neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Switch neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Switch neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSwitchNeo);
    } else {
        initSwitchNeo();
    }
