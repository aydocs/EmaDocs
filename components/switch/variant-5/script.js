/**
 * Switch Component - premium Variant
...
(function() {
    ...
    function initSwitchPremium() {
        const components = document.querySelectorAll('.ema-switch--premium');
        ...
        console.log(`Switch premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Switch component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Switch premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('switch:click', {
    ...
    window.handleClick = function() {
        console.log('Switch premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSwitchPremium);
    } else {
        initSwitchPremium();
    }
