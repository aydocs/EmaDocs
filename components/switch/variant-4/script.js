/**
 * Switch Component - glass Variant
...
(function() {
    ...
    function initSwitchGlass() {
        const components = document.querySelectorAll('.ema-switch--glass');
        ...
        console.log(`Switch glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Switch glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Switch glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSwitchGlass);
    } else {
        initSwitchGlass();
    }
