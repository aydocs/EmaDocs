/**
 * Switch Component - minimal Variant
...
(function() {
    ...
    function initSwitchMinimal() {
        const components = document.querySelectorAll('.ema-switch--minimal');
        ...
        console.log(`Switch minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Switch minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Switch minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSwitchMinimal);
    } else {
        initSwitchMinimal();
    }
