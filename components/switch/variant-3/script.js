...
(function() {
    ...
    function initSwitchSoft() {
        const components = document.querySelectorAll('.ema-switch--soft');
        ...
        console.log(`Switch soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Switch soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Switch soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSwitchSoft);
    } else {
        initSwitchSoft();
    }
