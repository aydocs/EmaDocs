/**
 * Skeleton Component - minimal Variant
...
(function() {
    ...
    function initSkeletonMinimal() {
        const components = document.querySelectorAll('.ema-skeleton--minimal');
        ...
        console.log(`Skeleton minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Skeleton minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Skeleton minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSkeletonMinimal);
    } else {
        initSkeletonMinimal();
    }
