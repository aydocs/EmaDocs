/**
 * Skeleton Component - soft Variant
...
(function() {
    ...
    function initSkeletonSoft() {
        const components = document.querySelectorAll('.ema-skeleton--soft');
        ...
        console.log(`Skeleton soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Skeleton soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Skeleton soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSkeletonSoft);
    } else {
        initSkeletonSoft();
    }
