...
A comprehensive Skeleton component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Skeleton variant="minimal">Minimal</Skeleton>
<Skeleton variant="neo">Neo</Skeleton>
<Skeleton variant="soft">Soft</Skeleton>
<Skeleton variant="glass">Glass</Skeleton>
<Skeleton variant="premium">Premium</Skeleton>
```
...
- `skeleton.ema` - Main component definition
