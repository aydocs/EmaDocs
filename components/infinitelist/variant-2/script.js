/**
 * InfiniteList Component - neo Variant
...
(function() {
    ...
    function initInfiniteListNeo() {
        const components = document.querySelectorAll('.ema-infinitelist--neo');
        ...
        console.log(`InfiniteList neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteList neo clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteList neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteListNeo);
    } else {
        initInfiniteListNeo();
    }
