/**
 * InfiniteList Component - premium Variant
...
(function() {
    ...
    function initInfiniteListPremium() {
        const components = document.querySelectorAll('.ema-infinitelist--premium');
        ...
        console.log(`InfiniteList premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `InfiniteList component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteList premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('infinitelist:click', {
    ...
    window.handleClick = function() {
        console.log('InfiniteList premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteListPremium);
    } else {
        initInfiniteListPremium();
    }
