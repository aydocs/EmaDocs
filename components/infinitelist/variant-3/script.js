...
(function() {
    ...
    function initInfiniteListSoft() {
        const components = document.querySelectorAll('.ema-infinitelist--soft');
        ...
        console.log(`InfiniteList soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteList soft clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteList soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteListSoft);
    } else {
        initInfiniteListSoft();
    }
