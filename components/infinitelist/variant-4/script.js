/**
 * InfiniteList Component - glass Variant
...
(function() {
    ...
    function initInfiniteListGlass() {
        const components = document.querySelectorAll('.ema-infinitelist--glass');
        ...
        console.log(`InfiniteList glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteList glass clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteList glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteListGlass);
    } else {
        initInfiniteListGlass();
    }
