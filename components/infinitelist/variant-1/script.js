/**
 * InfiniteList Component - minimal Variant
...
(function() {
    ...
    function initInfiniteListMinimal() {
        const components = document.querySelectorAll('.ema-infinitelist--minimal');
        ...
        console.log(`InfiniteList minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`InfiniteList minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('InfiniteList minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initInfiniteListMinimal);
    } else {
        initInfiniteListMinimal();
    }
