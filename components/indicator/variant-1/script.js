/**
 * Indicator Component - minimal Variant
...
(function() {
    ...
    function initIndicatorMinimal() {
        const components = document.querySelectorAll('.ema-indicator--minimal');
        ...
        console.log(`Indicator minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Indicator component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Indicator minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('indicator:click', {
    ...
    window.handleClick = function() {
        console.log('Indicator minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIndicatorMinimal);
    } else {
        initIndicatorMinimal();
    }
