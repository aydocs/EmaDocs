/**
 * Indicator Component - premium Variant
...
(function() {
    ...
    function initIndicatorPremium() {
        const components = document.querySelectorAll('.ema-indicator--premium');
        ...
        console.log(`Indicator premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Indicator premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Indicator premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIndicatorPremium);
    } else {
        initIndicatorPremium();
    }
