/**
 * Indicator Component - soft Variant
...
(function() {
    ...
    function initIndicatorSoft() {
        const components = document.querySelectorAll('.ema-indicator--soft');
        ...
        console.log(`Indicator soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Indicator soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Indicator soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIndicatorSoft);
    } else {
        initIndicatorSoft();
    }
