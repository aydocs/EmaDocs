/**
 * Indicator Component - neo Variant
...
(function() {
    ...
    function initIndicatorNeo() {
        const components = document.querySelectorAll('.ema-indicator--neo');
        ...
        console.log(`Indicator neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Indicator neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Indicator neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initIndicatorNeo);
    } else {
        initIndicatorNeo();
    }
