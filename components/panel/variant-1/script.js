/**
 * Panel Component - minimal Variant
...
(function() {
    ...
    function initPanelMinimal() {
        const components = document.querySelectorAll('.ema-panel--minimal');
        ...
        console.log(`Panel minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Panel component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Panel minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('panel:click', {
    ...
    window.handleClick = function() {
        console.log('Panel minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPanelMinimal);
    } else {
        initPanelMinimal();
    }
