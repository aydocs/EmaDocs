...
(function() {
    ...
    function initPanelGlass() {
        const components = document.querySelectorAll('.ema-panel--glass');
        ...
        console.log(`Panel glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Panel glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Panel glass clicked via global handler');
    };
