...
(function() {
    ...
    function initPanelSoft() {
        const components = document.querySelectorAll('.ema-panel--soft');
        ...
        console.log(`Panel soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Panel soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Panel soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPanelSoft);
    } else {
        initPanelSoft();
    }
