/**
 * Panel Component - premium Variant
...
(function() {
    ...
    function initPanelPremium() {
        const components = document.querySelectorAll('.ema-panel--premium');
        ...
        console.log(`Panel premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Panel premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Panel premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPanelPremium);
    } else {
        initPanelPremium();
    }
