...
(function() {
    ...
    function initPanelNeo() {
        const components = document.querySelectorAll('.ema-panel--neo');
        ...
        console.log(`Panel neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Panel neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPanelNeo);
    } else {
        initPanelNeo();
    }
