...
A comprehensive Panel component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Panel variant="minimal">Minimal</Panel>
<Panel variant="neo">Neo</Panel>
<Panel variant="soft">Soft</Panel>
<Panel variant="glass">Glass</Panel>
<Panel variant="premium">Premium</Panel>
```
...
- `panel.ema` - Main component definition
