/**
 * Panel Component - Main Entry Point
...
// Export component
export { default as Panel } from './panel.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Panel', {
    name: 'Panel',
...
console.log('Panel component loaded with 5 variants');
