/**
 * Doughnut Component - premium Variant
...
(function() {
    ...
    function initDoughnutPremium() {
        const components = document.querySelectorAll('.ema-doughnut--premium');
        ...
        console.log(`Doughnut premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Doughnut premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Doughnut premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDoughnutPremium);
    } else {
        initDoughnutPremium();
    }
