/**
 * Doughnut Component - neo Variant
...
(function() {
    ...
    function initDoughnutNeo() {
        const components = document.querySelectorAll('.ema-doughnut--neo');
        ...
        console.log(`Doughnut neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Doughnut neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Doughnut neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDoughnutNeo);
    } else {
        initDoughnutNeo();
    }
