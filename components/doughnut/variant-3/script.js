/**
 * Doughnut Component - soft Variant
...
(function() {
    ...
    function initDoughnutSoft() {
        const components = document.querySelectorAll('.ema-doughnut--soft');
        ...
        console.log(`Doughnut soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Doughnut soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Doughnut soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDoughnutSoft);
    } else {
        initDoughnutSoft();
    }
