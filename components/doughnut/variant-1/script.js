/**
 * Doughnut Component - minimal Variant
...
(function() {
    ...
    function initDoughnutMinimal() {
        const components = document.querySelectorAll('.ema-doughnut--minimal');
        ...
        console.log(`Doughnut minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Doughnut component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Doughnut minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('doughnut:click', {
    ...
    window.handleClick = function() {
        console.log('Doughnut minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDoughnutMinimal);
    } else {
        initDoughnutMinimal();
    }
