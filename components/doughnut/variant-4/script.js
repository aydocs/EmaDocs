/**
 * Doughnut Component - glass Variant
...
(function() {
    ...
    function initDoughnutGlass() {
        const components = document.querySelectorAll('.ema-doughnut--glass');
        ...
        console.log(`Doughnut glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Doughnut glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Doughnut glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDoughnutGlass);
    } else {
        initDoughnutGlass();
    }
