...
A comprehensive Doughnut component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Doughnut variant="minimal">Minimal</Doughnut>
<Doughnut variant="neo">Neo</Doughnut>
<Doughnut variant="soft">Soft</Doughnut>
<Doughnut variant="glass">Glass</Doughnut>
<Doughnut variant="premium">Premium</Doughnut>
```
...
- `doughnut.ema` - Main component definition
