/**
 * Toggle Component - minimal Variant
...
(function() {
    ...
    function initToggleMinimal() {
        const components = document.querySelectorAll('.ema-toggle--minimal');
        ...
        console.log(`Toggle minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toggle minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Toggle minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToggleMinimal);
    } else {
        initToggleMinimal();
    }
