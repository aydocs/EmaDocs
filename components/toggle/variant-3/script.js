...
(function() {
    ...
    function initToggleSoft() {
        const components = document.querySelectorAll('.ema-toggle--soft');
        ...
        console.log(`Toggle soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toggle soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Toggle soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToggleSoft);
    } else {
        initToggleSoft();
    }
