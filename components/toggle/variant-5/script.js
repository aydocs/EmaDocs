/**
 * Toggle Component - premium Variant
...
(function() {
    ...
    function initTogglePremium() {
        const components = document.querySelectorAll('.ema-toggle--premium');
        ...
        console.log(`Toggle premium variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Toggle premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTogglePremium);
    } else {
        initTogglePremium();
    }
