/**
 * Toggle Component - glass Variant
...
(function() {
    ...
    function initToggleGlass() {
        const components = document.querySelectorAll('.ema-toggle--glass');
        ...
        console.log(`Toggle glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Toggle glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Toggle glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initToggleGlass);
    } else {
        initToggleGlass();
    }
