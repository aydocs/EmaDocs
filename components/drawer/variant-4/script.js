/**
 * Drawer Component - glass Variant
...
(function() {
    ...
    function initDrawerGlass() {
        const components = document.querySelectorAll('.ema-drawer--glass');
        ...
        console.log(`Drawer glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drawer glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Drawer glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDrawerGlass);
    } else {
        initDrawerGlass();
    }
