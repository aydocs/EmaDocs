/**
 * Drawer Component - Main Entry Point
...
// Export component
export { default as Drawer } from './drawer.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Drawer', {
    name: 'Drawer',
...
console.log('Drawer component loaded with 5 variants');
