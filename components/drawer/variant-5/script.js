/**
 * Drawer Component - premium Variant
...
(function() {
    ...
    function initDrawerPremium() {
        const components = document.querySelectorAll('.ema-drawer--premium');
        ...
        console.log(`Drawer premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drawer premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Drawer premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDrawerPremium);
    } else {
        initDrawerPremium();
    }
