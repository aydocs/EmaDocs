...
(function() {
    ...
    function initDrawerSoft() {
        const components = document.querySelectorAll('.ema-drawer--soft');
        ...
        console.log(`Drawer soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drawer soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Drawer soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDrawerSoft);
    } else {
        initDrawerSoft();
    }
