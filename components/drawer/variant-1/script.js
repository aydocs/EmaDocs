/**
 * Drawer Component - minimal Variant
...
(function() {
    ...
    function initDrawerMinimal() {
        const components = document.querySelectorAll('.ema-drawer--minimal');
        ...
        console.log(`Drawer minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Drawer component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drawer minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('drawer:click', {
    ...
    window.handleClick = function() {
        console.log('Drawer minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDrawerMinimal);
    } else {
        initDrawerMinimal();
    }
