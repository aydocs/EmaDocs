...
(function() {
    ...
    function initDrawerNeo() {
        const components = document.querySelectorAll('.ema-drawer--neo');
        ...
        console.log(`Drawer neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Drawer neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Drawer neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initDrawerNeo);
    } else {
        initDrawerNeo();
    }
