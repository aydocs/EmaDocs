...
(function() {
    ...
    function initButtonNeo() {
        const components = document.querySelectorAll('.ema-button--neo');
        ...
        console.log(`Button neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Button neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Button neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initButtonNeo);
    } else {
        initButtonNeo();
    }
