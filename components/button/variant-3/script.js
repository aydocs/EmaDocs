...
(function() {
    ...
    function initButtonSoft() {
        const components = document.querySelectorAll('.ema-button--soft');
        ...
        console.log(`Button soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Button soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Button soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initButtonSoft);
    } else {
        initButtonSoft();
    }
