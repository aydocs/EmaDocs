/**
 * Button Component - minimal Variant
...
(function() {
    ...
    function initButtonMinimal() {
        const components = document.querySelectorAll('.ema-button--minimal');
        ...
        console.log(`Button minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Button component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Button minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('button:click', {
    ...
    window.handleClick = function() {
        console.log('Button minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initButtonMinimal);
    } else {
        initButtonMinimal();
    }
