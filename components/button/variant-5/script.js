/**
 * Button Component - premium Variant
...
(function() {
    ...
    function initButtonPremium() {
        const components = document.querySelectorAll('.ema-button--premium');
        ...
        console.log(`Button premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Button premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Button premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initButtonPremium);
    } else {
        initButtonPremium();
    }
