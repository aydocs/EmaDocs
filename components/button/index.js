/**
 * Button Component - Main Entry Point
...
// Export component
export { default as Button } from './button.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Button', {
    name: 'Button',
...
console.log('Button component loaded with 5 variants');
