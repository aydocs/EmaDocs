/**
 * Button Component - glass Variant
...
(function() {
    ...
    function initButtonGlass() {
        const components = document.querySelectorAll('.ema-button--glass');
        ...
        console.log(`Button glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Button glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Button glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initButtonGlass);
    } else {
        initButtonGlass();
    }
