/**
 * Line Component - Main Entry Point
...
// Export component
export { default as Line } from './line.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Line', {
    name: 'Line',
...
console.log('Line component loaded with 5 variants');
