...
A comprehensive Line component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Line variant="minimal">Minimal</Line>
<Line variant="neo">Neo</Line>
<Line variant="soft">Soft</Line>
<Line variant="glass">Glass</Line>
<Line variant="premium">Premium</Line>
```
...
- `line.ema` - Main component definition
