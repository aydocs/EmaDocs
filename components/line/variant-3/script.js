...
(function() {
    ...
    function initLineSoft() {
        const components = document.querySelectorAll('.ema-line--soft');
        ...
        console.log(`Line soft variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Line soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLineSoft);
    } else {
        initLineSoft();
    }
