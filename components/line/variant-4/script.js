...
(function() {
    ...
    function initLineGlass() {
        const components = document.querySelectorAll('.ema-line--glass');
        ...
        console.log(`Line glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Line glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Line glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLineGlass);
    } else {
        initLineGlass();
    }
