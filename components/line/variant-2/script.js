...
(function() {
    ...
    function initLineNeo() {
        const components = document.querySelectorAll('.ema-line--neo');
        ...
        console.log(`Line neo variant initialized: ${components.length} components`);
    }
    ...
    window.handleClick = function() {
        console.log('Line neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLineNeo);
    } else {
        initLineNeo();
    }
