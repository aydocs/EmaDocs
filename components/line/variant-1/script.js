/**
 * Line Component - minimal Variant
...
(function() {
    ...
    function initLineMinimal() {
        const components = document.querySelectorAll('.ema-line--minimal');
        ...
        console.log(`Line minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Line component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Line minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('line:click', {
    ...
    window.handleClick = function() {
        console.log('Line minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLineMinimal);
    } else {
        initLineMinimal();
    }
