/**
 * Line Component - premium Variant
...
(function() {
    ...
    function initLinePremium() {
        const components = document.querySelectorAll('.ema-line--premium');
        ...
        console.log(`Line premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Line premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Line premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLinePremium);
    } else {
        initLinePremium();
    }
