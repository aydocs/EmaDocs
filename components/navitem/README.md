...
A comprehensive NavItem component for Emadocs Framework with 5 beautiful variants.
...
```ema
<NavItem variant="minimal">Minimal</NavItem>
<NavItem variant="neo">Neo</NavItem>
<NavItem variant="soft">Soft</NavItem>
<NavItem variant="glass">Glass</NavItem>
<NavItem variant="premium">Premium</NavItem>
```
...
- `navitem.ema` - Main component definition
