/**
 * NavItem Component - premium Variant
...
(function() {
    ...
    function initNavItemPremium() {
        const components = document.querySelectorAll('.ema-navitem--premium');
        ...
        console.log(`NavItem premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `NavItem component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavItem premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('navitem:click', {
    ...
    window.handleClick = function() {
        console.log('NavItem premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavItemPremium);
    } else {
        initNavItemPremium();
    }
