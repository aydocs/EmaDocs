/**
 * NavItem Component - Main Entry Point
...
// Export component
export { default as NavItem } from './navitem.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('NavItem', {
    name: 'NavItem',
...
console.log('NavItem component loaded with 5 variants');
