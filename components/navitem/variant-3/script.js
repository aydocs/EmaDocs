/**
 * NavItem Component - soft Variant
...
(function() {
    ...
    function initNavItemSoft() {
        const components = document.querySelectorAll('.ema-navitem--soft');
        ...
        console.log(`NavItem soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavItem soft clicked`);
    ...
    window.handleClick = function() {
        console.log('NavItem soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavItemSoft);
    } else {
        initNavItemSoft();
    }
