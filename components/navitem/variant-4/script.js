/**
 * NavItem Component - glass Variant
...
(function() {
    ...
    function initNavItemGlass() {
        const components = document.querySelectorAll('.ema-navitem--glass');
        ...
        console.log(`NavItem glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavItem glass clicked`);
    ...
    window.handleClick = function() {
        console.log('NavItem glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavItemGlass);
    } else {
        initNavItemGlass();
    }
