...
(function() {
    ...
    function initNavItemNeo() {
        const components = document.querySelectorAll('.ema-navitem--neo');
        ...
        console.log(`NavItem neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavItem neo clicked`);
    ...
    window.handleClick = function() {
        console.log('NavItem neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavItemNeo);
    } else {
        initNavItemNeo();
    }
