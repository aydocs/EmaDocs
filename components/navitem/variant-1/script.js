/**
 * NavItem Component - minimal Variant
...
(function() {
    ...
    function initNavItemMinimal() {
        const components = document.querySelectorAll('.ema-navitem--minimal');
        ...
        console.log(`NavItem minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`NavItem minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('NavItem minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initNavItemMinimal);
    } else {
        initNavItemMinimal();
    }
