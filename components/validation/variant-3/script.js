/**
 * Validation Component - soft Variant
...
(function() {
    ...
    function initValidationSoft() {
        const components = document.querySelectorAll('.ema-validation--soft');
        ...
        console.log(`Validation soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Validation soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Validation soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initValidationSoft);
    } else {
        initValidationSoft();
    }
