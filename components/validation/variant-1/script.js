/**
 * Validation Component - minimal Variant
...
(function() {
    ...
    function initValidationMinimal() {
        const components = document.querySelectorAll('.ema-validation--minimal');
        ...
        console.log(`Validation minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Validation minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Validation minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initValidationMinimal);
    } else {
        initValidationMinimal();
    }
