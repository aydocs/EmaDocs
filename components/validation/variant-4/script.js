/**
 * Validation Component - glass Variant
...
(function() {
    ...
    function initValidationGlass() {
        const components = document.querySelectorAll('.ema-validation--glass');
        ...
        console.log(`Validation glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Validation glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Validation glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initValidationGlass);
    } else {
        initValidationGlass();
    }
