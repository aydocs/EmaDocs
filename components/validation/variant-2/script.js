/**
 * Validation Component - neo Variant
...
(function() {
    ...
    function initValidationNeo() {
        const components = document.querySelectorAll('.ema-validation--neo');
        ...
        console.log(`Validation neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Validation neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Validation neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initValidationNeo);
    } else {
        initValidationNeo();
    }
