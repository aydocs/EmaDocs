/**
 * Validation Component - premium Variant
...
(function() {
    ...
    function initValidationPremium() {
        const components = document.querySelectorAll('.ema-validation--premium');
        ...
        console.log(`Validation premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Validation component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Validation premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('validation:click', {
    ...
    window.handleClick = function() {
        console.log('Validation premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initValidationPremium);
    } else {
        initValidationPremium();
    }
