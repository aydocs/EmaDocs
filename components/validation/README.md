...
A comprehensive Validation component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Validation variant="minimal">Minimal</Validation>
<Validation variant="neo">Neo</Validation>
<Validation variant="soft">Soft</Validation>
<Validation variant="glass">Glass</Validation>
<Validation variant="premium">Premium</Validation>
```
...
- `validation.ema` - Main component definition
