/**
 * Lightbox Component - Main Entry Point
...
// Export component
export { default as Lightbox } from './lightbox.ema';

// Component registry
if (typeof window !== 'undefined' && window.EmadocsComponents) {
  window.EmadocsComponents.register('Lightbox', {
    name: 'Lightbox',
...
console.log('Lightbox component loaded with 5 variants');
