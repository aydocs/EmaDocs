...
A comprehensive Lightbox component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Lightbox variant="minimal">Minimal</Lightbox>
<Lightbox variant="neo">Neo</Lightbox>
<Lightbox variant="soft">Soft</Lightbox>
<Lightbox variant="glass">Glass</Lightbox>
<Lightbox variant="premium">Premium</Lightbox>
```
...
- `lightbox.ema` - Main component definition
