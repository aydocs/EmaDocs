/**
 * Lightbox Component - minimal Variant
...
(function() {
    ...
    function initLightboxMinimal() {
        const components = document.querySelectorAll('.ema-lightbox--minimal');
        ...
        console.log(`Lightbox minimal variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Lightbox minimal clicked`);
    ...
    window.handleClick = function() {
        console.log('Lightbox minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLightboxMinimal);
    } else {
        initLightboxMinimal();
    }
