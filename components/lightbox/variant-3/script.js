/**
 * Lightbox Component - soft Variant
...
(function() {
    ...
    function initLightboxSoft() {
        const components = document.querySelectorAll('.ema-lightbox--soft');
        ...
        console.log(`Lightbox soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Lightbox soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Lightbox soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLightboxSoft);
    } else {
        initLightboxSoft();
    }
