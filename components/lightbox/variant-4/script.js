/**
 * Lightbox Component - glass Variant
...
(function() {
    ...
    function initLightboxGlass() {
        const components = document.querySelectorAll('.ema-lightbox--glass');
        ...
        console.log(`Lightbox glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Lightbox glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Lightbox glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLightboxGlass);
    } else {
        initLightboxGlass();
    }
