/**
 * Lightbox Component - premium Variant
...
(function() {
    ...
    function initLightboxPremium() {
        const components = document.querySelectorAll('.ema-lightbox--premium');
        ...
        console.log(`Lightbox premium variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Lightbox component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Lightbox premium clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('lightbox:click', {
    ...
    window.handleClick = function() {
        console.log('Lightbox premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLightboxPremium);
    } else {
        initLightboxPremium();
    }
