/**
 * Lightbox Component - neo Variant
...
(function() {
    ...
    function initLightboxNeo() {
        const components = document.querySelectorAll('.ema-lightbox--neo');
        ...
        console.log(`Lightbox neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Lightbox neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Lightbox neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initLightboxNeo);
    } else {
        initLightboxNeo();
    }
