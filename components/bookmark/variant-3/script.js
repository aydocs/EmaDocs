/**
 * Bookmark Component - soft Variant
...
(function() {
    ...
    function initBookmarkSoft() {
        const components = document.querySelectorAll('.ema-bookmark--soft');
        ...
        console.log(`Bookmark soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bookmark soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Bookmark soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBookmarkSoft);
    } else {
        initBookmarkSoft();
    }
