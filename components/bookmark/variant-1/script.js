/**
 * Bookmark Component - minimal Variant
...
(function() {
    ...
    function initBookmarkMinimal() {
        const components = document.querySelectorAll('.ema-bookmark--minimal');
        ...
        console.log(`Bookmark minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Bookmark component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bookmark minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('bookmark:click', {
    ...
    window.handleClick = function() {
        console.log('Bookmark minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBookmarkMinimal);
    } else {
        initBookmarkMinimal();
    }
