/**
 * Bookmark Component - neo Variant
...
(function() {
    ...
    function initBookmarkNeo() {
        const components = document.querySelectorAll('.ema-bookmark--neo');
        ...
        console.log(`Bookmark neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bookmark neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Bookmark neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBookmarkNeo);
    } else {
        initBookmarkNeo();
    }
