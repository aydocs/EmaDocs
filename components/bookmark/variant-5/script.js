/**
 * Bookmark Component - premium Variant
...
(function() {
    ...
    function initBookmarkPremium() {
        const components = document.querySelectorAll('.ema-bookmark--premium');
        ...
        console.log(`Bookmark premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Bookmark premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Bookmark premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBookmarkPremium);
    } else {
        initBookmarkPremium();
    }
