/**
 * Upload Component - premium Variant
...
(function() {
    ...
    function initUploadPremium() {
        const components = document.querySelectorAll('.ema-upload--premium');
        ...
        console.log(`Upload premium variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Upload premium clicked`);
    ...
    window.handleClick = function() {
        console.log('Upload premium clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initUploadPremium);
    } else {
        initUploadPremium();
    }
