...
(function() {
    ...
    function initUploadNeo() {
        const components = document.querySelectorAll('.ema-upload--neo');
        ...
        console.log(`Upload neo variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Upload neo clicked`);
    ...
    window.handleClick = function() {
        console.log('Upload neo clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initUploadNeo);
    } else {
        initUploadNeo();
    }
