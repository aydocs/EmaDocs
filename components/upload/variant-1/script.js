/**
 * Upload Component - minimal Variant
...
(function() {
    ...
    function initUploadMinimal() {
        const components = document.querySelectorAll('.ema-upload--minimal');
        ...
        console.log(`Upload minimal variant initialized: ${components.length} components`);
    }
    ...
    function setupAccessibility(component) {
        ...
        if (!component.getAttribute('aria-label')) {
            component.setAttribute('aria-label', `Upload component`);
        }
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Upload minimal clicked`);
        
        // Add ripple effect
        addRippleEffect(event.target, event);
        
        // Emit custom event
        event.target.dispatchEvent(new CustomEvent('upload:click', {
    ...
    window.handleClick = function() {
        console.log('Upload minimal clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initUploadMinimal);
    } else {
        initUploadMinimal();
    }
