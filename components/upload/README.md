...
A comprehensive Upload component for Emadocs Framework with 5 beautiful variants.
...
```ema
<Upload variant="minimal">Minimal</Upload>
<Upload variant="neo">Neo</Upload>
<Upload variant="soft">Soft</Upload>
<Upload variant="glass">Glass</Upload>
<Upload variant="premium">Premium</Upload>
```
...
- `upload.ema` - Main component definition
