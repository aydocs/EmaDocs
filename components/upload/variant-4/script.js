/**
 * Upload Component - glass Variant
...
(function() {
    ...
    function initUploadGlass() {
        const components = document.querySelectorAll('.ema-upload--glass');
        ...
        console.log(`Upload glass variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Upload glass clicked`);
    ...
    window.handleClick = function() {
        console.log('Upload glass clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initUploadGlass);
    } else {
        initUploadGlass();
    }
