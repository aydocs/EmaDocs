...
(function() {
    ...
    function initUploadSoft() {
        const components = document.querySelectorAll('.ema-upload--soft');
        ...
        console.log(`Upload soft variant initialized: ${components.length} components`);
    }
    ...
    function handleClick(event) {
        ...
        console.log(`Upload soft clicked`);
    ...
    window.handleClick = function() {
        console.log('Upload soft clicked via global handler');
    };
    
    // Initialize when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initUploadSoft);
    } else {
        initUploadSoft();
    }
